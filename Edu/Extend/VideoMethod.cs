...
namespace Extend
{
    public class VideoMethod : System.Web.UI.Page
    {
        ...
        //文件路径
        public static string ffmpegtool = Common.App.Get["ffmpeg"].String;
        public static string mencodertool = Common.App.Get["mencoder"].String;
        //文件图片大小
        public static string sizeOfImg = ConfigurationManager.AppSettings["CatchFlvImgSize"];
        //文件大小
        public static string widthOfFile = Common.App.Get["widthSize"].String;
        public static string heightOfFile = Common.App.Get["heightSize"].String;
        //获取文件的名字
