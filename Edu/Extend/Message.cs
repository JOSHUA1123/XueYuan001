...
namespace Extend
{
    public class Message
    {
        ...
        public string ExceptionShow(Exception ex)
        {
            ...
            return "";
            //自定义异常
            //if (ex is Common.ExceptionForNoLogin)return this.Login("false");
            //if (ex is Common.ExceptionForAlert) return this.Alert(ex.Message);
            //if (ex is Common.ExceptionForPrompt) return this.Prompt(ex.Message);
            //if (ex is Common.ExceptionForWarning) return this.Warning(ex.Message);
            //if (ex is Common.ExceptionForLicense) return this.License(ex.Message);
