...
namespace Extend
{
    public class CustomPage : System.Web.UI.Page
    {
        ...
        protected override void OnInitComplete(EventArgs e)
        {
            ...
            if (System.IO.File.Exists(Common.Request.Page.PhysicsPath + "styles/public.css"))
            ...
            if (System.IO.File.Exists(Common.Request.Page.PhysicsPath + "styles/"+ name+".css" ))
            ...
            if (System.IO.File.Exists(Common.Request.Page.PhysicsPath + "scripts/" + name + ".js"))
            {
                try
                {
            ...
            else
            {
                ...
                {                    
                    ...
                    string module = Common.Request.Page.Module;
                    if (module.ToLower() != "student")
                    {

                        EntitiesInfo.Teacher th = LoginState.Accounts.Teacher;
                        if (th == null)
                        {
        ...
        #region 将实体的值绑定到控件
        protected void EntityBind(DataBaseInfo.Entity entity)
        {
            if (entity == null) return;
            _entityBind(this, entity);
        }
        protected void EntityBind(System.Web.UI.WebControls.Panel panel, DataBaseInfo.Entity entity)
        {
            if (entity == null) return;
        ...
        /// <returns></returns>
        protected void _entityBind(System.Web.UI.Control control, DataBaseInfo.Entity entity)
        {
        ...
        private void _entityBindSingle(System.Web.UI.Control c, DataBaseInfo.Entity entity)
        {
            //遍历实体属性
        ...
        /// </summary>
        /// <param name="entity"></param>
        protected DataBaseInfo.Entity EntityFill(DataBaseInfo.Entity entity)
        {
            return _entityFill(this, entity);
        }
        private DataBaseInfo.Entity _entityFill(System.Web.UI.Control control, DataBaseInfo.Entity entity)
        {
            foreach (Control c in control.Controls)
            {
                if (string.IsNullOrWhiteSpace(c.ID)) continue;
        ...
        private DataBaseInfo.Entity _entityFillSingle(System.Web.UI.Control c, DataBaseInfo.Entity entity, string piName)
        {
            string value = "";
            //下拉菜单，多选列表，单选列表
            if (c is DropDownList || c is CheckBoxList || c is RadioButtonList)
            ...
            object tm = string.IsNullOrEmpty(value) ? null : Common.DataConvert.ChangeType(value, property.PropertyType);
