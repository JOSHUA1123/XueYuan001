...
namespace SiteShow.SOAP
{
    ...
    public class Mobile : System.Web.Services.WebService
    {
        ...
        ///// <returns></returns>
        //[WebMethod]
        //public EntitiesInfo.EmpAccount Employee(string phoneNumber, string code)
        //{
        ...
        /// <returns></returns>
        [WebMethod]
        public EntitiesInfo.EmpAccount[] Employees(string code)
        {
            if (!isVerify(code)) return null;
        ...
        /// <returns></returns>
        [WebMethod]
        public EntitiesInfo.Organization OrgInfo(string code)
        {
            if (!isVerify(code)) return null;
