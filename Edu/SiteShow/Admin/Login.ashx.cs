...
namespace SiteShow.Admin
{
    ...
    public class Login : IHttpHandler, IRequiresSessionState
    {
        ...
        string pw = Common.Request.Form["tbPw"].String;
        ...
        private void isLogin()
        {
          ...
          EntitiesInfo.Organization org = Business.Do<IOrganization>().OrganCurrent();
            //通过验证，进入登录状态            
            EntitiesInfo.EmpAccount emp = Business.Do<IEmployee>().EmpLogin(acc, pw, org.Org_ID);
            if (emp != null)
            {
        ...
        {
            //取图片验证码
            string imgCode = Common.Request.Cookies["admincode"].ParaValue;
            //取员工输入的验证码
