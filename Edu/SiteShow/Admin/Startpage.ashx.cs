...
namespace SiteShow.Admin
{
    ...
    public class Startpage : BasePage
    {
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            //web模板列表
            this.Document.Variables.SetValue("tempweb",Business.Do<ServiceInterfaces.ITemplate>().WebTemplates());
            //手机模板列表
            this.Document.Variables.SetValue("tempwap", Business.Do<ServiceInterfaces.ITemplate>().MobiTemplates());
            //热门课程
