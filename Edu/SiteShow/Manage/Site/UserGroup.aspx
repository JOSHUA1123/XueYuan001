<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="UserGroup.aspx.cs" Inherits="SiteShow.Manage.Site.UserGroup" Title="无标题页" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((Entities.UserGroup[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
