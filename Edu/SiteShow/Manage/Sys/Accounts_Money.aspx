<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    CodeBehind="Accounts_Money.aspx.cs" Inherits="SiteShow.Manage.Sys.Accounts_Money"
    Title="无标题页" %>
      ...
      <%--  <tr>
        ...
        <tr>
            ...
            <td><asp:Label ID="lbOperator" runat="server" Text="+"></asp:Label>
                <asp:TextBox ID="tbMoney" runat="server" Width="40%" nullable="false" datatype="uint"
