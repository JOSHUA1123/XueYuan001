<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="MenuRoot.aspx.cs" Inherits="SiteShow.Manage.Sys.MenuRoot" Title="菜单管理" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((Entities.ManageMenu[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
