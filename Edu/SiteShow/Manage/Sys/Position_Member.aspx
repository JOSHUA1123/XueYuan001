<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    Codebehind="Position_Member.aspx.cs" Inherits="SiteShow.Manage.Sys.Position_Member"
    Title="无标题页" %>
...
<asp:Repeater ID="rbEmp4Posi" runat="server">
    ...
    <div id="EmplyeeListTitle">属于
        <asp:Label ID="lbPosi" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label> 的员工有：</div>
