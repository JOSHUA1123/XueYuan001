<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="Product.aspx.cs" Inherits="SiteShow.Manage.Content.Product"
    Title="无标题页" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((Entities.Product[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
