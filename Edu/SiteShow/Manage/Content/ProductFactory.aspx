<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="ProductFactory.aspx.cs" Inherits="SiteShow.Manage.Content.ProductFactory"
    Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <div id="header">
        <uc1:toolsBar ID="ToolsBar1" runat="server" WinPath="ProductFactory_Edit.aspx" GvName="GridView1"
...
<%# Eval("Pfact_Name", "{0}")%> 
            ...
            <asp:TemplateField HeaderText="公司所在地">
...
<%# Eval("Pfact_Addr", "{0}")%> 
            ...
            <asp:TemplateField HeaderText="使用">
                ...
                <itemtemplate>
<cc1:StateButton id="sbUse" onclick="sbUse_Click" runat="server" TrueText="使用" FalseText="禁用" State='<%# Eval("Pfact_IsUse","{0}")=="True"%>'></cc1:StateButton> 
</itemtemplate>
            </asp:TemplateField>
        </Columns>
    </cc1:GridView>
