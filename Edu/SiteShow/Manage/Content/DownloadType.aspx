<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="DownloadType.aspx.cs" Inherits="SiteShow.Manage.Content.DownloadType"
    Title="无标题页" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((Entities.DownloadType[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
