<%@ Page Language="C#" MasterPageFile="~/Manage/ElementUI.Master" AutoEventWireup="true"
    CodeBehind="Qiniuyun.aspx.cs" Inherits="SiteShow.Manage.Live.Qiniuyun" Title="七牛云直播设置" %>
 ...
 <el-form-item label="SecretKey：" prop="SecretKey">
  ...
  <el-form-item label="直播空间名：">
   ...
   <el-radio-group v-model="form.Protocol">
    <el-radio label="http">禁止 HTTPS</el-radio>
    <el-radio label="https">开启 HTTPS</el-radio>
  </el-radio-group>
  </el-form-item>
