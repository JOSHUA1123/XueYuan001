...
namespace SiteShow.Manage.Course
{
    public partial class Courses_Outline : Extend.CustomPage
    {
        ...
        protected void BindData(object sender, EventArgs e)
        {
            ...
            //
            EntitiesInfo.Outline[] outlines = Business.Do<IOutline>().OutlineAll(couid, null);
        ...
        protected void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            EntitiesInfo.Outline ol = olid < 1 ? new EntitiesInfo.Outline() : Business.Do<IOutline>().OutlineSingle(olid);
            if (ol == null) return;
            //名称
        ...
        {
            List<EntitiesInfo.Accessory> acs = Business.Do<IAccessory>().GetAll(this.getUID(), this.Uploader1.UploadPath);
        ...
        {
            EntitiesInfo.OutlineEvent[] events = Business.Do<IOutline>().EventAll(-1, this.getUID(), -1, null);
        ...
        {
            List<EntitiesInfo.Accessory> acs = Business.Do<IAccessory>().GetAll(this.getUID(), _uppath);
            foreach (Accessory ac in acs)
            {
