<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    CodeBehind="Outline_Video.aspx.cs" Inherits="SiteShow.Manage.Course.Outline_Video"
    Title="章节附件" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    padding-bottom: 20px;">视频事件-<a href="OutlineEvent_Edit.aspx?couid=<%=couid %>&uid=<%= uid %>&olid=<%= olid %>"
