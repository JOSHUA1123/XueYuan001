...
namespace SiteShow.Manage.Course
{
    ...
    {
        private int id = Common.Request.QueryString["couid"].Int32 ?? 0;
        //题型分类汉字名称
        ...
        {
            EntitiesInfo.Course cou = id < 1 ? new EntitiesInfo.Course() : Business.Do<ICourse>().CourseSingle(id);
            if (cou == null) return;
            //课程名称
            lbName.Text = cou.Cou_Name;
            //当前课程的试题类型
            EntitiesInfo.QuesTypes[] types = Business.Do<IQuestions>().TypeCount(cou.Cou_ID, null, -1);
        ...
        {
            EntitiesInfo.QuesTypes qt = new QuesTypes();
            qt.Cou_ID = id;
        ...
        protected void btnEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            EntitiesInfo.QuesTypes qt = Business.Do<IQuestions>().TypeSingle(typeid);
            if (qt == null) return;
            //名称
        ...
        protected void sbUse_Click(object sender, EventArgs e)
        {
            ...
            int id = int.Parse(this.gvPrice.DataKeys[index].Value.ToString());
            //
            EntitiesInfo.QuesTypes entity = Business.Do<IQuestions>().TypeSingle(id);
