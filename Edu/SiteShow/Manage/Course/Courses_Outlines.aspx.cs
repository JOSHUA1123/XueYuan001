...
namespace SiteShow.Manage.Course
{
    public partial class Courses_Outlines : Extend.CustomPage
    {
        ...
        protected void BindData(object sender, EventArgs e)
        {
            ...
            //计算试题数
            foreach (EntitiesInfo.Outline c in outlines)
            {
        ...
        protected void btnEditEnter_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                EntitiesInfo.Outline outline = Business.Do<IOutline>().OutlineSingle(id);
            ...
            {
                //新增
                EntitiesInfo.Outline outline = new EntitiesInfo.Outline();
                outline.Ol_Name = tb.Text.Trim();
                //上级ID
        ...
        protected void sbUse_Click(object sender, EventArgs e)
        {
            ...
            int id = int.Parse(this.GridView1.DataKeys[index].Value.ToString());
            //
            EntitiesInfo.Outline entity = Business.Do<IOutline>().OutlineSingle(id);
