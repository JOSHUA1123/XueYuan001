...
namespace SiteShow.Manage.Course
{
    public partial class Courses_Money : Extend.CustomPage
    {
        ...
        {
            EntitiesInfo.Course cou = this.Save();
            this.Alert("操作成功");
        }
        ...
        /// </summary>
        /// <returns></returns>
        private EntitiesInfo.Course Save()
        {
        ...
        {            
            ...
            EntitiesInfo.CoursePrice[] prices = Business.Do<ICourse>().PriceCount(0, cou.Cou_UID, null, -1);
        ...
        {
            EntitiesInfo.CoursePrice cp = new CoursePrice();
            cp.Cou_UID = getUID();
            //消费时间
            int span;
        ...
        protected void btnEditEnter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int id = int.Parse(this.gvPrice.DataKeys[index].Value.ToString());
                //
                EntitiesInfo.CoursePrice col = Business.Do<ICourse>().PriceSingle(id);
                if (col != null)
                {
                    //区间
        ...
        protected void sbUse_Click(object sender, EventArgs e)
        {
            ...
            int id = int.Parse(this.gvPrice.DataKeys[index].Value.ToString());
            //
            EntitiesInfo.CoursePrice entity = Business.Do<ICourse>().PriceSingle(id);
