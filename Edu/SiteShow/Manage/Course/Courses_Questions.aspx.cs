...
namespace SiteShow.Manage.Course
{
    public partial class Courses_Questions : Extend.CustomPage
    {
        ...
        //章节列表
        protected EntitiesInfo.Outline[] outlines = null;
        ...
        {
            string olname = "";
            foreach (EntitiesInfo.Outline o in outlines)
            {
                if (o.Ol_ID == olid)
                {
                    olname = o.Ol_Name;
        ...
        protected void Output_Click(object sender, EventArgs e)
        {
            ...
            BindData(null, null);
            EntitiesInfo.Questions[] ques = null;
            if (GridView1.DataSource is EntitiesInfo.Questions[])
            {
                ques = (EntitiesInfo.Questions[])GridView1.DataSource;
            }
            else
            {
            ...
            string filePath = Upload.Get["Temp"].Physics + Common.Server.LegalName(filename);
        ...
        //单选题导出
        private void buildExcelSql_1(NPOI.HSSF.UserModel.HSSFWorkbook hssfworkbook, EntitiesInfo.Questions[] ques)
        {
            //创建工作簿对象
            NPOI.SS.UserModel.ISheet sheet = hssfworkbook.CreateSheet("单选题");
        ...
        //多选题导出
        private void buildExcelSql_2(NPOI.HSSF.UserModel.HSSFWorkbook hssfworkbook, EntitiesInfo.Questions[] ques)
        {
            //创建工作簿对象
        ...
        //判断题导出
        private void buildExcelSql_3(NPOI.HSSF.UserModel.HSSFWorkbook hssfworkbook, EntitiesInfo.Questions[] ques)
        {
            //创建工作簿对象
        ...
        //简答题导出
        private void buildExcelSql_4(NPOI.HSSF.UserModel.HSSFWorkbook hssfworkbook, EntitiesInfo.Questions[] ques)
        {
            //创建工作簿对象
        ...
        //填空题导出
        private void buildExcelSql_5(NPOI.HSSF.UserModel.HSSFWorkbook hssfworkbook, EntitiesInfo.Questions[] ques)
        {
            //创建工作簿对象
