<%@ Page Language="C#"  MasterPageFile="~/Manage/Student/Parents.Master" AutoEventWireup="true"
 CodeBehind="MoneyDetails.aspx.cs" Inherits="SiteShow.Manage.Student.MoneyDetails" %>
    ...
    <cc1:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SelectBoxKeyName="SelectBox"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="详情">
                <ItemTemplate>
                    <a href="#" onclick="OpenWin('Details_View.aspx?id=<%# Common.DataConvert.EncryptForBase64UrlEncode(Eval("Ma_ID").ToString())%>','<%# Eval("Ma_Source", "{0}")%>',600,480);return false;">
                        查看</a>
                </ItemTemplate>
