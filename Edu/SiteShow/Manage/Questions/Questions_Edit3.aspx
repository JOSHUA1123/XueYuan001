<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    CodeBehind="Questions_Edit3.aspx.cs" Inherits="SiteShow.Manage.Questions.Questions_Edit3"
    Title="无标题页" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        ...
        <div class="answerBox">
            <div style="height: 25px; width: 80px; text-align: right; line-height: 25px; float: left">
                答案：</div>
            <asp:RadioButtonList ID="rblIsCorrect" runat="server" RepeatDirection="Horizontal"
                CssClass="rblAnswer" RepeatLayout="Flow">
    ...
    <div class="quesRight">
        ...
        <WebEditor:Editor ID="tbExplain" runat="server" Height="420px" ThemeType="simple"> </WebEditor:Editor>
    </div>
</asp:Content>
