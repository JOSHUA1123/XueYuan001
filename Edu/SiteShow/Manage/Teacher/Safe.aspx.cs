...
namespace SiteShow.Manage.Teacher
{
    public partial class Safe : Extend.CustomPage
    {
        ...
        private void fill()
        {
            EntitiesInfo.Teacher th = id == 0 ? Extend.LoginState.Accounts.Teacher : Business.Do<ITeacher>().TeacherSingle(id);
            if (th == null) return;
            this.EntityBind(th);
        ...
        {
            EntitiesInfo.Teacher obj = Extend.LoginState.Accounts.Teacher;
        ...
        {
            EntitiesInfo.Teacher obj = Extend.LoginState.Accounts.Teacher;
            obj = this.EntityFill(obj) as EntitiesInfo.Teacher;
            Business.Do<ITeacher>().TeacherSave(obj);
            this.Alert("操作成功！");
        }
    }
