<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    CodeBehind="Sort.aspx.cs" Inherits="SiteShow.Manage.Teacher.Sort" Title="教师分类" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="移动">
                ...
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="lbDown" OnClick="lbDown_Click" runat="server" Enabled='<%# Container.DataItemIndex+1< ((EntitiesInfo.TeacherSort[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
