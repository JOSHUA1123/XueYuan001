<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    CodeBehind="Correct.aspx.cs" Inherits="SiteShow.Manage.Teacher.Correct"
    Title="无标题页" %>
            ...
            <tr>
                ...
                <td class="right">切换考生：</td>
                 <td>
                     ...
                     </asp:DropDownList> （背景为蓝色的为选中考生，绿色为已经判过卷）
                 </td>
            </tr>
        </table>
    </fieldset>
                ...
                <ItemTemplate>
                    <div class="shortQues">
                        <div class="quesTitle">
                            ...
                            分]
                            <asp:HiddenField ID="types" runat="server" Value='<%# Eval("type") %>'/>
                        </div>
                        <div class="quText">
