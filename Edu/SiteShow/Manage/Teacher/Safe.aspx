<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Safe.aspx.cs" Inherits="SiteShow.Manage.Teacher.Safe"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
  ...
  <asp:Label ID="lbShow" runat=server Text="原密码不正确" Visible=False ForeColor="Red"></asp:Label>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnEnter" runat="server"  group="pw" Text="保存" verify=true  OnClick="btnEnter_Click" />
            </td>
        </tr>
    </table>
    </fieldset>
    <fieldset>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox nullable="false" ID="Th_Qus"  group="ques" runat="server" Width="200" MaxLength="100"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox nullable="false" ID="Th_Anwser"  group="ques" runat="server"  Width="200" MaxLength="100"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnSafeQues" runat="server"  group="ques" verify=true  Text="保存" OnClick="btnSafeQues_Click" />
            </td>
        </tr>
    </table>
        </asp:Panel>
