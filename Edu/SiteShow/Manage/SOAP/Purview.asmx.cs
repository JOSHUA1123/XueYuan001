...
namespace SiteShow.Manage.SOAP
{
    ...
    public class Purview : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        //用于权限管理的功能菜单，禁用的不显示
        public EntitiesInfo.ManageMenu[] PurViewMenu()
        {
            //获取功能菜单树的所有菜单项
        ...
        public EntitiesInfo.ManageMenu[] GetAll4Emplyee(int empId)
        {
            //获取功能菜单树的所有菜单项
        ...
        {
            //获取功能菜单树的所有菜单项
            EntitiesInfo.ManageMenu[] mm = Business.Do<IPurview>().GetAll4Emplyee(empId);
            string ManageId = "";
        ...
        [WebMethod]
        //用于权限管理的功能菜单
        public EntitiesInfo.Purview[] GetPurView(int memberId, string type)
        {
            //获取功能菜单树的所有菜单项
