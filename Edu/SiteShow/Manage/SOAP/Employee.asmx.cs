...
namespace SiteShow.Manage.SOAP
{
    ...
    public class Employee : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        //获取所有在职员工
        public EntitiesInfo.EmpAccount[] Employees()
        {
        ...
        [WebMethod]
        //获取某院系所有在职员工
        public EntitiesInfo.EmpAccount[] Emp4Depart(int depid)
        {
            int orgid = Extend.LoginState.Admin.CurrentUser.Org_ID;
        ...
        public void UpdateEmp4Posi(string xml)
        {
            ...
            try
            {
                ...
                foreach (XmlNode xn in nodeList)
                {
                    ...
                    EntitiesInfo.EmpAccount mm = Business.Do<IEmployee>().GetSingle(empid);
