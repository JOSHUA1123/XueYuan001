<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="AddressSort.aspx.cs" Inherits="SiteShow.Manage.Common1.AddressSort"
    Title="无标题页" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((List<Entities.AddressSort>)GridView1.DataSource).Length %>'>下移</asp:LinkButton>
