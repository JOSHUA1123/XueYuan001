...
namespace SiteShow
{
    ...
    {
        //根域名
        protected string mainname = Common.Server.MainName;
        //版权信息
        ...
        {    
            ...
            {                
                ...
                {
                    case "code":
                        int type = Common.Request.Form["type"].Int16 ?? 4;
        ...
        {            
            ...
            if (type == 1) code = Common.Activationcode.CodeForCPU;
            if (type == 2) code = Common.Activationcode.CodeForHardDisk;
            if (type == 3) code = Common.Activationcode.CodeForIP;
            if (type == 4) code = Common.Activationcode.CodeForDomain;       //域名激活码
            if (type == 5) code = Common.Activationcode.CodeForRoot;         //主域激活码
            return code;            
        }
        /// <summary>
        /// 绑定各版本之间的差别数据
        ...
        {
            DataTable dt = Common.Parameters.Authorization.VersionLevel.LevelTable;
