...
namespace SiteShow
{
    ...
    public class MessageBoards : BasePage
    {
        ...
        //提交的信息
        private string msg = Common.Request.Form["msg"].String;
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            if (noTag != null)
            {
                ...
                int sum = 0;
                EntitiesInfo.MessageBoard[] msgBoards = Business.Do<IMessageBoard>().ThemePager(Organ.Org_ID, couid, false, true, "", size, index, out sum);
                foreach (EntitiesInfo.MessageBoard no in msgBoards)
                {
