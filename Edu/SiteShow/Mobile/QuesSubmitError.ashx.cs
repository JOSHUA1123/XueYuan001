...
namespace SiteShow.Mobile
{
    ...
    {
        //试题id
        protected int qid = Common.Request.QueryString["id"].Int32 ?? 0;
        //错误类型
        string errtype = Common.Request.Form["err1"].String;
        //错误信息
        string errinfo = Common.Request.Form["tbErrInfo"].String;
