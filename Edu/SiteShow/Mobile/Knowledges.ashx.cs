    ...
    public class Knowledges : BasePage
    {
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            if (Request.ServerVariables["REQUEST_METHOD"] == "GET")
            {
                ...
                //知识库栏目
                EntitiesInfo.KnowledgeSort[] kns = Business.Do<IKnowledge>().GetSortAll(-1, couid, -1, true);
                ...
                this.Document.Variables.SetValue("couid", couid);
                //当前知识库栏目
                int sorts = Common.Request.QueryString["sorts"].Int32 ?? 0;  //栏目分类id
                EntitiesInfo.KnowledgeSort sort = Business.Do<IKnowledge>().SortSingle(sorts);
            ...
            if (Request.ServerVariables["REQUEST_METHOD"] == "POST")
            {
                ...
                int sumcount = 0;
                //信息列表
                EntitiesInfo.Knowledge[] kls = null;
