...
namespace SiteShow.Mobile
{
    ...
    public class CoursePage : BasePage
    {
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            //树形章节输出
            EntitiesInfo.Outline[] outlines = Business.Do<IOutline>().OutlineAll(course.Cou_ID, true);
            ...
            EntitiesInfo.Guide[] guides = Business.Do<IGuide>().GuideCount(0, course.Cou_ID, 0, guidCount);
