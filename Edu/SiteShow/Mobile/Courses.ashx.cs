...
namespace SiteShow.Mobile
{
    ...
    {
        //专业ID,课程id
        protected int sbjid = Common.Request.QueryString["sbjid"].Int32 ?? 0;
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            {
                //专业id，多个id用逗号分隔
                string sbjids = Common.Request.Form["sbjids"].String;
                string sear = Common.Request.Form["sear"].UrlDecode;
                ...
                string order = Common.Request.Form["order"].String;
                int sumcount = 0;
                //当前专业下的子专业，如果是顶级，则显示所有顶级专业
                List<EntitiesInfo.Course> courses;
