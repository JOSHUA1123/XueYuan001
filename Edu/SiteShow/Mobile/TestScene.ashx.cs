...
namespace SiteShow.Mobile
{
    ...
    public class TestScene : BasePage
    {
        ...
        //行为
        protected string action = Common.Request.QueryString["action"].String;
        //当前学员收藏的试题
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            if (action == "start")
            {
                ...
                Dictionary<TestPaperItem, EntitiesInfo.Questions[]> dic = Business.Do<ITestPaper>().Putout(paper);
