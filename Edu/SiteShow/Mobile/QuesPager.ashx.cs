...
namespace SiteShow.Mobile
{
    ...
    public class QuesPager : BasePage
    {
        ...
        //每页多少条
        int pagerSize = Common.Request.QueryString["size"].Int32 ?? 100;
        //不分页的最大值,例如小于200时不分页
        int noPager = Common.Request.QueryString["onpager"].Int32 ?? 200;
        //要跳转的页
        string url = Common.Request.QueryString["url"].String;
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            //是否购买该课程
            EntitiesInfo.Course couBuy = Business.Do<ICourse>().IsBuyCourse(couid, Extend.LoginState.Accounts.CurrentUser.Ac_ID, 1);
