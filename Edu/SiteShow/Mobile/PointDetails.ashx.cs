...
namespace SiteShow.Mobile
{
    ...
    public class PointDetails : BasePage
    {
        ...
        private void point_List()
        {
            ...
            int sumcount = 0;
            EntitiesInfo.PointAccount[] details = Business.Do<IAccounts>().PointPager(-1, stid, 0, null, null, null, size, index, out sumcount);
        ...
        {
            int id = Common.Request.Form["id"].Int32 ?? 10; 
            try
            {
