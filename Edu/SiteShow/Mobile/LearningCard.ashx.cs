...
namespace SiteShow.Mobile
{
    ...
    public class LearningCard : BasePage
    {
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            if (Request.ServerVariables["REQUEST_METHOD"] == "GET")
            {
                ...
                if (accid > 0)
                {
                    ...
                    //学习卡
                    EntitiesInfo.LearningCard[] cards = Business.Do<ILearningCard>().AccountCards(accid);
        ...
        private void decode_qrcode(HttpContext context)
        {
            ...
            if (context.Request.Files.Count > 0)
            {
                try
                {
                    ...
                    //解析二维码
                    ret = Common.QrcodeHepler.Decode(img);
                }
                catch
                {
                }
        ...
        {            
            //学习卡的编码与密钥
            string code = Common.Request.Form["card"].String;
            ...
            {               
                ...
                {
                    //开始验证
                    EntitiesInfo.LearningCard card = Business.Do<ILearningCard>().CardCheck(code);
                    if (card != null)
                    {
                        ...
                        if (st != null)
                        {
                            ...
                            //输出关联的课程
                            EntitiesInfo.Course[] courses = Business.Do<ILearningCard>().CoursesForCard(card.Lc_Code, card.Lc_Pw);
