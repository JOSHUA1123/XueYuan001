    ...
    public class QuesNotes : BasePage
    {
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            if (Request.ServerVariables["REQUEST_METHOD"] == "GET")
            {
                ...
                //错题列表
                EntitiesInfo.Questions[] ques = Business.Do<IStudent>().NotesCount(st.Ac_ID, couid, -1, -1);
        ...
        private void delete()
        {
            ...
            try
            {
                if (id > 0)
                {
                    ...
                    {
                        EntitiesInfo.Accounts st = Extend.LoginState.Accounts.CurrentUser;
                        Business.Do<IStudent>().NotesDelete(id, st.Ac_ID);
                    }
                }
                Response.Write("1");
            }
        ...
        private void clear()
        {
            ...
            try
            {
                if (couid > 0)
                {
                    ...
                    {
                        EntitiesInfo.Accounts st = Extend.LoginState.Accounts.CurrentUser;
                        Business.Do<IStudent>().NotesClear(couid, st.Ac_ID);
                    }
                }
                Response.Write("1");
            }
