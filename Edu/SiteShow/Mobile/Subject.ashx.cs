...
namespace SiteShow.Mobile
{
    ...
    {
        //专业ID
        protected int sbjid = Common.Request.QueryString["id"].Int32 ?? 0;
        //搜索字符
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            //当前专业
            EntitiesInfo.Subject subject = Business.Do<ISubject>().SubjectSingle(sbjid);
            if (subject != null)
            {
            ...
            foreach (EntitiesInfo.Subject s in subjects)
            {
