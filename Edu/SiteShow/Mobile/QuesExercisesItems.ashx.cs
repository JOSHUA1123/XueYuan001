...
namespace SiteShow.Mobile
{
    ...
    public class QuesExercisesItems : BasePage
    {
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            //当前课程
            EntitiesInfo.Course course = null;
            if (outline != null)
            {
            ...
            EntitiesInfo.Course couBuy = Business.Do<ICourse>().IsBuyCourse(couid, accid, 1);
            ...
            //试题列表
            EntitiesInfo.Questions[] ques = Business.Do<IQuestions>().CacheQuestions("all");
            ...
            //List<EntitiesInfo.Questions> list = new List<EntitiesInfo.Questions>();
            //if (isBuy || course.Cou_IsFree) list = ques.ToList<EntitiesInfo.Questions>();  //如果已经购买或免费；
        ...
        /// <returns></returns>
        private List<EntitiesInfo.Questions> GetQues(List<int> olid, EntitiesInfo.Questions[] ques)
        {
