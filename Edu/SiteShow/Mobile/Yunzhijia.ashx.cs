...
namespace SiteShow.Mobile
{
    ...
    public class Yunzhijia : BasePage
    {
        ...
        private string getUser()
        {
            ...
            string ticket = Common.Request.QueryString["ticket"].String;
            string json = string.Empty;
            try
            {
                //验证
                ...
                string resultToken = Common.Request.HttpGet(urlToken);
                ...
                if (!string.IsNullOrWhiteSpace(token))
                {
                    ...
                    string resultUser = Common.Request.HttpGet(urlUser);
        ...
        {
            //判断是否存在
            EntitiesInfo.Accounts acc = Business.Do<IAccounts>().IsAccountsExist(accout);
            if (acc == null)
            {
