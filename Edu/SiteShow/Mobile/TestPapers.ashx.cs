...
namespace SiteShow.Mobile
{
    ...
    {
        //搜索字符
        protected string search = Common.Request.Form["search"].String;
        ...
        protected override void InitPageTemplate(HttpContext context)
        {
            ...
            //当前选中的课程
            EntitiesInfo.Course currCourse = Business.Do<ICourse>().CourseSingle(couid);
            ...
            //试卷列表
            EntitiesInfo.TestPaper[] tps = null;
            ...
            foreach (EntitiesInfo.TestPaper s in tps)
            {
            ...
            //是否购买该课程
            EntitiesInfo.Course couBuy = Business.Do<ICourse>().IsBuyCourse(currCourse.Cou_ID, Extend.LoginState.Accounts.CurrentUser.Ac_ID, 1);
