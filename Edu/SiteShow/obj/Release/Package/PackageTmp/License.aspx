<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="License.aspx.cs" Inherits="SiteShow.License" %>
...
<body>
    ...
    <div id="footer">
        <div class="copyright">
            Copyright &copy; 2019-2020 <a href="<%= copyright["url"] %>" target="_blank"><%= copyright["en"]%></a>
            All rights reserved
        </div>
    </div>
</body>
