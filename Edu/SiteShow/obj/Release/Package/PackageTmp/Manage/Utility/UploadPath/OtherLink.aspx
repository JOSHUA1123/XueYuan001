<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherLink.aspx.cs" Inherits="SiteShow.Manage.Utility.UploadPath.OtherLink" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td>
                 <asp:TextBox ID="tbName" runat="server" Width="30%" nullable="false" MaxLength="255"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="right">
           ...
           <tr>
            ...
            <td >
              &nbsp;<asp:Panel ID="panleShow" runat="server" Visible=false>
               <span style="color:red">该视频附件不是来自视频平台的链接，不允许编辑；<br />
               如果需要添加，请删除原有视频；</span>
                </asp:Panel>
            </td>
        </tr>
