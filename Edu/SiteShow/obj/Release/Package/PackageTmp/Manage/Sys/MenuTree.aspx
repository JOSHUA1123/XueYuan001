<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuTree.aspx.cs" Inherits="SiteShow.Manage.Sys.MenuTree"
    Title="无标题页" %>
...
<body>
                ...
                <div id="Panel">
                    <div>
                        ...
                        <dd style="display: none">
                            <span name="id"></span>=<span name="patid"></span>-<span name="tax"></span>
                        </dd>
                        <dd class="namebar">
                            <div class="name">
                                名称：
                        ...
                        <dd>
                            移动到：
                            <select name="moveto">
                                <% foreach (Entities.ManageMenu mm in root)
                                   {
                                       if (mm.MM_Id == id)
                                       {             
                                %>
                                <option value="<%= mm.MM_Id%>" selected="selected" style="background-color: #CCCCCC;">
                                    <%= mm.MM_Name%></option>
                                <%}
                   else
                   {
                                %>
                                <option value="<%= mm.MM_Id%>">
                                    <%= mm.MM_Name%></option>
                                <%
                   }
               }%>
                   ...
                   else
                   {
                        ...
                        <dd>
                            ...
                            ×
                            <input name="winheight" type="text" class="numBox" value="300" size="2" maxlength="3" />
                            px)
                            <label>
                    ...
                    <div id="patdata">
                        <dd>
                            上级菜单项： <span id="addNodeParent" name="name" read="no" class="nodeParent"></span>
                        </dd>
                        <dd style="display: none">
                            <span name="id"></span>-<span name="tax"></span>
                        </dd>
                    </div>
                    <dd class="namebar">
                        <div class="name">
    ...
    <div class="pageWinBtn" style="text-align: right" loyout="row" height="50">
        <input type="image" name="btnEnter" id="btnEnter" class="btnEnterButton" verify="true"
            text="确定" src="../Images/empty.gif" />
        <input type="image" name="CloseButton" id="btnCloseWin" class="btnCloseWin" src="../Images/empty.gif"
            onclick="new top.PageBox().Close();" />
    </div>
