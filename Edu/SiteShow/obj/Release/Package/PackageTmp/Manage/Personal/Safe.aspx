<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Safe.aspx.cs" Inherits="SiteShow.Manage.Personal.Safe"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
  ...
  <asp:Label ID="lbShow" runat=server Text="原密码不正确" Visible=False ForeColor="Red"></asp:Label>
        ...
        <tr>
            ...
            <td>
                <cc1:Button ID="btnEnter" runat="server" Text="保存" verify=true  group="pw"  OnClick="btnEnter_Click" />
            </td>
        </tr>
    </table>
    </fieldset>
    <fieldset>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox nullable="false" ID="Acc_Qus"  group="ques" runat="server" Width="200" MaxLength="100"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox nullable="false" ID="Acc_Ans" group="ques" runat="server"  Width="200" MaxLength="100"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <cc1:Button ID="btnSafeQues" runat="server" verify=true  group="ques" Text="保存" OnClick="btnSafeQues_Click" />
            </td>
        </tr>
    </table>
        </asp:Panel>
