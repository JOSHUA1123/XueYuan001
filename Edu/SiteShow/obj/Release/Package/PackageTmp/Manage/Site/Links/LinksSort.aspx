<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="LinksSort.aspx.cs" Inherits="SiteShow.Manage.Site.Links.LinksSort"
    Title="无标题页" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((EntitiesInfo.LinksSort[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
