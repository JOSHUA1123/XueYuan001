<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="PayList.aspx.cs" Inherits="SiteShow.Manage.Pay.PayList" Title="支付接口" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((Entities.PayInterface[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
