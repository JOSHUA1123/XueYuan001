<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    CodeBehind="KnlContent.aspx.cs" Inherits="SiteShow.Manage.Course.KnlContent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <asp:Panel ID="plEditArea" runat="server" CssClass="plEditArea" Visible="false">
        ...
        <div class="contItem" tab="tab2">
            <WebEditor:Editor ID="tbDetails" runat="server" Height="400px" Width="99%"> </WebEditor:Editor>
        </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>
                    <asp:Button ID="btnAddEnter" runat="server" Text="确 定" group="ent" verify="true"
        ...
        <div id="header">
            ...
            <div class="searchBox" id="searchBox">
                <span id="spanColName" runat="server">栏目：《<asp:Label ID="lbColunms" runat="server"
                    Text=""></asp:Label>》</span> <%--标题：<asp:TextBox ID="tbSear" runat="server" Width="80"
                        MaxLength="10"></asp:TextBox>&nbsp;<asp:Button ID="btnSear" runat="server" Width="60"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="使用">
                    <ItemTemplate>
                        <cc1:StateButton ID="sbUse" OnClick="sbUse_Click" runat="server" TrueText="使用" FalseText="禁用"
                            State='<%# Eval("Kn_IsUse","{0}")=="True"%>'></cc1:StateButton>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        ...
                        <cc1:RowEdit ID="btnEdit" IsJsEvent="false" OnClick="btnEdit_Click" CommandArgument='<%# Eval("Kn_ID")%>'
