<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Course/CourseEdit.Master"
    AutoEventWireup="true" CodeBehind="Courses_Knl.aspx.cs" Inherits="SiteShow.Manage.Course.Courses_Knl" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
        ...
        <div id="knl">
         <iframe id="leftIframe" src="KnlColumns.aspx?couid=<%=couid %>" width="300" height="550" marginwidth="0" marginheight="0"
            ...
            <iframe id="rightIframe" src="" height="500" marginwidth="0" marginheight="0"
                scrolling="auto" frameborder="0"></iframe>
       </div>
