<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    CodeBehind="Outline_Accessory.aspx.cs" Inherits="SiteShow.Manage.Course.Outline_Accessory"
    Title="章节附件" %>

<%@ MasterType VirtualPath="~/Manage/PageWin.Master" %>
<%@ Register Assembly="WeiSha.WebControl" Namespace="WeiSha.WebControl" TagPrefix="cc1" %>
<%@ Register Assembly="WebEditor" Namespace="WebEditor" TagPrefix="WebEditor" %>
<%@ Register Src="../Utility/UploaderFJ.ascx" TagName="UploaderFJ" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
     <fieldset>
         ...
         <uc1:UploaderFJ ID="Uploader1" runat="server" UploadPath="Course" LimitCount="1" />
            <br />
