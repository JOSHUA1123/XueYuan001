<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="DownloadOS.aspx.cs" Inherits="SiteShow.Manage.Content.DownloadOS"
    Title="无标题页" %>
...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((Entities.DownloadOS[])GridView1.DataSource).Length %>'>下移</asp:LinkButton>
