<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ques.aspx.cs" MasterPageFile="~/Manage/ManagePage.Master"
    Inherits="SiteShow.Manage.Questions.Ques" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    <div id="header">
        <uc1:toolsBar ID="ToolsBar1" runat="server" WinPath="List_Edit.aspx" DelShowMsg="注：如果当前试题已经被试卷采用，则无法删除！"
            ...
            InputButtonVisible="true" OutputButtonVisible="false" OnOutput="Output_Click" />
        <asp:Panel ID="searchBox" CssClass="searchBox" runat="server">
            ...
            <asp:DropDownList ID="ddlDiff" runat="server" Width="50">
