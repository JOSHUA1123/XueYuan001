<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true"
    Codebehind="TaskWorker.aspx.cs" Inherits="SiteShow.Manage.Common1.TaskWorker" Title="无标题页" %>

<%@ Register Src="../Utility/toolsBar.ascx" TagName="toolsBar" TagPrefix="uc1" %>
<%@ Register Src="../Utility/Pager.ascx" TagName="Pager" TagPrefix="uc2" %>
<%@ Register Assembly="WeiSha.WebControl" Namespace="WeiSha.WebControl" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
   <div id="header">   <uc1:toolsBar ID="ToolsBar1" runat="server" WinPath="TaskWorker_Edit.aspx" GvName="GridView1"
        WinWidth="70" WinHeight="70" OnDelete="DeleteEvent"  AddButtonVisible=false DelButtonVisible=false/>
    ...
    <div class="searchBox">
        ...
        优先级：<asp:DropDownList ID="ddlLevel" runat="server" Width="60">
...
<%# Eval("Task_Level","{0}")%> </span>
            ...
            <asp:TemplateField HeaderText="派发人/任务主题/完成度">
