<%@ Page Language="C#" MasterPageFile="~/Manage/PageWin.Master" AutoEventWireup="true"
    Codebehind="TaskGoBack_Edit.aspx.cs" Inherits="SiteShow.Manage.Common1.TaskGoBack_Edit" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBtn" runat="server">
    <cc1:EnterButton verify="true" ID="btnEnter" runat="server" Text="再次派发" OnClick="btnEnter_Click"
