...
namespace SiteShow.Ajax
{
    ...
    public class GetResult : IHttpHandler
    {
        ...
        //试卷id，考试id,学生id
        private int tpid = Common.Request.QueryString["tpid"].Int32 ?? 0;
        private int examid = Common.Request.QueryString["examid"].Int32 ?? 0;
        private int stid = Common.Request.QueryString["stid"].Int32 ?? 0;
        public void ProcessRequest(HttpContext context)
        {
            context.Response.ContentType = "text/plain";
            //获取答题信息
           EntitiesInfo.ExamResults exr = Business.Do<IExamination>().ResultSingleForCache(examid, tpid, stid);
