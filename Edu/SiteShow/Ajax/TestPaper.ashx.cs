...
namespace SiteShow.Ajax
{
    ...
    public class TestPaper : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //Entities.TestPaper tp = Business.Do<ITestPaper>().PagerSingle(tpid);
        ...
        private string randomJson()
        {
            ...
            {
                EntitiesInfo.TestPaperItem pi = tpi[i];
                //类型，试题数目，该类型占多少分，
        ...
        /// <returns></returns>
        private EntitiesInfo.Questions[] clacScore(EntitiesInfo.Questions[] ques, float total)
        {
            float surplus = total;
