    ...
    public class Notices : BasePage
    {
        ...
        {          
            ...
            if (noTag != null)
            {
                ...
                int sum = 0;
                EntitiesInfo.Notice[] notice = Business.Do<INotice>().GetPager(Organ.Org_ID, true, "", size, index, out sum);
                foreach (EntitiesInfo.Notice no in notice)
                {
            ...
            if (newsTag != null)
            {
                ...
                EntitiesInfo.Article[] news = Business.Do<IContents>().ArticleCount(Organ.Org_ID, columns, newsCount, null);
