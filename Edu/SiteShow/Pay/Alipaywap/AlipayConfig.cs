...
namespace Com.Alipaywap
{
    ...
    public class Config
    {
        ...
        public Config(EntitiesInfo.PayInterface payInterface)
        {
            _init(payInterface);
        }
        public Config(int paiid)
        {
            EntitiesInfo.PayInterface payInterface = Business.Do<IPayInterface>().PaySingle(paiid);
            _init(payInterface);
        }

        private void _init(EntitiesInfo.PayInterface payInterface)
        {
            //↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
