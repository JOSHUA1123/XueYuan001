...
namespace WxPayAPI
{
    ...
    {
        //支付接口ID
        int pi = Common.Request.QueryString["pi"].Int32 ?? 0;
        //流水号，即商户订单号
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.ServerVariables["REQUEST_METHOD"] == "GET")
            {
                ...
                if (!System.IO.File.Exists(Common.Upload.Get["Accounts"].Physics + acc.Ac_Photo))
                {
                    accphoto = Common.Upload.Get["Accounts"].Virtual + acc.Ac_Photo;
                }
                EntitiesInfo.MoneyAccount maccount = Business.Do<IAccounts>().MoneySingle(serial);
        ...
        private void initData()
        {
            ...
            if (string.IsNullOrWhiteSpace(notify_url)) notify_url = "http://" + Common.Server.Domain + "/";
