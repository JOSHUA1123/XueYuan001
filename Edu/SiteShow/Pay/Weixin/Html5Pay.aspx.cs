...
namespace Site.Pay.Weixin
{
    public partial class Html5Pay : System.Web.UI.Page
    {
        ...
        protected int total_fee = Common.Request.QueryString["money"].Int32 ?? 0;  //充值的钱数
        int orgid = 0;  //机构id
        ...
        //当前账号
        protected EntitiesInfo.Accounts acc = Extend.LoginState.Accounts.CurrentUser;
        protected string path = Common.Upload.Get["Accounts"].Virtual;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.ServerVariables["REQUEST_METHOD"] == "GET")
            {
                ...
                piid = Common.Request.QueryString["piid"].Int32 ?? 0;
                serial = Common.Request.QueryString["serial"].String;
                //回调地址
                this.payInterface = Business.Do<IPayInterface>().PaySingle(piid);
                retdomain = this.payInterface.Pai_Returl;
                if (string.IsNullOrWhiteSpace(retdomain)) retdomain = "http://" + Common.Server.Domain + "/";
            ...
            if (Request.ServerVariables["REQUEST_METHOD"] == "POST")
            {
                ...
                string code = Common.Request.Form["code"].String;
                piid = Common.Request.Form["piid"].Int32 ?? 0;
                serial = Common.Request.Form["serial"].String;
                notify_url = Common.Request.Form["returl"].String;
                initData();  
                //支付下单
