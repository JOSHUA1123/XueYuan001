...
namespace Site.Pay.Weixin
{
    public partial class miniProgramOpenid : System.Web.UI.Page
    {
        ...
        private string code = Common.Request.Form["scode"].String;   
        ...
        {
            EntitiesInfo.PayInterface[] pis = Business.Do<IPayInterface>().PayAll(-1, null, true);
            foreach (EntitiesInfo.PayInterface p in pis)
            {
