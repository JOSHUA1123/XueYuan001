namespace EntitiesInfo {
    	...
    	public partial class Depart : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Depart>("Depart");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Depart>();
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<Depart>("Dep_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<Depart>("Dep_CnName");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Code = new DataBaseInfo.Field<Depart>("Dep_Code");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Tax = new DataBaseInfo.Field<Depart>("Dep_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Dep_IsUse = new DataBaseInfo.Field<Depart>("Dep_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Dep_IsShow = new DataBaseInfo.Field<Depart>("Dep_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_IsAdmin - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Dep_IsAdmin = new DataBaseInfo.Field<Depart>("Dep_IsAdmin");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_PatId - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_PatId = new DataBaseInfo.Field<Depart>("Dep_PatId");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Level = new DataBaseInfo.Field<Depart>("Dep_Level");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Func - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Func = new DataBaseInfo.Field<Depart>("Dep_Func");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Phone = new DataBaseInfo.Field<Depart>("Dep_Phone");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Msn - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Msn = new DataBaseInfo.Field<Depart>("Dep_Msn");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Fax - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Fax = new DataBaseInfo.Field<Depart>("Dep_Fax");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Email = new DataBaseInfo.Field<Depart>("Dep_Email");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_WorkAddr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_WorkAddr = new DataBaseInfo.Field<Depart>("Dep_WorkAddr");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_CnAbbr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnAbbr = new DataBaseInfo.Field<Depart>("Dep_CnAbbr");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_EnAbbr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_EnAbbr = new DataBaseInfo.Field<Depart>("Dep_EnAbbr");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_EnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_EnName = new DataBaseInfo.Field<Depart>("Dep_EnName");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_State - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Dep_State = new DataBaseInfo.Field<Depart>("Dep_State");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Count - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Count = new DataBaseInfo.Field<Depart>("Dep_Count");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Depart>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Depart>("Org_Name");
    		}
    	}
    }
