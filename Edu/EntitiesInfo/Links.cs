namespace EntitiesInfo {
    	...
    	public partial class Links : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Links>("Links");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Links>();
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Id = new DataBaseInfo.Field<Links>("Lk_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Ls_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Id = new DataBaseInfo.Field<Links>("Ls_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Ls_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Name = new DataBaseInfo.Field<Links>("Ls_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Name = new DataBaseInfo.Field<Links>("Lk_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Url - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Url = new DataBaseInfo.Field<Links>("Lk_Url");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Tax = new DataBaseInfo.Field<Links>("Lk_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lk_IsUse = new DataBaseInfo.Field<Links>("Lk_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Logo = new DataBaseInfo.Field<Links>("Lk_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_LogoSmall - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_LogoSmall = new DataBaseInfo.Field<Links>("Lk_LogoSmall");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lk_IsShow = new DataBaseInfo.Field<Links>("Lk_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Tootip - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Tootip = new DataBaseInfo.Field<Links>("Lk_Tootip");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Email = new DataBaseInfo.Field<Links>("Lk_Email");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_IsApply - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lk_IsApply = new DataBaseInfo.Field<Links>("Lk_IsApply");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_IsVerify - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lk_IsVerify = new DataBaseInfo.Field<Links>("Lk_IsVerify");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_SiteMaster - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_SiteMaster = new DataBaseInfo.Field<Links>("Lk_SiteMaster");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_QQ - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_QQ = new DataBaseInfo.Field<Links>("Lk_QQ");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Mobile - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Mobile = new DataBaseInfo.Field<Links>("Lk_Mobile");
    			
    			/// <summary>
    			/// -1 - 字段名：Lk_Explain - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lk_Explain = new DataBaseInfo.Field<Links>("Lk_Explain");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Links>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Links>("Org_Name");
    		}
    	}
    }
