namespace EntitiesInfo {
    	...
    	public partial class MobileUser : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<MobileUser>("MobileUser");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<MobileUser>();
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Id = new DataBaseInfo.Field<MobileUser>("Mu_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Phone = new DataBaseInfo.Field<MobileUser>("Mu_Phone");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_LastTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Mu_LastTime = new DataBaseInfo.Field<MobileUser>("Mu_LastTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Sex - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Sex = new DataBaseInfo.Field<MobileUser>("Mu_Sex");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Age - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Age = new DataBaseInfo.Field<MobileUser>("Mu_Age");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Post - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Post = new DataBaseInfo.Field<MobileUser>("Mu_Post");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Depart - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Depart = new DataBaseInfo.Field<MobileUser>("Mu_Depart");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Number - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Number = new DataBaseInfo.Field<MobileUser>("Mu_Number");
    			
    			/// <summary>
    			/// -1 - 字段名：Mu_Version - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Mu_Version = new DataBaseInfo.Field<MobileUser>("Mu_Version");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<MobileUser>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<MobileUser>("Org_Name");
    		}
    	}
    }
