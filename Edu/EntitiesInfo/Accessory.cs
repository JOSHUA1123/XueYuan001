namespace EntitiesInfo {
    	...
    	public partial class Accessory : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Accessory>("Accessory");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Accessory>();
    			
    			/// <summary>
    			/// -1 - 字段名：As_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field As_Id = new DataBaseInfo.Field<Accessory>("As_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：As_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field As_Name = new DataBaseInfo.Field<Accessory>("As_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：As_FileName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field As_FileName = new DataBaseInfo.Field<Accessory>("As_FileName");
    			
    			/// <summary>
    			/// -1 - 字段名：As_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field As_Type = new DataBaseInfo.Field<Accessory>("As_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：As_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field As_CrtTime = new DataBaseInfo.Field<Accessory>("As_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：As_Size - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field As_Size = new DataBaseInfo.Field<Accessory>("As_Size");
    			
    			/// <summary>
    			/// -1 - 字段名：As_Uid - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field As_Uid = new DataBaseInfo.Field<Accessory>("As_Uid");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Accessory>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Accessory>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：As_Width - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field As_Width = new DataBaseInfo.Field<Accessory>("As_Width");
    			
    			/// <summary>
    			/// 字段名：As_Height - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field As_Height = new DataBaseInfo.Field<Accessory>("As_Height");
    			
    			/// <summary>
    			/// 字段名：As_Extension - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field As_Extension = new DataBaseInfo.Field<Accessory>("As_Extension");
    			
    			/// <summary>
    			/// 字段名：As_Duration - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field As_Duration = new DataBaseInfo.Field<Accessory>("As_Duration");
    			
    			/// <summary>
    			/// 字段名：As_IsOuter - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field As_IsOuter = new DataBaseInfo.Field<Accessory>("As_IsOuter");
    			
    			/// <summary>
    			/// 字段名：As_IsOther - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field As_IsOther = new DataBaseInfo.Field<Accessory>("As_IsOther");
    		}
    	}
    }
