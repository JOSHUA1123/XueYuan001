namespace EntitiesInfo {
    	...
    	public partial class OutlineEvent : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<OutlineEvent>("OutlineEvent");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<OutlineEvent>();
    			
    			/// <summary>
    			/// 字段名：Oe_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Oe_ID = new DataBaseInfo.Field<OutlineEvent>("Oe_ID");
    			
    			/// <summary>
    			/// 字段名：Ol_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ol_ID = new DataBaseInfo.Field<OutlineEvent>("Ol_ID");
    			
    			/// <summary>
    			/// 字段名：Ol_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ol_UID = new DataBaseInfo.Field<OutlineEvent>("Ol_UID");
    			
    			/// <summary>
    			/// 字段名：Oe_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Title = new DataBaseInfo.Field<OutlineEvent>("Oe_Title");
    			
    			/// <summary>
    			/// 字段名：Oe_Width - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Width = new DataBaseInfo.Field<OutlineEvent>("Oe_Width");
    			
    			/// <summary>
    			/// 字段名：Oe_Height - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Height = new DataBaseInfo.Field<OutlineEvent>("Oe_Height");
    			
    			/// <summary>
    			/// 字段名：Oe_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Oe_IsUse = new DataBaseInfo.Field<OutlineEvent>("Oe_IsUse");
    			
    			/// <summary>
    			/// 字段名：Oe_EventType - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Oe_EventType = new DataBaseInfo.Field<OutlineEvent>("Oe_EventType");
    			
    			/// <summary>
    			/// 字段名：Oe_TriggerPoint - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Oe_TriggerPoint = new DataBaseInfo.Field<OutlineEvent>("Oe_TriggerPoint");
    			
    			/// <summary>
    			/// 字段名：Oe_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Context = new DataBaseInfo.Field<OutlineEvent>("Oe_Context");
    			
    			/// <summary>
    			/// 字段名：Oe_Datatable - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Datatable = new DataBaseInfo.Field<OutlineEvent>("Oe_Datatable");
    			
    			/// <summary>
    			/// 字段名：Oe_Questype - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Questype = new DataBaseInfo.Field<OutlineEvent>("Oe_Questype");
    			
    			/// <summary>
    			/// 字段名：Oe_Answer - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Oe_Answer = new DataBaseInfo.Field<OutlineEvent>("Oe_Answer");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<OutlineEvent>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<OutlineEvent>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Oe_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Oe_CrtTime = new DataBaseInfo.Field<OutlineEvent>("Oe_CrtTime");
    		}
    	}
    }
