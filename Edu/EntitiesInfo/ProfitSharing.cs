namespace EntitiesInfo {
    	...
    	public partial class ProfitSharing : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ProfitSharing>("ProfitSharing");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ProfitSharing>();
    			
    			/// <summary>
    			/// 字段名：Ps_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_ID = new DataBaseInfo.Field<ProfitSharing>("Ps_ID");
    			
    			/// <summary>
    			/// 字段名：Ps_IsTheme - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ps_IsTheme = new DataBaseInfo.Field<ProfitSharing>("Ps_IsTheme");
    			
    			/// <summary>
    			/// 字段名：Ps_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ps_IsUse = new DataBaseInfo.Field<ProfitSharing>("Ps_IsUse");
    			
    			/// <summary>
    			/// 字段名：Ps_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_Level = new DataBaseInfo.Field<ProfitSharing>("Ps_Level");
    			
    			/// <summary>
    			/// 字段名：Ps_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ps_Intro = new DataBaseInfo.Field<ProfitSharing>("Ps_Intro");
    			
    			/// <summary>
    			/// 字段名：Ps_Moneyratio - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_Moneyratio = new DataBaseInfo.Field<ProfitSharing>("Ps_Moneyratio");
    			
    			/// <summary>
    			/// 字段名：Ps_Couponratio - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_Couponratio = new DataBaseInfo.Field<ProfitSharing>("Ps_Couponratio");
    			
    			/// <summary>
    			/// 字段名：Ps_MoneyValue - 数据类型：Decimal
    			/// </summary>
    			public static DataBaseInfo.Field Ps_MoneyValue = new DataBaseInfo.Field<ProfitSharing>("Ps_MoneyValue");
    			
    			/// <summary>
    			/// 字段名：Ps_CouponValue - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_CouponValue = new DataBaseInfo.Field<ProfitSharing>("Ps_CouponValue");
    			
    			/// <summary>
    			/// 字段名：Ps_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_PID = new DataBaseInfo.Field<ProfitSharing>("Ps_PID");
    			
    			/// <summary>
    			/// 字段名：Ps_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ps_Name = new DataBaseInfo.Field<ProfitSharing>("Ps_Name");
    		}
    	}
    }
