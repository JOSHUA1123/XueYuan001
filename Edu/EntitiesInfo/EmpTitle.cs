namespace EntitiesInfo {
    	...
    	public partial class EmpTitle : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<EmpTitle>("EmpTitle");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<EmpTitle>();
    			
    			/// <summary>
    			/// -1 - 字段名：Title_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Title_Id = new DataBaseInfo.Field<EmpTitle>("Title_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Title_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Title_Name = new DataBaseInfo.Field<EmpTitle>("Title_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Title_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Title_IsUse = new DataBaseInfo.Field<EmpTitle>("Title_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Title_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Title_Tax = new DataBaseInfo.Field<EmpTitle>("Title_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Title_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Title_Intro = new DataBaseInfo.Field<EmpTitle>("Title_Intro");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<EmpTitle>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<EmpTitle>("Org_Name");
    		}
    	}
    }
