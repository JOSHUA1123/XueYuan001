namespace EntitiesInfo {
    	...
    	public partial class CouponAccount : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<CouponAccount>("CouponAccount");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<CouponAccount>();
    			
    			/// <summary>
    			/// 字段名：Ca_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ca_ID = new DataBaseInfo.Field<CouponAccount>("Ca_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<CouponAccount>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ca_Total - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Total = new DataBaseInfo.Field<CouponAccount>("Ca_Total");
    			
    			/// <summary>
    			/// 字段名：Ca_TotalAmount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ca_TotalAmount = new DataBaseInfo.Field<CouponAccount>("Ca_TotalAmount");
    			
    			/// <summary>
    			/// 字段名：Ca_Value - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Value = new DataBaseInfo.Field<CouponAccount>("Ca_Value");
    			
    			/// <summary>
    			/// 字段名：Ca_Source - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Source = new DataBaseInfo.Field<CouponAccount>("Ca_Source");
    			
    			/// <summary>
    			/// 字段名：Ca_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Type = new DataBaseInfo.Field<CouponAccount>("Ca_Type");
    			
    			/// <summary>
    			/// 字段名：Ca_Info - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Info = new DataBaseInfo.Field<CouponAccount>("Ca_Info");
    			
    			/// <summary>
    			/// 字段名：Ca_Remark - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Remark = new DataBaseInfo.Field<CouponAccount>("Ca_Remark");
    			
    			/// <summary>
    			/// 字段名：Ca_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Ca_CrtTime = new DataBaseInfo.Field<CouponAccount>("Ca_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<CouponAccount>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Ca_Serial - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ca_Serial = new DataBaseInfo.Field<CouponAccount>("Ca_Serial");
    			
    			/// <summary>
    			/// 字段名：Ca_From - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ca_From = new DataBaseInfo.Field<CouponAccount>("Ca_From");
    			
    			/// <summary>
    			/// 字段名：Rc_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Code = new DataBaseInfo.Field<CouponAccount>("Rc_Code");
    		}
    	}
    }
