namespace EntitiesInfo {
    	...
    	public partial class ManageMenu : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ManageMenu>("ManageMenu");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ManageMenu>();
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_Id = new DataBaseInfo.Field<ManageMenu>("MM_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Name = new DataBaseInfo.Field<ManageMenu>("MM_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Type = new DataBaseInfo.Field<ManageMenu>("MM_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Root - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_Root = new DataBaseInfo.Field<ManageMenu>("MM_Root");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Link - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Link = new DataBaseInfo.Field<ManageMenu>("MM_Link");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Marker - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Marker = new DataBaseInfo.Field<ManageMenu>("MM_Marker");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_Tax = new DataBaseInfo.Field<ManageMenu>("MM_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_PatId - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_PatId = new DataBaseInfo.Field<ManageMenu>("MM_PatId");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Color - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Color = new DataBaseInfo.Field<ManageMenu>("MM_Color");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Font - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Font = new DataBaseInfo.Field<ManageMenu>("MM_Font");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_IsBold - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MM_IsBold = new DataBaseInfo.Field<ManageMenu>("MM_IsBold");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_IsItalic - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MM_IsItalic = new DataBaseInfo.Field<ManageMenu>("MM_IsItalic");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_IcoS - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_IcoS = new DataBaseInfo.Field<ManageMenu>("MM_IcoS");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_IcoB - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_IcoB = new DataBaseInfo.Field<ManageMenu>("MM_IcoB");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MM_IsUse = new DataBaseInfo.Field<ManageMenu>("MM_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MM_IsShow = new DataBaseInfo.Field<ManageMenu>("MM_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Intro = new DataBaseInfo.Field<ManageMenu>("MM_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_State - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MM_State = new DataBaseInfo.Field<ManageMenu>("MM_State");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_Func - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MM_Func = new DataBaseInfo.Field<ManageMenu>("MM_Func");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_WinWidth - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_WinWidth = new DataBaseInfo.Field<ManageMenu>("MM_WinWidth");
    			
    			/// <summary>
    			/// -1 - 字段名：MM_WinHeight - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_WinHeight = new DataBaseInfo.Field<ManageMenu>("MM_WinHeight");
    			
    			/// <summary>
    			/// 字段名：MM_IcoX - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_IcoX = new DataBaseInfo.Field<ManageMenu>("MM_IcoX");
    			
    			/// <summary>
    			/// 字段名：MM_IcoY - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MM_IcoY = new DataBaseInfo.Field<ManageMenu>("MM_IcoY");
    		}
    	}
    }
