namespace EntitiesInfo {
    	...
    	public partial class SingleSignOn : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<SingleSignOn>("SingleSignOn");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<SingleSignOn>();
    			
    			/// <summary>
    			/// 字段名：SSO_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field SSO_ID = new DataBaseInfo.Field<SingleSignOn>("SSO_ID");
    			
    			/// <summary>
    			/// 字段名：SSO_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Name = new DataBaseInfo.Field<SingleSignOn>("SSO_Name");
    			
    			/// <summary>
    			/// 字段名：SSO_IsUse - 数据类型：Boolean(可空)
    			/// </summary>
    			public static DataBaseInfo.Field SSO_IsUse = new DataBaseInfo.Field<SingleSignOn>("SSO_IsUse");
    			
    			/// <summary>
    			/// 字段名：SSO_APPID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_APPID = new DataBaseInfo.Field<SingleSignOn>("SSO_APPID");
    			
    			/// <summary>
    			/// 字段名：SSO_IsAdd - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field SSO_IsAdd = new DataBaseInfo.Field<SingleSignOn>("SSO_IsAdd");
    			
    			/// <summary>
    			/// 字段名：SSO_Domain - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Domain = new DataBaseInfo.Field<SingleSignOn>("SSO_Domain");
    			
    			/// <summary>
    			/// 字段名：SSO_Direction - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Direction = new DataBaseInfo.Field<SingleSignOn>("SSO_Direction");
    			
    			/// <summary>
    			/// 字段名：SSO_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Phone = new DataBaseInfo.Field<SingleSignOn>("SSO_Phone");
    			
    			/// <summary>
    			/// 字段名：SSO_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Email = new DataBaseInfo.Field<SingleSignOn>("SSO_Email");
    			
    			/// <summary>
    			/// 字段名：SSO_Info - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Info = new DataBaseInfo.Field<SingleSignOn>("SSO_Info");
    			
    			/// <summary>
    			/// 字段名：SSO_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field SSO_CrtTime = new DataBaseInfo.Field<SingleSignOn>("SSO_CrtTime");
    			
    			/// <summary>
    			/// 字段名：SSO_Power - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Power = new DataBaseInfo.Field<SingleSignOn>("SSO_Power");
    			
    			/// <summary>
    			/// 字段名：SSO_Config - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field SSO_Config = new DataBaseInfo.Field<SingleSignOn>("SSO_Config");
    		}
    	}
    }
