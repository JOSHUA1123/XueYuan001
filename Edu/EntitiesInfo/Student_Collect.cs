namespace EntitiesInfo {
    	...
    	public partial class Student_Collect : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Student_Collect>("Student_Collect");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Student_Collect>();
    			
    			/// <summary>
    			/// 字段名：Stc_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Stc_ID = new DataBaseInfo.Field<Student_Collect>("Stc_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Student_Collect>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Student_Collect>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ID = new DataBaseInfo.Field<Student_Collect>("Qus_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Type = new DataBaseInfo.Field<Student_Collect>("Qus_Type");
    			
    			/// <summary>
    			/// 字段名：Qus_Diff - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Diff = new DataBaseInfo.Field<Student_Collect>("Qus_Diff");
    			
    			/// <summary>
    			/// 字段名：Qus_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Title = new DataBaseInfo.Field<Student_Collect>("Qus_Title");
    			
    			/// <summary>
    			/// 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<Student_Collect>("Sbj_ID");
    			
    			/// <summary>
    			/// 字段名：Stc_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Stc_Level = new DataBaseInfo.Field<Student_Collect>("Stc_Level");
    			
    			/// <summary>
    			/// 字段名：Stc_Strange - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Stc_Strange = new DataBaseInfo.Field<Student_Collect>("Stc_Strange");
    			
    			/// <summary>
    			/// 字段名：Stc_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Stc_CrtTime = new DataBaseInfo.Field<Student_Collect>("Stc_CrtTime");
    		}
    	}
    }
