namespace EntitiesInfo {
    	...
    	public partial class ProductPackage : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ProductPackage>("ProductPackage");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ProductPackage>();
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field PPK_Id = new DataBaseInfo.Field<ProductPackage>("PPK_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field PPK_Name = new DataBaseInfo.Field<ProductPackage>("PPK_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field PPK_IsUse = new DataBaseInfo.Field<ProductPackage>("PPK_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field PPK_Logo = new DataBaseInfo.Field<ProductPackage>("PPK_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_Price - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field PPK_Price = new DataBaseInfo.Field<ProductPackage>("PPK_Price");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_DiscountPrice - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field PPK_DiscountPrice = new DataBaseInfo.Field<ProductPackage>("PPK_DiscountPrice");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_StartTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field PPK_StartTime = new DataBaseInfo.Field<ProductPackage>("PPK_StartTime");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_EndTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field PPK_EndTime = new DataBaseInfo.Field<ProductPackage>("PPK_EndTime");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field PPK_Intro = new DataBaseInfo.Field<ProductPackage>("PPK_Intro");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ProductPackage>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ProductPackage>("Org_Name");
    		}
    	}
    }
