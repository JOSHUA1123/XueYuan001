namespace EntitiesInfo {
    	...
    	public partial class SmsMessage : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<SmsMessage>("SmsMessage");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<SmsMessage>();
    			
    			/// <summary>
    			/// -1 - 字段名：SMS_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field SMS_Id = new DataBaseInfo.Field<SmsMessage>("SMS_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sms_Context = new DataBaseInfo.Field<SmsMessage>("Sms_Context");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_SendTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sms_SendTime = new DataBaseInfo.Field<SmsMessage>("Sms_SendTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sms_CrtTime = new DataBaseInfo.Field<SmsMessage>("Sms_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_Type - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sms_Type = new DataBaseInfo.Field<SmsMessage>("Sms_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_SendId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sms_SendId = new DataBaseInfo.Field<SmsMessage>("Sms_SendId");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_SendName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sms_SendName = new DataBaseInfo.Field<SmsMessage>("Sms_SendName");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_MailBox - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sms_MailBox = new DataBaseInfo.Field<SmsMessage>("Sms_MailBox");
    			
    			/// <summary>
    			/// -1 - 字段名：Sms_State - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sms_State = new DataBaseInfo.Field<SmsMessage>("Sms_State");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<SmsMessage>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<SmsMessage>("Org_Name");
    		}
    	}
    }
