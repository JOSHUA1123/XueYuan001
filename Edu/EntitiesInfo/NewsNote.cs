namespace EntitiesInfo {
    	...
    	public partial class NewsNote : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<NewsNote>("NewsNote");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<NewsNote>();
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Nn_Id = new DataBaseInfo.Field<NewsNote>("Nn_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Art_Id = new DataBaseInfo.Field<NewsNote>("Art_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_Name = new DataBaseInfo.Field<NewsNote>("Nn_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_Title = new DataBaseInfo.Field<NewsNote>("Nn_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_Details = new DataBaseInfo.Field<NewsNote>("Nn_Details");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Nn_CrtTime = new DataBaseInfo.Field<NewsNote>("Nn_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_IP = new DataBaseInfo.Field<NewsNote>("Nn_IP");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Nn_IsShow = new DataBaseInfo.Field<NewsNote>("Nn_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_Email = new DataBaseInfo.Field<NewsNote>("Nn_Email");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_Province - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_Province = new DataBaseInfo.Field<NewsNote>("Nn_Province");
    			
    			/// <summary>
    			/// -1 - 字段名：Nn_City - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nn_City = new DataBaseInfo.Field<NewsNote>("Nn_City");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<NewsNote>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<NewsNote>("Org_Name");
    		}
    	}
    }
