namespace EntitiesInfo {
    	...
    	public partial class Purview : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Purview>("Purview");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Purview>();
    			
    			/// <summary>
    			/// False - 字段名：Pur_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pur_Id = new DataBaseInfo.Field<Purview>("Pur_Id");
    			
    			/// <summary>
    			/// False - 字段名：Dep_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<Purview>("Dep_Id");
    			
    			/// <summary>
    			/// False - 字段名：EGrp_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_Id = new DataBaseInfo.Field<Purview>("EGrp_Id");
    			
    			/// <summary>
    			/// False - 字段名：Posi_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Id = new DataBaseInfo.Field<Purview>("Posi_Id");
    			
    			/// <summary>
    			/// False - 字段名：MM_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field MM_Id = new DataBaseInfo.Field<Purview>("MM_Id");
    			
    			/// <summary>
    			/// True - 字段名：Pur_State - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pur_State = new DataBaseInfo.Field<Purview>("Pur_State");
    			
    			/// <summary>
    			/// True - 字段名：Pur_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pur_Type = new DataBaseInfo.Field<Purview>("Pur_Type");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Purview>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Olv_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Olv_ID = new DataBaseInfo.Field<Purview>("Olv_ID");
    		}
    	}
    }
