namespace EntitiesInfo {
    	...
    	public partial class TeacherHistory : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<TeacherHistory>("TeacherHistory");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<TeacherHistory>();
    			
    			/// <summary>
    			/// 字段名：Thh_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Thh_ID = new DataBaseInfo.Field<TeacherHistory>("Thh_ID");
    			
    			/// <summary>
    			/// 字段名：Thh_Theme - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Theme = new DataBaseInfo.Field<TeacherHistory>("Thh_Theme");
    			
    			/// <summary>
    			/// 字段名：Thh_StartTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Thh_StartTime = new DataBaseInfo.Field<TeacherHistory>("Thh_StartTime");
    			
    			/// <summary>
    			/// 字段名：Thh_EndTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Thh_EndTime = new DataBaseInfo.Field<TeacherHistory>("Thh_EndTime");
    			
    			/// <summary>
    			/// 字段名：Thh_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Thh_CrtTime = new DataBaseInfo.Field<TeacherHistory>("Thh_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Thh_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Type = new DataBaseInfo.Field<TeacherHistory>("Thh_Type");
    			
    			/// <summary>
    			/// 字段名：Thh_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Intro = new DataBaseInfo.Field<TeacherHistory>("Thh_Intro");
    			
    			/// <summary>
    			/// 字段名：Thh_Success - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Success = new DataBaseInfo.Field<TeacherHistory>("Thh_Success");
    			
    			/// <summary>
    			/// 字段名：Thh_School - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_School = new DataBaseInfo.Field<TeacherHistory>("Thh_School");
    			
    			/// <summary>
    			/// 字段名：Thh_Major - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Major = new DataBaseInfo.Field<TeacherHistory>("Thh_Major");
    			
    			/// <summary>
    			/// 字段名：Thh_Education - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Education = new DataBaseInfo.Field<TeacherHistory>("Thh_Education");
    			
    			/// <summary>
    			/// 字段名：Thh_Compay - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Compay = new DataBaseInfo.Field<TeacherHistory>("Thh_Compay");
    			
    			/// <summary>
    			/// 字段名：Thh_Job - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Job = new DataBaseInfo.Field<TeacherHistory>("Thh_Job");
    			
    			/// <summary>
    			/// 字段名：Thh_Post - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thh_Post = new DataBaseInfo.Field<TeacherHistory>("Thh_Post");
    			
    			/// <summary>
    			/// 字段名：Th_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<TeacherHistory>("Th_ID");
    			
    			/// <summary>
    			/// 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<TeacherHistory>("Th_Name");
    		}
    	}
    }
