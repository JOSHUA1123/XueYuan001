namespace EntitiesInfo {
    	...
    	public partial class MoneyAccount : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<MoneyAccount>("MoneyAccount");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<MoneyAccount>();
    			
    			/// <summary>
    			/// 字段名：Ma_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ma_ID = new DataBaseInfo.Field<MoneyAccount>("Ma_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<MoneyAccount>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ma_Total - 数据类型：Decimal
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Total = new DataBaseInfo.Field<MoneyAccount>("Ma_Total");
    			
    			/// <summary>
    			/// 字段名：Ma_Money - 数据类型：Decimal
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Money = new DataBaseInfo.Field<MoneyAccount>("Ma_Money");
    			
    			/// <summary>
    			/// 字段名：Ma_Source - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Source = new DataBaseInfo.Field<MoneyAccount>("Ma_Source");
    			
    			/// <summary>
    			/// 字段名：Ma_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Type = new DataBaseInfo.Field<MoneyAccount>("Ma_Type");
    			
    			/// <summary>
    			/// 字段名：Ma_Info - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Info = new DataBaseInfo.Field<MoneyAccount>("Ma_Info");
    			
    			/// <summary>
    			/// 字段名：Ma_Remark - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Remark = new DataBaseInfo.Field<MoneyAccount>("Ma_Remark");
    			
    			/// <summary>
    			/// 字段名：Ma_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Ma_CrtTime = new DataBaseInfo.Field<MoneyAccount>("Ma_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Rc_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Code = new DataBaseInfo.Field<MoneyAccount>("Rc_Code");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<MoneyAccount>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Ma_Serial - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Serial = new DataBaseInfo.Field<MoneyAccount>("Ma_Serial");
    			
    			/// <summary>
    			/// 字段名：Ma_IsSuccess - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ma_IsSuccess = new DataBaseInfo.Field<MoneyAccount>("Ma_IsSuccess");
    			
    			/// <summary>
    			/// 字段名：Ma_From - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ma_From = new DataBaseInfo.Field<MoneyAccount>("Ma_From");
    			
    			/// <summary>
    			/// 字段名：Pai_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pai_ID = new DataBaseInfo.Field<MoneyAccount>("Pai_ID");
    			
    			/// <summary>
    			/// 字段名：Ma_Status - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Status = new DataBaseInfo.Field<MoneyAccount>("Ma_Status");
    			
    			/// <summary>
    			/// 字段名：Ma_Buyer - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Buyer = new DataBaseInfo.Field<MoneyAccount>("Ma_Buyer");
    			
    			/// <summary>
    			/// 字段名：Ma_Seller - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ma_Seller = new DataBaseInfo.Field<MoneyAccount>("Ma_Seller");
    		}
    	}
    }
