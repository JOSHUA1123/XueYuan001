namespace EntitiesInfo {
    	...
    	public partial class DailyLog : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<DailyLog>("DailyLog");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<DailyLog>();
    			
    			/// <summary>
    			/// False - 字段名：Dlog_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dlog_Id = new DataBaseInfo.Field<DailyLog>("Dlog_Id");
    			
    			/// <summary>
    			/// True - 字段名：Dlog_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dlog_Type = new DataBaseInfo.Field<DailyLog>("Dlog_Type");
    			
    			/// <summary>
    			/// True - 字段名：Dlog_Note - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dlog_Note = new DataBaseInfo.Field<DailyLog>("Dlog_Note");
    			
    			/// <summary>
    			/// True - 字段名：Dlog_Plan - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dlog_Plan = new DataBaseInfo.Field<DailyLog>("Dlog_Plan");
    			
    			/// <summary>
    			/// False - 字段名：Dlog_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Dlog_CrtTime = new DataBaseInfo.Field<DailyLog>("Dlog_CrtTime");
    			
    			/// <summary>
    			/// False - 字段名：Dlog_WrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Dlog_WrtTime = new DataBaseInfo.Field<DailyLog>("Dlog_WrtTime");
    			
    			/// <summary>
    			/// False - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<DailyLog>("Acc_Id");
    			
    			/// <summary>
    			/// True - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<DailyLog>("Acc_Name");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<DailyLog>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<DailyLog>("Org_Name");
    		}
    	}
    }
