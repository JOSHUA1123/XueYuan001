namespace EntitiesInfo {
    	...
    	public partial class AddressSort : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<AddressSort>("AddressSort");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<AddressSort>();
    			
    			/// <summary>
    			/// -1 - 字段名：Ads_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ads_Id = new DataBaseInfo.Field<AddressSort>("Ads_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Ads_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ads_Name = new DataBaseInfo.Field<AddressSort>("Ads_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Ads_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ads_IsUse = new DataBaseInfo.Field<AddressSort>("Ads_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Ads_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ads_CrtTime = new DataBaseInfo.Field<AddressSort>("Ads_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Ads_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ads_Tax = new DataBaseInfo.Field<AddressSort>("Ads_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<AddressSort>("Acc_Id");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<AddressSort>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<AddressSort>("Org_Name");
    		}
    	}
    }
