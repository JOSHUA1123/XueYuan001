namespace EntitiesInfo {
    	...
    	public partial class Special : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Special>("Special");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Special>();
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Id = new DataBaseInfo.Field<Special>("Sp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_PatId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sp_PatId = new DataBaseInfo.Field<Special>("Sp_PatId");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Tax = new DataBaseInfo.Field<Special>("Sp_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Name = new DataBaseInfo.Field<Special>("Sp_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sp_IsUse = new DataBaseInfo.Field<Special>("Sp_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sp_IsShow = new DataBaseInfo.Field<Special>("Sp_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_IsOut - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sp_IsOut = new DataBaseInfo.Field<Special>("Sp_IsOut");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_OutUrl - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_OutUrl = new DataBaseInfo.Field<Special>("Sp_OutUrl");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Intro = new DataBaseInfo.Field<Special>("Sp_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Details = new DataBaseInfo.Field<Special>("Sp_Details");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Keywords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Keywords = new DataBaseInfo.Field<Special>("Sp_Keywords");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Descr = new DataBaseInfo.Field<Special>("Sp_Descr");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_PushTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sp_PushTime = new DataBaseInfo.Field<Special>("Sp_PushTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Label - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Label = new DataBaseInfo.Field<Special>("Sp_Label");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Tootip - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Tootip = new DataBaseInfo.Field<Special>("Sp_Tootip");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Banner - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Banner = new DataBaseInfo.Field<Special>("Sp_Banner");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Uid - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Uid = new DataBaseInfo.Field<Special>("Sp_Uid");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Logo = new DataBaseInfo.Field<Special>("Sp_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_QrCode - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sp_QrCode = new DataBaseInfo.Field<Special>("Sp_QrCode");
    			
    			/// <summary>
    			/// -1 - 字段名：OtherData - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field OtherData = new DataBaseInfo.Field<Special>("OtherData");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Special>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Special>("Org_Name");
    		}
    	}
    }
