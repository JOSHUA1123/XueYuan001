namespace EntitiesInfo {
    	...
    	public partial class Student_Notes : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Student_Notes>("Student_Notes");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Student_Notes>();
    			
    			/// <summary>
    			/// 字段名：Stn_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Stn_ID = new DataBaseInfo.Field<Student_Notes>("Stn_ID");
    			
    			/// <summary>
    			/// 字段名：Stn_PID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Stn_PID = new DataBaseInfo.Field<Student_Notes>("Stn_PID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Student_Notes>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Student_Notes>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ID = new DataBaseInfo.Field<Student_Notes>("Qus_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Type = new DataBaseInfo.Field<Student_Notes>("Qus_Type");
    			
    			/// <summary>
    			/// 字段名：Qus_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Title = new DataBaseInfo.Field<Student_Notes>("Qus_Title");
    			
    			/// <summary>
    			/// 字段名：Stn_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Stn_Title = new DataBaseInfo.Field<Student_Notes>("Stn_Title");
    			
    			/// <summary>
    			/// 字段名：Stn_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Stn_Context = new DataBaseInfo.Field<Student_Notes>("Stn_Context");
    			
    			/// <summary>
    			/// 字段名：Stn_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Stn_CrtTime = new DataBaseInfo.Field<Student_Notes>("Stn_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Student_Notes>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Student_Notes>("Org_Name");
    		}
    	}
    }
