namespace EntitiesInfo {
    	...
    	public partial class PayInterface : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<PayInterface>("PayInterface");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<PayInterface>();
    			
    			/// <summary>
    			/// 字段名：Pai_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pai_ID = new DataBaseInfo.Field<PayInterface>("Pai_ID");
    			
    			/// <summary>
    			/// 字段名：Pai_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Name = new DataBaseInfo.Field<PayInterface>("Pai_Name");
    			
    			/// <summary>
    			/// 字段名：Pai_Pattern - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Pattern = new DataBaseInfo.Field<PayInterface>("Pai_Pattern");
    			
    			/// <summary>
    			/// 字段名：Pai_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Tax = new DataBaseInfo.Field<PayInterface>("Pai_Tax");
    			
    			/// <summary>
    			/// 字段名：Pai_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Intro = new DataBaseInfo.Field<PayInterface>("Pai_Intro");
    			
    			/// <summary>
    			/// 字段名：Pai_Currency - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Currency = new DataBaseInfo.Field<PayInterface>("Pai_Currency");
    			
    			/// <summary>
    			/// 字段名：Pai_Platform - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Platform = new DataBaseInfo.Field<PayInterface>("Pai_Platform");
    			
    			/// <summary>
    			/// 字段名：Pai_ParterID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_ParterID = new DataBaseInfo.Field<PayInterface>("Pai_ParterID");
    			
    			/// <summary>
    			/// 字段名：Pai_Key - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Key = new DataBaseInfo.Field<PayInterface>("Pai_Key");
    			
    			/// <summary>
    			/// 字段名：Pai_InterfaceType - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_InterfaceType = new DataBaseInfo.Field<PayInterface>("Pai_InterfaceType");
    			
    			/// <summary>
    			/// 字段名：Pai_Feerate - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Feerate = new DataBaseInfo.Field<PayInterface>("Pai_Feerate");
    			
    			/// <summary>
    			/// 字段名：Pai_Config - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Config = new DataBaseInfo.Field<PayInterface>("Pai_Config");
    			
    			/// <summary>
    			/// 字段名：Pai_IsEnable - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pai_IsEnable = new DataBaseInfo.Field<PayInterface>("Pai_IsEnable");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<PayInterface>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Pai_Returl - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Returl = new DataBaseInfo.Field<PayInterface>("Pai_Returl");
    			
    			/// <summary>
    			/// 字段名：Pai_Scene - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pai_Scene = new DataBaseInfo.Field<PayInterface>("Pai_Scene");
    		}
    	}
    }
