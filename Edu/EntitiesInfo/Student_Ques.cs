namespace EntitiesInfo {
    	...
    	public partial class Student_Ques : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Student_Ques>("Student_Ques");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Student_Ques>();
    			
    			/// <summary>
    			/// 字段名：Squs_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Squs_ID = new DataBaseInfo.Field<Student_Ques>("Squs_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Student_Ques>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Student_Ques>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ID = new DataBaseInfo.Field<Student_Ques>("Qus_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Type = new DataBaseInfo.Field<Student_Ques>("Qus_Type");
    			
    			/// <summary>
    			/// 字段名：Qus_Diff - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Diff = new DataBaseInfo.Field<Student_Ques>("Qus_Diff");
    			
    			/// <summary>
    			/// 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<Student_Ques>("Sbj_ID");
    			
    			/// <summary>
    			/// 字段名：Squs_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Squs_Level = new DataBaseInfo.Field<Student_Ques>("Squs_Level");
    			
    			/// <summary>
    			/// 字段名：Squs_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Squs_CrtTime = new DataBaseInfo.Field<Student_Ques>("Squs_CrtTime");
    		}
    	}
    }
