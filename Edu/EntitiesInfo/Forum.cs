namespace EntitiesInfo {
    	...
    	public partial class Forum : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Forum>("Forum");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Forum>();
    			
    			/// <summary>
    			/// 字段名：Fm_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Fm_ID = new DataBaseInfo.Field<Forum>("Fm_ID");
    			
    			/// <summary>
    			/// 字段名：Fm_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Fm_Title = new DataBaseInfo.Field<Forum>("Fm_Title");
    			
    			/// <summary>
    			/// 字段名：Fm_IsTheme - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Fm_IsTheme = new DataBaseInfo.Field<Forum>("Fm_IsTheme");
    			
    			/// <summary>
    			/// 字段名：Fm_Content - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Fm_Content = new DataBaseInfo.Field<Forum>("Fm_Content");
    			
    			/// <summary>
    			/// 字段名：Fm_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Fm_PID = new DataBaseInfo.Field<Forum>("Fm_PID");
    			
    			/// <summary>
    			/// 字段名：Fm_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Fm_UID = new DataBaseInfo.Field<Forum>("Fm_UID");
    			
    			/// <summary>
    			/// 字段名：Fm_At - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Fm_At = new DataBaseInfo.Field<Forum>("Fm_At");
    			
    			/// <summary>
    			/// 字段名：Fm_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Fm_CrtTime = new DataBaseInfo.Field<Forum>("Fm_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Fm_LastTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Fm_LastTime = new DataBaseInfo.Field<Forum>("Fm_LastTime");
    			
    			/// <summary>
    			/// 字段名：Fm_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Fm_IP = new DataBaseInfo.Field<Forum>("Fm_IP");
    			
    			/// <summary>
    			/// 字段名：Fm_ViewNumber - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Fm_ViewNumber = new DataBaseInfo.Field<Forum>("Fm_ViewNumber");
    			
    			/// <summary>
    			/// 字段名：Fm_ReplyNumber - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Fm_ReplyNumber = new DataBaseInfo.Field<Forum>("Fm_ReplyNumber");
    			
    			/// <summary>
    			/// 字段名：Fm_IsDel - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Fm_IsDel = new DataBaseInfo.Field<Forum>("Fm_IsDel");
    			
    			/// <summary>
    			/// 字段名：Fm_IsTop - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Fm_IsTop = new DataBaseInfo.Field<Forum>("Fm_IsTop");
    			
    			/// <summary>
    			/// 字段名：Fm_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Fm_IsRec = new DataBaseInfo.Field<Forum>("Fm_IsRec");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Forum>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Name = new DataBaseInfo.Field<Forum>("Ac_Name");
    			
    			/// <summary>
    			/// 字段名：Th_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<Forum>("Th_ID");
    			
    			/// <summary>
    			/// 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<Forum>("Th_Name");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Forum>("Org_ID");
    		}
    	}
    }
