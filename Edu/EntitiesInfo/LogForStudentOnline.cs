namespace EntitiesInfo {
    	...
    	public partial class LogForStudentOnline : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LogForStudentOnline>("LogForStudentOnline");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LogForStudentOnline>();
    			
    			/// <summary>
    			/// 字段名：Lso_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lso_ID = new DataBaseInfo.Field<LogForStudentOnline>("Lso_ID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<LogForStudentOnline>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<LogForStudentOnline>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_AccName = new DataBaseInfo.Field<LogForStudentOnline>("Ac_AccName");
    			
    			/// <summary>
    			/// 字段名：Ac_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Name = new DataBaseInfo.Field<LogForStudentOnline>("Ac_Name");
    			
    			/// <summary>
    			/// 字段名：Lso_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lso_UID = new DataBaseInfo.Field<LogForStudentOnline>("Lso_UID");
    			
    			/// <summary>
    			/// 字段名：Lso_LoginDate - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lso_LoginDate = new DataBaseInfo.Field<LogForStudentOnline>("Lso_LoginDate");
    			
    			/// <summary>
    			/// 字段名：Lso_LoginTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lso_LoginTime = new DataBaseInfo.Field<LogForStudentOnline>("Lso_LoginTime");
    			
    			/// <summary>
    			/// 字段名：Lso_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lso_LastTime = new DataBaseInfo.Field<LogForStudentOnline>("Lso_LastTime");
    			
    			/// <summary>
    			/// 字段名：Lso_LogoutTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lso_LogoutTime = new DataBaseInfo.Field<LogForStudentOnline>("Lso_LogoutTime");
    			
    			/// <summary>
    			/// 字段名：Lso_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lso_CrtTime = new DataBaseInfo.Field<LogForStudentOnline>("Lso_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Lso_OnlineTime - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lso_OnlineTime = new DataBaseInfo.Field<LogForStudentOnline>("Lso_OnlineTime");
    			
    			/// <summary>
    			/// 字段名：Lso_BrowseTime - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lso_BrowseTime = new DataBaseInfo.Field<LogForStudentOnline>("Lso_BrowseTime");
    			
    			/// <summary>
    			/// 字段名：Lso_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lso_IP = new DataBaseInfo.Field<LogForStudentOnline>("Lso_IP");
    			
    			/// <summary>
    			/// 字段名：Lso_Browser - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lso_Browser = new DataBaseInfo.Field<LogForStudentOnline>("Lso_Browser");
    			
    			/// <summary>
    			/// 字段名：Lso_Platform - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lso_Platform = new DataBaseInfo.Field<LogForStudentOnline>("Lso_Platform");
    			
    			/// <summary>
    			/// 字段名：Lso_OS - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lso_OS = new DataBaseInfo.Field<LogForStudentOnline>("Lso_OS");
    		}
    	}
    }
