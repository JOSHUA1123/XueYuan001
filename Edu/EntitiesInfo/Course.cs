namespace EntitiesInfo {
    	...
    	public partial class Course : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Course>("Course");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Course>();
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Course>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Name = new DataBaseInfo.Field<Course>("Cou_Name");
    			
    			/// <summary>
    			/// 字段名：Cou_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Logo = new DataBaseInfo.Field<Course>("Cou_Logo");
    			
    			/// <summary>
    			/// 字段名：Cou_LogoSmall - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_LogoSmall = new DataBaseInfo.Field<Course>("Cou_LogoSmall");
    			
    			/// <summary>
    			/// 字段名：Cou_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Tax = new DataBaseInfo.Field<Course>("Cou_Tax");
    			
    			/// <summary>
    			/// 字段名：Cou_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Intro = new DataBaseInfo.Field<Course>("Cou_Intro");
    			
    			/// <summary>
    			/// 字段名：Cou_Target - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Target = new DataBaseInfo.Field<Course>("Cou_Target");
    			
    			/// <summary>
    			/// 字段名：Cou_Content - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Content = new DataBaseInfo.Field<Course>("Cou_Content");
    			
    			/// <summary>
    			/// 字段名：Cou_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_IsUse = new DataBaseInfo.Field<Course>("Cou_IsUse");
    			
    			/// <summary>
    			/// 字段名：Cou_IsFree - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_IsFree = new DataBaseInfo.Field<Course>("Cou_IsFree");
    			
    			/// <summary>
    			/// 字段名：Cou_IsStudy - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_IsStudy = new DataBaseInfo.Field<Course>("Cou_IsStudy");
    			
    			/// <summary>
    			/// 字段名：Cou_StudentSum - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_StudentSum = new DataBaseInfo.Field<Course>("Cou_StudentSum");
    			
    			/// <summary>
    			/// 字段名：Cou_Price - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Price = new DataBaseInfo.Field<Course>("Cou_Price");
    			
    			/// <summary>
    			/// 字段名：Cou_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Cou_CrtTime = new DataBaseInfo.Field<Course>("Cou_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Cou_Score - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Score = new DataBaseInfo.Field<Course>("Cou_Score");
    			
    			/// <summary>
    			/// 字段名：Cou_ViewNum - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ViewNum = new DataBaseInfo.Field<Course>("Cou_ViewNum");
    			
    			/// <summary>
    			/// 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<Course>("Sbj_ID");
    			
    			/// <summary>
    			/// 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<Course>("Sbj_Name");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Course>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Course>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Th_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<Course>("Th_ID");
    			
    			/// <summary>
    			/// 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<Course>("Th_Name");
    			
    			/// <summary>
    			/// 字段名：Cou_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_PID = new DataBaseInfo.Field<Course>("Cou_PID");
    			
    			/// <summary>
    			/// 字段名：Cou_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Level = new DataBaseInfo.Field<Course>("Cou_Level");
    			
    			/// <summary>
    			/// 字段名：Cou_XPath - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_XPath = new DataBaseInfo.Field<Course>("Cou_XPath");
    			
    			/// <summary>
    			/// 字段名：Cou_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_UID = new DataBaseInfo.Field<Course>("Cou_UID");
    			
    			/// <summary>
    			/// 字段名：Cou_IsTry - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_IsTry = new DataBaseInfo.Field<Course>("Cou_IsTry");
    			
    			/// <summary>
    			/// 字段名：Cou_TryNum - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_TryNum = new DataBaseInfo.Field<Course>("Cou_TryNum");
    			
    			/// <summary>
    			/// 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<Course>("Dep_Id");
    			
    			/// <summary>
    			/// 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<Course>("Dep_CnName");
    			
    			/// <summary>
    			/// 字段名：Cou_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_IsRec = new DataBaseInfo.Field<Course>("Cou_IsRec");
    			
    			/// <summary>
    			/// 字段名：Cou_PriceUnit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_PriceUnit = new DataBaseInfo.Field<Course>("Cou_PriceUnit");
    			
    			/// <summary>
    			/// 字段名：Cou_PriceSpan - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_PriceSpan = new DataBaseInfo.Field<Course>("Cou_PriceSpan");
    			
    			/// <summary>
    			/// 字段名：Cou_IsLimitFree - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_IsLimitFree = new DataBaseInfo.Field<Course>("Cou_IsLimitFree");
    			
    			/// <summary>
    			/// 字段名：Cou_FreeStart - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Cou_FreeStart = new DataBaseInfo.Field<Course>("Cou_FreeStart");
    			
    			/// <summary>
    			/// 字段名：Cou_FreeEnd - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Cou_FreeEnd = new DataBaseInfo.Field<Course>("Cou_FreeEnd");
    			
    			/// <summary>
    			/// 字段名：Cou_ExistLive - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ExistLive = new DataBaseInfo.Field<Course>("Cou_ExistLive");
    			
    			/// <summary>
    			/// 字段名：Cou_ExistQues - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ExistQues = new DataBaseInfo.Field<Course>("Cou_ExistQues");
    			
    			/// <summary>
    			/// 字段名：Cou_ExistExam - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ExistExam = new DataBaseInfo.Field<Course>("Cou_ExistExam");
    		}
    	}
    }
