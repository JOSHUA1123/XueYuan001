namespace EntitiesInfo {
    	...
    	public partial class ExamResultsTemp : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ExamResultsTemp>("ExamResultsTemp");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ExamResultsTemp>();
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Exr_ID = new DataBaseInfo.Field<ExamResultsTemp>("Exr_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Score - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Score = new DataBaseInfo.Field<ExamResultsTemp>("Exr_Score");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Results - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Results = new DataBaseInfo.Field<ExamResultsTemp>("Exr_Results");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Exr_CrtTime = new DataBaseInfo.Field<ExamResultsTemp>("Exr_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exr_IP = new DataBaseInfo.Field<ExamResultsTemp>("Exr_IP");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Mac - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Mac = new DataBaseInfo.Field<ExamResultsTemp>("Exr_Mac");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_IsSubmit - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Exr_IsSubmit = new DataBaseInfo.Field<ExamResultsTemp>("Exr_IsSubmit");
    			
    			/// <summary>
    			/// -1 - 字段名：Exam_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Exam_ID = new DataBaseInfo.Field<ExamResultsTemp>("Exam_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<ExamResultsTemp>("Sbj_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Id = new DataBaseInfo.Field<ExamResultsTemp>("Tp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<ExamResultsTemp>("Acc_Id");
    		}
    	}
    }
