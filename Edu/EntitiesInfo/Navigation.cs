namespace EntitiesInfo {
    	...
    	public partial class Navigation : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Navigation>("Navigation");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Navigation>();
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Nav_ID = new DataBaseInfo.Field<Navigation>("Nav_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Nav_PID = new DataBaseInfo.Field<Navigation>("Nav_PID");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Name = new DataBaseInfo.Field<Navigation>("Nav_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_EnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_EnName = new DataBaseInfo.Field<Navigation>("Nav_EnName");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Url - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Url = new DataBaseInfo.Field<Navigation>("Nav_Url");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Target - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Target = new DataBaseInfo.Field<Navigation>("Nav_Target");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Event - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Event = new DataBaseInfo.Field<Navigation>("Nav_Event");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Image - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Image = new DataBaseInfo.Field<Navigation>("Nav_Image");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Color - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Color = new DataBaseInfo.Field<Navigation>("Nav_Color");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Font - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Font = new DataBaseInfo.Field<Navigation>("Nav_Font");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Child - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Child = new DataBaseInfo.Field<Navigation>("Nav_Child");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Tax = new DataBaseInfo.Field<Navigation>("Nav_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Intro = new DataBaseInfo.Field<Navigation>("Nav_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Title = new DataBaseInfo.Field<Navigation>("Nav_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Type = new DataBaseInfo.Field<Navigation>("Nav_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_Site - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Site = new DataBaseInfo.Field<Navigation>("Nav_Site");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Nav_CrtTime = new DataBaseInfo.Field<Navigation>("Nav_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Nav_IsShow = new DataBaseInfo.Field<Navigation>("Nav_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Nav_IsBold - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Nav_IsBold = new DataBaseInfo.Field<Navigation>("Nav_IsBold");
    			
    			/// <summary>
    			/// 字段名：Nav_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Nav_Logo = new DataBaseInfo.Field<Navigation>("Nav_Logo");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Navigation>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Navigation>("Org_Name");
    		}
    	}
    }
