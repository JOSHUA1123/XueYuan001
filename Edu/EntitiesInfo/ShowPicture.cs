namespace EntitiesInfo {
    	...
    	public partial class ShowPicture : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ShowPicture>("ShowPicture");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ShowPicture>();
    			
    			/// <summary>
    			/// 字段名：Shp_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Shp_ID = new DataBaseInfo.Field<ShowPicture>("Shp_ID");
    			
    			/// <summary>
    			/// 字段名：Shp_File - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Shp_File = new DataBaseInfo.Field<ShowPicture>("Shp_File");
    			
    			/// <summary>
    			/// 字段名：Shp_Url - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Shp_Url = new DataBaseInfo.Field<ShowPicture>("Shp_Url");
    			
    			/// <summary>
    			/// 字段名：Shp_Target - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Shp_Target = new DataBaseInfo.Field<ShowPicture>("Shp_Target");
    			
    			/// <summary>
    			/// 字段名：Shp_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Shp_IsShow = new DataBaseInfo.Field<ShowPicture>("Shp_IsShow");
    			
    			/// <summary>
    			/// 字段名：Shp_Site - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Shp_Site = new DataBaseInfo.Field<ShowPicture>("Shp_Site");
    			
    			/// <summary>
    			/// 字段名：Shp_BgColor - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Shp_BgColor = new DataBaseInfo.Field<ShowPicture>("Shp_BgColor");
    			
    			/// <summary>
    			/// 字段名：Shp_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Shp_Tax = new DataBaseInfo.Field<ShowPicture>("Shp_Tax");
    			
    			/// <summary>
    			/// 字段名：Shp_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Shp_Intro = new DataBaseInfo.Field<ShowPicture>("Shp_Intro");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ShowPicture>("Org_ID");
    		}
    	}
    }
