namespace EntitiesInfo {
    	...
    	public partial class SystemPara : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<SystemPara>("SystemPara");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<SystemPara>();
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sys_Id = new DataBaseInfo.Field<SystemPara>("Sys_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_Key - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sys_Key = new DataBaseInfo.Field<SystemPara>("Sys_Key");
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_Value - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sys_Value = new DataBaseInfo.Field<SystemPara>("Sys_Value");
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_Default - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sys_Default = new DataBaseInfo.Field<SystemPara>("Sys_Default");
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_ParaIntro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sys_ParaIntro = new DataBaseInfo.Field<SystemPara>("Sys_ParaIntro");
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_Unit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sys_Unit = new DataBaseInfo.Field<SystemPara>("Sys_Unit");
    			
    			/// <summary>
    			/// -1 - 字段名：Sys_SelectUnit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sys_SelectUnit = new DataBaseInfo.Field<SystemPara>("Sys_SelectUnit");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<SystemPara>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<SystemPara>("Org_Name");
    		}
    	}
    }
