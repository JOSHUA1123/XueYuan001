namespace EntitiesInfo {
    	...
    	public partial class ProductOrigin : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ProductOrigin>("ProductOrigin");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ProductOrigin>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pori_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pori_Id = new DataBaseInfo.Field<ProductOrigin>("Pori_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pori_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pori_Name = new DataBaseInfo.Field<ProductOrigin>("Pori_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Pori_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pori_Intro = new DataBaseInfo.Field<ProductOrigin>("Pori_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Pori_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pori_IsUse = new DataBaseInfo.Field<ProductOrigin>("Pori_IsUse");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ProductOrigin>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ProductOrigin>("Org_Name");
    		}
    	}
    }
