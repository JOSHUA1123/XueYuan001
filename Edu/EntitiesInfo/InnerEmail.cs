namespace EntitiesInfo {
    	...
    	public partial class InnerEmail : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<InnerEmail>("InnerEmail");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<InnerEmail>();
    			
    			/// <summary>
    			/// False - 字段名：Ine_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ine_Id = new DataBaseInfo.Field<InnerEmail>("Ine_Id");
    			
    			/// <summary>
    			/// True - 字段名：Ine_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ine_Title = new DataBaseInfo.Field<InnerEmail>("Ine_Title");
    			
    			/// <summary>
    			/// True - 字段名：Ine_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ine_Context = new DataBaseInfo.Field<InnerEmail>("Ine_Context");
    			
    			/// <summary>
    			/// False - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<InnerEmail>("Acc_Id");
    			
    			/// <summary>
    			/// True - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<InnerEmail>("Acc_Name");
    			
    			/// <summary>
    			/// False - 字段名：Ine_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_CrtTime = new DataBaseInfo.Field<InnerEmail>("Ine_CrtTime");
    			
    			/// <summary>
    			/// False - 字段名：Ine_ToTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_ToTime = new DataBaseInfo.Field<InnerEmail>("Ine_ToTime");
    			
    			/// <summary>
    			/// False - 字段名：Ine_ReadTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_ReadTime = new DataBaseInfo.Field<InnerEmail>("Ine_ReadTime");
    			
    			/// <summary>
    			/// False - 字段名：Ine_State - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_State = new DataBaseInfo.Field<InnerEmail>("Ine_State");
    			
    			/// <summary>
    			/// True - 字段名：Ine_ToName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ine_ToName = new DataBaseInfo.Field<InnerEmail>("Ine_ToName");
    			
    			/// <summary>
    			/// False - 字段名：Ine_ToId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_ToId = new DataBaseInfo.Field<InnerEmail>("Ine_ToId");
    			
    			/// <summary>
    			/// False - 字段名：Ine_OfBox - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_OfBox = new DataBaseInfo.Field<InnerEmail>("Ine_OfBox");
    			
    			/// <summary>
    			/// True - 字段名：Ine_ToAllId - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ine_ToAllId = new DataBaseInfo.Field<InnerEmail>("Ine_ToAllId");
    			
    			/// <summary>
    			/// True - 字段名：Ine_ToAllName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ine_ToAllName = new DataBaseInfo.Field<InnerEmail>("Ine_ToAllName");
    			
    			/// <summary>
    			/// False - 字段名：Ine_OwnerId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ine_OwnerId = new DataBaseInfo.Field<InnerEmail>("Ine_OwnerId");
    			
    			/// <summary>
    			/// False - 字段名：Ine_Del - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ine_Del = new DataBaseInfo.Field<InnerEmail>("Ine_Del");
    			
    			/// <summary>
    			/// True - 字段名：Ine_UniqueId - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ine_UniqueId = new DataBaseInfo.Field<InnerEmail>("Ine_UniqueId");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<InnerEmail>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<InnerEmail>("Org_Name");
    		}
    	}
    }
