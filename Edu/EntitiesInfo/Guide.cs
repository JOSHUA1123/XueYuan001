namespace EntitiesInfo {
    	...
    	public partial class Guide : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Guide>("Guide");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Guide>();
    			
    			/// <summary>
    			/// 字段名：Gu_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Id = new DataBaseInfo.Field<Guide>("Gu_Id");
    			
    			/// <summary>
    			/// 字段名：Gc_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Title = new DataBaseInfo.Field<Guide>("Gc_Title");
    			
    			/// <summary>
    			/// 字段名：Gc_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Gc_ID = new DataBaseInfo.Field<Guide>("Gc_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Guide>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Name = new DataBaseInfo.Field<Guide>("Cou_Name");
    			
    			/// <summary>
    			/// 字段名：Gu_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Title = new DataBaseInfo.Field<Guide>("Gu_Title");
    			
    			/// <summary>
    			/// 字段名：Gu_TitleAbbr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_TitleAbbr = new DataBaseInfo.Field<Guide>("Gu_TitleAbbr");
    			
    			/// <summary>
    			/// 字段名：Gu_TitleFull - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_TitleFull = new DataBaseInfo.Field<Guide>("Gu_TitleFull");
    			
    			/// <summary>
    			/// 字段名：Gu_TitleSub - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_TitleSub = new DataBaseInfo.Field<Guide>("Gu_TitleSub");
    			
    			/// <summary>
    			/// 字段名：Gu_Color - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Color = new DataBaseInfo.Field<Guide>("Gu_Color");
    			
    			/// <summary>
    			/// 字段名：Gu_Font - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Font = new DataBaseInfo.Field<Guide>("Gu_Font");
    			
    			/// <summary>
    			/// 字段名：Gu_IsError - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsError = new DataBaseInfo.Field<Guide>("Gu_IsError");
    			
    			/// <summary>
    			/// 字段名：Gu_ErrInfo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_ErrInfo = new DataBaseInfo.Field<Guide>("Gu_ErrInfo");
    			
    			/// <summary>
    			/// 字段名：Gu_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsUse = new DataBaseInfo.Field<Guide>("Gu_IsUse");
    			
    			/// <summary>
    			/// 字段名：Gu_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsShow = new DataBaseInfo.Field<Guide>("Gu_IsShow");
    			
    			/// <summary>
    			/// 字段名：Gu_IsImg - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsImg = new DataBaseInfo.Field<Guide>("Gu_IsImg");
    			
    			/// <summary>
    			/// 字段名：Gu_IsHot - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsHot = new DataBaseInfo.Field<Guide>("Gu_IsHot");
    			
    			/// <summary>
    			/// 字段名：Gu_IsTop - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsTop = new DataBaseInfo.Field<Guide>("Gu_IsTop");
    			
    			/// <summary>
    			/// 字段名：Gu_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsRec = new DataBaseInfo.Field<Guide>("Gu_IsRec");
    			
    			/// <summary>
    			/// 字段名：Gu_IsDel - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsDel = new DataBaseInfo.Field<Guide>("Gu_IsDel");
    			
    			/// <summary>
    			/// 字段名：Gu_IsVerify - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsVerify = new DataBaseInfo.Field<Guide>("Gu_IsVerify");
    			
    			/// <summary>
    			/// 字段名：Gu_VerifyMan - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_VerifyMan = new DataBaseInfo.Field<Guide>("Gu_VerifyMan");
    			
    			/// <summary>
    			/// 字段名：Gu_IsOut - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsOut = new DataBaseInfo.Field<Guide>("Gu_IsOut");
    			
    			/// <summary>
    			/// 字段名：Gu_OutUrl - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_OutUrl = new DataBaseInfo.Field<Guide>("Gu_OutUrl");
    			
    			/// <summary>
    			/// 字段名：Gu_Keywords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Keywords = new DataBaseInfo.Field<Guide>("Gu_Keywords");
    			
    			/// <summary>
    			/// 字段名：Gu_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Descr = new DataBaseInfo.Field<Guide>("Gu_Descr");
    			
    			/// <summary>
    			/// 字段名：Gu_Author - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Author = new DataBaseInfo.Field<Guide>("Gu_Author");
    			
    			/// <summary>
    			/// 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<Guide>("Acc_Id");
    			
    			/// <summary>
    			/// 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<Guide>("Acc_Name");
    			
    			/// <summary>
    			/// 字段名：Gu_Source - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Source = new DataBaseInfo.Field<Guide>("Gu_Source");
    			
    			/// <summary>
    			/// 字段名：Gu_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Intro = new DataBaseInfo.Field<Guide>("Gu_Intro");
    			
    			/// <summary>
    			/// 字段名：Gu_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Details = new DataBaseInfo.Field<Guide>("Gu_Details");
    			
    			/// <summary>
    			/// 字段名：Gu_Endnote - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Endnote = new DataBaseInfo.Field<Guide>("Gu_Endnote");
    			
    			/// <summary>
    			/// 字段名：Gu_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Gu_CrtTime = new DataBaseInfo.Field<Guide>("Gu_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Gu_LastTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Gu_LastTime = new DataBaseInfo.Field<Guide>("Gu_LastTime");
    			
    			/// <summary>
    			/// 字段名：Gu_VerifyTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Gu_VerifyTime = new DataBaseInfo.Field<Guide>("Gu_VerifyTime");
    			
    			/// <summary>
    			/// 字段名：Gu_Number - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Number = new DataBaseInfo.Field<Guide>("Gu_Number");
    			
    			/// <summary>
    			/// 字段名：Gu_IsNote - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsNote = new DataBaseInfo.Field<Guide>("Gu_IsNote");
    			
    			/// <summary>
    			/// 字段名：Gu_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Logo = new DataBaseInfo.Field<Guide>("Gu_Logo");
    			
    			/// <summary>
    			/// 字段名：Gu_IsStatic - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gu_IsStatic = new DataBaseInfo.Field<Guide>("Gu_IsStatic");
    			
    			/// <summary>
    			/// 字段名：Gu_PushTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Gu_PushTime = new DataBaseInfo.Field<Guide>("Gu_PushTime");
    			
    			/// <summary>
    			/// 字段名：Gu_Label - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Label = new DataBaseInfo.Field<Guide>("Gu_Label");
    			
    			/// <summary>
    			/// 字段名：Gu_Uid - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gu_Uid = new DataBaseInfo.Field<Guide>("Gu_Uid");
    			
    			/// <summary>
    			/// 字段名：OtherData - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field OtherData = new DataBaseInfo.Field<Guide>("OtherData");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Guide>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Guide>("Org_Name");
    		}
    	}
    }
