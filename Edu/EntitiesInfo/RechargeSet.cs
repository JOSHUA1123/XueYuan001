namespace EntitiesInfo {
    	...
    	public partial class RechargeSet : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<RechargeSet>("RechargeSet");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<RechargeSet>();
    			
    			/// <summary>
    			/// 字段名：Rs_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_ID = new DataBaseInfo.Field<RechargeSet>("Rs_ID");
    			
    			/// <summary>
    			/// 字段名：Rs_Count - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_Count = new DataBaseInfo.Field<RechargeSet>("Rs_Count");
    			
    			/// <summary>
    			/// 字段名：Rs_Price - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_Price = new DataBaseInfo.Field<RechargeSet>("Rs_Price");
    			
    			/// <summary>
    			/// 字段名：Rs_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rs_CrtTime = new DataBaseInfo.Field<RechargeSet>("Rs_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Rs_Theme - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rs_Theme = new DataBaseInfo.Field<RechargeSet>("Rs_Theme");
    			
    			/// <summary>
    			/// 字段名：Rs_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rs_Intro = new DataBaseInfo.Field<RechargeSet>("Rs_Intro");
    			
    			/// <summary>
    			/// 字段名：Rs_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rs_Pw = new DataBaseInfo.Field<RechargeSet>("Rs_Pw");
    			
    			/// <summary>
    			/// 字段名：Rs_UsedCount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_UsedCount = new DataBaseInfo.Field<RechargeSet>("Rs_UsedCount");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<RechargeSet>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Rs_LimitStart - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rs_LimitStart = new DataBaseInfo.Field<RechargeSet>("Rs_LimitStart");
    			
    			/// <summary>
    			/// 字段名：Rs_LimitEnd - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rs_LimitEnd = new DataBaseInfo.Field<RechargeSet>("Rs_LimitEnd");
    			
    			/// <summary>
    			/// 字段名：Rs_IsEnable - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Rs_IsEnable = new DataBaseInfo.Field<RechargeSet>("Rs_IsEnable");
    			
    			/// <summary>
    			/// 字段名：Rs_CodeLength - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_CodeLength = new DataBaseInfo.Field<RechargeSet>("Rs_CodeLength");
    			
    			/// <summary>
    			/// 字段名：Rs_PwLength - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_PwLength = new DataBaseInfo.Field<RechargeSet>("Rs_PwLength");
    		}
    	}
    }
