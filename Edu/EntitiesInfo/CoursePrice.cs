namespace EntitiesInfo {
    	...
    	public partial class CoursePrice : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<CoursePrice>("CoursePrice");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<CoursePrice>();
    			
    			/// <summary>
    			/// 字段名：CP_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field CP_ID = new DataBaseInfo.Field<CoursePrice>("CP_ID");
    			
    			/// <summary>
    			/// 字段名：CP_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field CP_Tax = new DataBaseInfo.Field<CoursePrice>("CP_Tax");
    			
    			/// <summary>
    			/// 字段名：CP_Price - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field CP_Price = new DataBaseInfo.Field<CoursePrice>("CP_Price");
    			
    			/// <summary>
    			/// 字段名：CP_Span - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field CP_Span = new DataBaseInfo.Field<CoursePrice>("CP_Span");
    			
    			/// <summary>
    			/// 字段名：CP_Unit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field CP_Unit = new DataBaseInfo.Field<CoursePrice>("CP_Unit");
    			
    			/// <summary>
    			/// 字段名：CP_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field CP_IsUse = new DataBaseInfo.Field<CoursePrice>("CP_IsUse");
    			
    			/// <summary>
    			/// 字段名：CP_Group - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field CP_Group = new DataBaseInfo.Field<CoursePrice>("CP_Group");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<CoursePrice>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_UID = new DataBaseInfo.Field<CoursePrice>("Cou_UID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<CoursePrice>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：CP_Coupon - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field CP_Coupon = new DataBaseInfo.Field<CoursePrice>("CP_Coupon");
    		}
    	}
    }
