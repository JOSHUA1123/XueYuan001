namespace EntitiesInfo {
    	...
    	public partial class Product : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Product>("Product");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Product>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Id = new DataBaseInfo.Field<Product>("Pd_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Name = new DataBaseInfo.Field<Product>("Pd_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Tax = new DataBaseInfo.Field<Product>("Pd_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pd_IsUse = new DataBaseInfo.Field<Product>("Pd_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_IsNew - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pd_IsNew = new DataBaseInfo.Field<Product>("Pd_IsNew");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pd_IsRec = new DataBaseInfo.Field<Product>("Pd_IsRec");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Col_Id = new DataBaseInfo.Field<Product>("Col_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Name = new DataBaseInfo.Field<Product>("Col_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Model - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Model = new DataBaseInfo.Field<Product>("Pd_Model");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Code = new DataBaseInfo.Field<Product>("Pd_Code");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Prise - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Prise = new DataBaseInfo.Field<Product>("Pd_Prise");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Weight - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Weight = new DataBaseInfo.Field<Product>("Pd_Weight");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_ColorName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_ColorName = new DataBaseInfo.Field<Product>("Pd_ColorName");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Color - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Color = new DataBaseInfo.Field<Product>("Pd_Color");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_KeyWords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_KeyWords = new DataBaseInfo.Field<Product>("Pd_KeyWords");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Descr = new DataBaseInfo.Field<Product>("Pd_Descr");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Logo = new DataBaseInfo.Field<Product>("Pd_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_LogoSmall - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_LogoSmall = new DataBaseInfo.Field<Product>("Pd_LogoSmall");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_QrCode - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_QrCode = new DataBaseInfo.Field<Product>("Pd_QrCode");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Number - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Number = new DataBaseInfo.Field<Product>("Pd_Number");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Stocks - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Stocks = new DataBaseInfo.Field<Product>("Pd_Stocks");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Unit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Unit = new DataBaseInfo.Field<Product>("Pd_Unit");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_SaleTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_SaleTime = new DataBaseInfo.Field<Product>("Pd_SaleTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_CrtTime = new DataBaseInfo.Field<Product>("Pd_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_IsNote - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pd_IsNote = new DataBaseInfo.Field<Product>("Pd_IsNote");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Intro = new DataBaseInfo.Field<Product>("Pd_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Details = new DataBaseInfo.Field<Product>("Pd_Details");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_IsDel - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pd_IsDel = new DataBaseInfo.Field<Product>("Pd_IsDel");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_IsStatic - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pd_IsStatic = new DataBaseInfo.Field<Product>("Pd_IsStatic");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_PushTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_PushTime = new DataBaseInfo.Field<Product>("Pd_PushTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Label - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Label = new DataBaseInfo.Field<Product>("Pd_Label");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Uid - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Uid = new DataBaseInfo.Field<Product>("Pd_Uid");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<Product>("Acc_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<Product>("Acc_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Id = new DataBaseInfo.Field<Product>("Pfact_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pori_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pori_Id = new DataBaseInfo.Field<Product>("Pori_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmat_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pmat_Id = new DataBaseInfo.Field<Product>("Pmat_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：OtherData - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field OtherData = new DataBaseInfo.Field<Product>("OtherData");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Product>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Product>("Org_Name");
    		}
    	}
    }
