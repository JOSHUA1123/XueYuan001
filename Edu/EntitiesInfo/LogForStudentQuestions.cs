namespace EntitiesInfo {
    	...
    	public partial class LogForStudentQuestions : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LogForStudentQuestions>("LogForStudentQuestions");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LogForStudentQuestions>();
    			
    			/// <summary>
    			/// 字段名：Lsq_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lsq_ID = new DataBaseInfo.Field<LogForStudentQuestions>("Lsq_ID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<LogForStudentQuestions>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<LogForStudentQuestions>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_AccName = new DataBaseInfo.Field<LogForStudentQuestions>("Ac_AccName");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<LogForStudentQuestions>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Ol_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ol_ID = new DataBaseInfo.Field<LogForStudentQuestions>("Ol_ID");
    			
    			/// <summary>
    			/// 字段名：Lsq_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lsq_CrtTime = new DataBaseInfo.Field<LogForStudentQuestions>("Lsq_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Lsq_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lsq_LastTime = new DataBaseInfo.Field<LogForStudentQuestions>("Lsq_LastTime");
    			
    			/// <summary>
    			/// 字段名：Qus_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ID = new DataBaseInfo.Field<LogForStudentQuestions>("Qus_ID");
    			
    			/// <summary>
    			/// 字段名：Lsq_Index - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lsq_Index = new DataBaseInfo.Field<LogForStudentQuestions>("Lsq_Index");
    		}
    	}
    }
