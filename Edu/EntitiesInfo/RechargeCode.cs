namespace EntitiesInfo {
    	...
    	public partial class RechargeCode : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<RechargeCode>("RechargeCode");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<RechargeCode>();
    			
    			/// <summary>
    			/// 字段名：Rc_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rc_ID = new DataBaseInfo.Field<RechargeCode>("Rc_ID");
    			
    			/// <summary>
    			/// 字段名：Rc_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Code = new DataBaseInfo.Field<RechargeCode>("Rc_Code");
    			
    			/// <summary>
    			/// 字段名：Rc_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Pw = new DataBaseInfo.Field<RechargeCode>("Rc_Pw");
    			
    			/// <summary>
    			/// 字段名：Rc_Price - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Price = new DataBaseInfo.Field<RechargeCode>("Rc_Price");
    			
    			/// <summary>
    			/// 字段名：Rc_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rc_CrtTime = new DataBaseInfo.Field<RechargeCode>("Rc_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Rc_UsedTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rc_UsedTime = new DataBaseInfo.Field<RechargeCode>("Rc_UsedTime");
    			
    			/// <summary>
    			/// 字段名：Rc_IsEnable - 数据类型：Boolean(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Rc_IsEnable = new DataBaseInfo.Field<RechargeCode>("Rc_IsEnable");
    			
    			/// <summary>
    			/// 字段名：Rc_IsUsed - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Rc_IsUsed = new DataBaseInfo.Field<RechargeCode>("Rc_IsUsed");
    			
    			/// <summary>
    			/// 字段名：Rc_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Type = new DataBaseInfo.Field<RechargeCode>("Rc_Type");
    			
    			/// <summary>
    			/// 字段名：Rs_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Rs_ID = new DataBaseInfo.Field<RechargeCode>("Rs_ID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<RechargeCode>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<RechargeCode>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_AccName = new DataBaseInfo.Field<RechargeCode>("Ac_AccName");
    			
    			/// <summary>
    			/// 字段名：Rc_LimitStart - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rc_LimitStart = new DataBaseInfo.Field<RechargeCode>("Rc_LimitStart");
    			
    			/// <summary>
    			/// 字段名：Rc_LimitEnd - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Rc_LimitEnd = new DataBaseInfo.Field<RechargeCode>("Rc_LimitEnd");
    			
    			/// <summary>
    			/// 字段名：Rc_QrcodeBase64 - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rc_QrcodeBase64 = new DataBaseInfo.Field<RechargeCode>("Rc_QrcodeBase64");
    		}
    	}
    }
