namespace EntitiesInfo {
    	...
    	public partial class SmsFault : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<SmsFault>("SmsFault");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<SmsFault>();
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Smf_Id = new DataBaseInfo.Field<SmsFault>("Smf_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Smf_Context = new DataBaseInfo.Field<SmsFault>("Smf_Context");
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_SendTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Smf_SendTime = new DataBaseInfo.Field<SmsFault>("Smf_SendTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Smf_CrtTime = new DataBaseInfo.Field<SmsFault>("Smf_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_MobileTel - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Smf_MobileTel = new DataBaseInfo.Field<SmsFault>("Smf_MobileTel");
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_SendName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Smf_SendName = new DataBaseInfo.Field<SmsFault>("Smf_SendName");
    			
    			/// <summary>
    			/// -1 - 字段名：Smf_Company - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Smf_Company = new DataBaseInfo.Field<SmsFault>("Smf_Company");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<SmsFault>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<SmsFault>("Org_Name");
    		}
    	}
    }
