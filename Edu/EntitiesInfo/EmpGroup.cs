namespace EntitiesInfo {
    	...
    	public partial class EmpGroup : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<EmpGroup>("EmpGroup");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<EmpGroup>();
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_Id = new DataBaseInfo.Field<EmpGroup>("EGrp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_Name = new DataBaseInfo.Field<EmpGroup>("EGrp_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_IsUse = new DataBaseInfo.Field<EmpGroup>("EGrp_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_Tax = new DataBaseInfo.Field<EmpGroup>("EGrp_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_Intro = new DataBaseInfo.Field<EmpGroup>("EGrp_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_IsSystem - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_IsSystem = new DataBaseInfo.Field<EmpGroup>("EGrp_IsSystem");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<EmpGroup>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<EmpGroup>("Org_Name");
    		}
    	}
    }
