namespace EntitiesInfo {
    	...
    	public partial class LogForStudentStudy : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LogForStudentStudy>("LogForStudentStudy");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LogForStudentStudy>();
    			
    			/// <summary>
    			/// 字段名：Lss_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lss_ID = new DataBaseInfo.Field<LogForStudentStudy>("Lss_ID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<LogForStudentStudy>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<LogForStudentStudy>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_AccName = new DataBaseInfo.Field<LogForStudentStudy>("Ac_AccName");
    			
    			/// <summary>
    			/// 字段名：Ac_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Name = new DataBaseInfo.Field<LogForStudentStudy>("Ac_Name");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<LogForStudentStudy>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Ol_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ol_ID = new DataBaseInfo.Field<LogForStudentStudy>("Ol_ID");
    			
    			/// <summary>
    			/// 字段名：Lss_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lss_UID = new DataBaseInfo.Field<LogForStudentStudy>("Lss_UID");
    			
    			/// <summary>
    			/// 字段名：Lss_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lss_CrtTime = new DataBaseInfo.Field<LogForStudentStudy>("Lss_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Lss_PlayTime - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lss_PlayTime = new DataBaseInfo.Field<LogForStudentStudy>("Lss_PlayTime");
    			
    			/// <summary>
    			/// 字段名：Lss_StudyTime - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lss_StudyTime = new DataBaseInfo.Field<LogForStudentStudy>("Lss_StudyTime");
    			
    			/// <summary>
    			/// 字段名：Lss_Duration - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lss_Duration = new DataBaseInfo.Field<LogForStudentStudy>("Lss_Duration");
    			
    			/// <summary>
    			/// 字段名：Lss_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lss_LastTime = new DataBaseInfo.Field<LogForStudentStudy>("Lss_LastTime");
    			
    			/// <summary>
    			/// 字段名：Lss_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lss_IP = new DataBaseInfo.Field<LogForStudentStudy>("Lss_IP");
    			
    			/// <summary>
    			/// 字段名：Lss_Browser - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lss_Browser = new DataBaseInfo.Field<LogForStudentStudy>("Lss_Browser");
    			
    			/// <summary>
    			/// 字段名：Lss_Platform - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lss_Platform = new DataBaseInfo.Field<LogForStudentStudy>("Lss_Platform");
    			
    			/// <summary>
    			/// 字段名：Lss_OS - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lss_OS = new DataBaseInfo.Field<LogForStudentStudy>("Lss_OS");
    		}
    	}
    }
