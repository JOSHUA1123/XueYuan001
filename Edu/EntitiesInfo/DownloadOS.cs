namespace EntitiesInfo {
    	...
    	public partial class DownloadOS : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<DownloadOS>("DownloadOS");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<DownloadOS>();
    			
    			/// <summary>
    			/// -1 - 字段名：Dos_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dos_Id = new DataBaseInfo.Field<DownloadOS>("Dos_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Dos_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dos_Name = new DataBaseInfo.Field<DownloadOS>("Dos_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Dos_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dos_Intro = new DataBaseInfo.Field<DownloadOS>("Dos_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Dos_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Dos_IsUse = new DataBaseInfo.Field<DownloadOS>("Dos_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Dos_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Dos_Tax = new DataBaseInfo.Field<DownloadOS>("Dos_Tax");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<DownloadOS>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<DownloadOS>("Org_Name");
    		}
    	}
    }
