namespace EntitiesInfo {
    	...
    	public partial class InternalLink : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<InternalLink>("InternalLink");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<InternalLink>();
    			
    			/// <summary>
    			/// -1 - 字段名：IL_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field IL_ID = new DataBaseInfo.Field<InternalLink>("IL_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：IL_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field IL_Name = new DataBaseInfo.Field<InternalLink>("IL_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：IL_Url - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field IL_Url = new DataBaseInfo.Field<InternalLink>("IL_Url");
    			
    			/// <summary>
    			/// -1 - 字段名：IL_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field IL_Title = new DataBaseInfo.Field<InternalLink>("IL_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：IL_Target - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field IL_Target = new DataBaseInfo.Field<InternalLink>("IL_Target");
    			
    			/// <summary>
    			/// -1 - 字段名：IL_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field IL_IsUse = new DataBaseInfo.Field<InternalLink>("IL_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：IL_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field IL_CrtTime = new DataBaseInfo.Field<InternalLink>("IL_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<InternalLink>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<InternalLink>("Org_Name");
    		}
    	}
    }
