namespace EntitiesInfo {
    	...
    	public partial class TrPlan : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<TrPlan>("TrPlan");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<TrPlan>();
    			
    			/// <summary>
    			/// 字段名：TrP_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Id = new DataBaseInfo.Field<TrPlan>("TrP_Id");
    			
    			/// <summary>
    			/// 字段名：TrP_Time - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Time = new DataBaseInfo.Field<TrPlan>("TrP_Time");
    			
    			/// <summary>
    			/// 字段名：TrP_Start - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Start = new DataBaseInfo.Field<TrPlan>("TrP_Start");
    			
    			/// <summary>
    			/// 字段名：TrP_End - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field TrP_End = new DataBaseInfo.Field<TrPlan>("TrP_End");
    			
    			/// <summary>
    			/// 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<TrPlan>("Dep_Id");
    			
    			/// <summary>
    			/// 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<TrPlan>("Dep_CnName");
    			
    			/// <summary>
    			/// 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<TrPlan>("Sbj_ID");
    			
    			/// <summary>
    			/// 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<TrPlan>("Sbj_Name");
    			
    			/// <summary>
    			/// 字段名：TrP_GroupType - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field TrP_GroupType = new DataBaseInfo.Field<TrPlan>("TrP_GroupType");
    			
    			/// <summary>
    			/// 字段名：TrP_Num - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Num = new DataBaseInfo.Field<TrPlan>("TrP_Num");
    			
    			/// <summary>
    			/// 字段名：TrP_Content - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Content = new DataBaseInfo.Field<TrPlan>("TrP_Content");
    			
    			/// <summary>
    			/// 字段名：TrP_Location - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Location = new DataBaseInfo.Field<TrPlan>("TrP_Location");
    			
    			/// <summary>
    			/// 字段名：TrP_Teacher - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Teacher = new DataBaseInfo.Field<TrPlan>("TrP_Teacher");
    			
    			/// <summary>
    			/// 字段名：TrP_Way - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Way = new DataBaseInfo.Field<TrPlan>("TrP_Way");
    			
    			/// <summary>
    			/// 字段名：TrP_Result - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field TrP_Result = new DataBaseInfo.Field<TrPlan>("TrP_Result");
    			
    			/// <summary>
    			/// 字段名：TrP_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field TrP_UID = new DataBaseInfo.Field<TrPlan>("TrP_UID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<TrPlan>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<TrPlan>("Org_Name");
    		}
    	}
    }
