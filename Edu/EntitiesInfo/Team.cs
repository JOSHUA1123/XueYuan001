namespace EntitiesInfo {
    	...
    	public partial class Team : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Team>("Team");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Team>();
    			
    			/// <summary>
    			/// -1 - 字段名：Team_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Team_ID = new DataBaseInfo.Field<Team>("Team_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<Team>("Sbj_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<Team>("Sbj_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Team_Name = new DataBaseInfo.Field<Team>("Team_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_ByName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Team_ByName = new DataBaseInfo.Field<Team>("Team_ByName");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Team_Intro = new DataBaseInfo.Field<Team>("Team_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Team_Tax = new DataBaseInfo.Field<Team>("Team_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Team_IsUse = new DataBaseInfo.Field<Team>("Team_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_Count - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Team_Count = new DataBaseInfo.Field<Team>("Team_Count");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Dep_ID = new DataBaseInfo.Field<Team>("Dep_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Name = new DataBaseInfo.Field<Team>("Dep_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Team_CrtTime = new DataBaseInfo.Field<Team>("Team_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Team>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Team>("Org_Name");
    		}
    	}
    }
