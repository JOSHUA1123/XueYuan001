namespace EntitiesInfo {
    	...
    	public partial class Columns : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Columns>("Columns");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Columns>();
    			
    			/// <summary>
    			/// -1 - 字段名：Col_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Col_ID = new DataBaseInfo.Field<Columns>("Col_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Col_PID = new DataBaseInfo.Field<Columns>("Col_PID");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Name = new DataBaseInfo.Field<Columns>("Col_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_ByName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_ByName = new DataBaseInfo.Field<Columns>("Col_ByName");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Title = new DataBaseInfo.Field<Columns>("Col_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Keywords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Keywords = new DataBaseInfo.Field<Columns>("Col_Keywords");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Descr = new DataBaseInfo.Field<Columns>("Col_Descr");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Intro = new DataBaseInfo.Field<Columns>("Col_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Type = new DataBaseInfo.Field<Columns>("Col_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Col_Tax = new DataBaseInfo.Field<Columns>("Col_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Col_IsUse = new DataBaseInfo.Field<Columns>("Col_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_IsNote - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Col_IsNote = new DataBaseInfo.Field<Columns>("Col_IsNote");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Col_CrtTime = new DataBaseInfo.Field<Columns>("Col_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Columns>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Columns>("Org_Name");
    		}
    	}
    }
