namespace EntitiesInfo {
    	...
    	public partial class DownloadType : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<DownloadType>("DownloadType");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<DownloadType>();
    			
    			/// <summary>
    			/// -1 - 字段名：Dty_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dty_Id = new DataBaseInfo.Field<DownloadType>("Dty_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Dty_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dty_Name = new DataBaseInfo.Field<DownloadType>("Dty_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Dty_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dty_Intro = new DataBaseInfo.Field<DownloadType>("Dty_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Dty_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dty_Details = new DataBaseInfo.Field<DownloadType>("Dty_Details");
    			
    			/// <summary>
    			/// -1 - 字段名：Dty_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Dty_IsUse = new DataBaseInfo.Field<DownloadType>("Dty_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Dty_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Dty_Tax = new DataBaseInfo.Field<DownloadType>("Dty_Tax");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<DownloadType>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<DownloadType>("Org_Name");
    		}
    	}
    }
