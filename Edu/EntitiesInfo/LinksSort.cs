namespace EntitiesInfo {
    	...
    	public partial class LinksSort : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LinksSort>("LinksSort");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LinksSort>();
    			
    			/// <summary>
    			/// False - 字段名：Ls_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Id = new DataBaseInfo.Field<LinksSort>("Ls_Id");
    			
    			/// <summary>
    			/// False - 字段名：Ls_PatId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ls_PatId = new DataBaseInfo.Field<LinksSort>("Ls_PatId");
    			
    			/// <summary>
    			/// False - 字段名：Ls_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Name = new DataBaseInfo.Field<LinksSort>("Ls_Name");
    			
    			/// <summary>
    			/// False - 字段名：Ls_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Tax = new DataBaseInfo.Field<LinksSort>("Ls_Tax");
    			
    			/// <summary>
    			/// False - 字段名：Ls_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ls_IsUse = new DataBaseInfo.Field<LinksSort>("Ls_IsUse");
    			
    			/// <summary>
    			/// True - 字段名：Ls_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Logo = new DataBaseInfo.Field<LinksSort>("Ls_Logo");
    			
    			/// <summary>
    			/// False - 字段名：Ls_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ls_IsShow = new DataBaseInfo.Field<LinksSort>("Ls_IsShow");
    			
    			/// <summary>
    			/// True - 字段名：Ls_Tootip - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ls_Tootip = new DataBaseInfo.Field<LinksSort>("Ls_Tootip");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<LinksSort>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<LinksSort>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Ls_IsImg - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ls_IsImg = new DataBaseInfo.Field<LinksSort>("Ls_IsImg");
    			
    			/// <summary>
    			/// 字段名：Ls_IsText - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ls_IsText = new DataBaseInfo.Field<LinksSort>("Ls_IsText");
    		}
    	}
    }
