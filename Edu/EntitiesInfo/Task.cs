namespace EntitiesInfo {
    	...
    	public partial class Task : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Task>("Task");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Task>();
    			
    			/// <summary>
    			/// -1 - 字段名：Task_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Task_Id = new DataBaseInfo.Field<Task>("Task_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Task_Name = new DataBaseInfo.Field<Task>("Task_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Task_Context = new DataBaseInfo.Field<Task>("Task_Context");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_CrtTime = new DataBaseInfo.Field<Task>("Task_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<Task>("Acc_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<Task>("Acc_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_StartTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_StartTime = new DataBaseInfo.Field<Task>("Task_StartTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_EndTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_EndTime = new DataBaseInfo.Field<Task>("Task_EndTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_State - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Task_State = new DataBaseInfo.Field<Task>("Task_State");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_IsComplete - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Task_IsComplete = new DataBaseInfo.Field<Task>("Task_IsComplete");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_CompleteTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_CompleteTime = new DataBaseInfo.Field<Task>("Task_CompleteTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_Level - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_Level = new DataBaseInfo.Field<Task>("Task_Level");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_Tax = new DataBaseInfo.Field<Task>("Task_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_WorkerId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_WorkerId = new DataBaseInfo.Field<Task>("Task_WorkerId");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_WorkerName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Task_WorkerName = new DataBaseInfo.Field<Task>("Task_WorkerName");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Task_IsUse = new DataBaseInfo.Field<Task>("Task_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_WorkLog - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Task_WorkLog = new DataBaseInfo.Field<Task>("Task_WorkLog");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_CompletePer - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Task_CompletePer = new DataBaseInfo.Field<Task>("Task_CompletePer");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_IsGoback - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Task_IsGoback = new DataBaseInfo.Field<Task>("Task_IsGoback");
    			
    			/// <summary>
    			/// -1 - 字段名：Task_GobackText - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Task_GobackText = new DataBaseInfo.Field<Task>("Task_GobackText");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Task>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Task>("Org_Name");
    		}
    	}
    }
