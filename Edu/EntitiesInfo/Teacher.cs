namespace EntitiesInfo {
    	...
    	public partial class Teacher : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Teacher>("Teacher");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Teacher>();
    			
    			/// <summary>
    			/// 字段名：Th_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<Teacher>("Th_ID");
    			
    			/// <summary>
    			/// 字段名：Th_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_AccName = new DataBaseInfo.Field<Teacher>("Th_AccName");
    			
    			/// <summary>
    			/// 字段名：Th_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Pw = new DataBaseInfo.Field<Teacher>("Th_Pw");
    			
    			/// <summary>
    			/// 字段名：Th_Qus - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Qus = new DataBaseInfo.Field<Teacher>("Th_Qus");
    			
    			/// <summary>
    			/// 字段名：Th_Anwser - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Anwser = new DataBaseInfo.Field<Teacher>("Th_Anwser");
    			
    			/// <summary>
    			/// 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<Teacher>("Th_Name");
    			
    			/// <summary>
    			/// 字段名：Th_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Title = new DataBaseInfo.Field<Teacher>("Th_Title");
    			
    			/// <summary>
    			/// 字段名：Th_Pinyin - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Pinyin = new DataBaseInfo.Field<Teacher>("Th_Pinyin");
    			
    			/// <summary>
    			/// 字段名：Th_Age - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_Age = new DataBaseInfo.Field<Teacher>("Th_Age");
    			
    			/// <summary>
    			/// 字段名：Th_Birthday - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Th_Birthday = new DataBaseInfo.Field<Teacher>("Th_Birthday");
    			
    			/// <summary>
    			/// 字段名：Th_IDCardNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_IDCardNumber = new DataBaseInfo.Field<Teacher>("Th_IDCardNumber");
    			
    			/// <summary>
    			/// 字段名：Th_Photo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Photo = new DataBaseInfo.Field<Teacher>("Th_Photo");
    			
    			/// <summary>
    			/// 字段名：Th_Signature - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Signature = new DataBaseInfo.Field<Teacher>("Th_Signature");
    			
    			/// <summary>
    			/// 字段名：Th_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Intro = new DataBaseInfo.Field<Teacher>("Th_Intro");
    			
    			/// <summary>
    			/// 字段名：Th_Job - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Job = new DataBaseInfo.Field<Teacher>("Th_Job");
    			
    			/// <summary>
    			/// 字段名：Th_Major - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Major = new DataBaseInfo.Field<Teacher>("Th_Major");
    			
    			/// <summary>
    			/// 字段名：Th_Education - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Education = new DataBaseInfo.Field<Teacher>("Th_Education");
    			
    			/// <summary>
    			/// 字段名：Th_Sex - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_Sex = new DataBaseInfo.Field<Teacher>("Th_Sex");
    			
    			/// <summary>
    			/// 字段名：Th_Native - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Native = new DataBaseInfo.Field<Teacher>("Th_Native");
    			
    			/// <summary>
    			/// 字段名：Th_Nation - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Nation = new DataBaseInfo.Field<Teacher>("Th_Nation");
    			
    			/// <summary>
    			/// 字段名：Th_CodeNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_CodeNumber = new DataBaseInfo.Field<Teacher>("Th_CodeNumber");
    			
    			/// <summary>
    			/// 字段名：Th_Address - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Address = new DataBaseInfo.Field<Teacher>("Th_Address");
    			
    			/// <summary>
    			/// 字段名：Th_AddrContact - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_AddrContact = new DataBaseInfo.Field<Teacher>("Th_AddrContact");
    			
    			/// <summary>
    			/// 字段名：Th_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Phone = new DataBaseInfo.Field<Teacher>("Th_Phone");
    			
    			/// <summary>
    			/// 字段名：Th_IsOpenPhone - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Th_IsOpenPhone = new DataBaseInfo.Field<Teacher>("Th_IsOpenPhone");
    			
    			/// <summary>
    			/// 字段名：Th_PhoneMobi - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_PhoneMobi = new DataBaseInfo.Field<Teacher>("Th_PhoneMobi");
    			
    			/// <summary>
    			/// 字段名：Th_IsOpenMobi - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Th_IsOpenMobi = new DataBaseInfo.Field<Teacher>("Th_IsOpenMobi");
    			
    			/// <summary>
    			/// 字段名：Th_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Email = new DataBaseInfo.Field<Teacher>("Th_Email");
    			
    			/// <summary>
    			/// 字段名：Th_Qq - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Qq = new DataBaseInfo.Field<Teacher>("Th_Qq");
    			
    			/// <summary>
    			/// 字段名：Th_Weixin - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Weixin = new DataBaseInfo.Field<Teacher>("Th_Weixin");
    			
    			/// <summary>
    			/// 字段名：Th_Zip - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Zip = new DataBaseInfo.Field<Teacher>("Th_Zip");
    			
    			/// <summary>
    			/// 字段名：Th_LinkMan - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_LinkMan = new DataBaseInfo.Field<Teacher>("Th_LinkMan");
    			
    			/// <summary>
    			/// 字段名：Th_LinkManPhone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_LinkManPhone = new DataBaseInfo.Field<Teacher>("Th_LinkManPhone");
    			
    			/// <summary>
    			/// 字段名：Th_IsPass - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Th_IsPass = new DataBaseInfo.Field<Teacher>("Th_IsPass");
    			
    			/// <summary>
    			/// 字段名：Th_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Th_IsUse = new DataBaseInfo.Field<Teacher>("Th_IsUse");
    			
    			/// <summary>
    			/// 字段名：Th_RegTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Th_RegTime = new DataBaseInfo.Field<Teacher>("Th_RegTime");
    			
    			/// <summary>
    			/// 字段名：Th_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Th_LastTime = new DataBaseInfo.Field<Teacher>("Th_LastTime");
    			
    			/// <summary>
    			/// 字段名：Th_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Th_CrtTime = new DataBaseInfo.Field<Teacher>("Th_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Th_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_Tax = new DataBaseInfo.Field<Teacher>("Th_Tax");
    			
    			/// <summary>
    			/// 字段名：Th_Score - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_Score = new DataBaseInfo.Field<Teacher>("Th_Score");
    			
    			/// <summary>
    			/// 字段名：Th_ViewNum - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ViewNum = new DataBaseInfo.Field<Teacher>("Th_ViewNum");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Teacher>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Teacher>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Ths_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ths_ID = new DataBaseInfo.Field<Teacher>("Ths_ID");
    			
    			/// <summary>
    			/// 字段名：Ths_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ths_Name = new DataBaseInfo.Field<Teacher>("Ths_Name");
    			
    			/// <summary>
    			/// 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<Teacher>("Dep_Id");
    			
    			/// <summary>
    			/// 字段名：Th_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Th_IsShow = new DataBaseInfo.Field<Teacher>("Th_IsShow");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Teacher>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_UID = new DataBaseInfo.Field<Teacher>("Ac_UID");
    		}
    	}
    }
