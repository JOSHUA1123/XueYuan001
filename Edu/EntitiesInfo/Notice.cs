namespace EntitiesInfo {
    	...
    	public partial class Notice : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Notice>("Notice");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Notice>();
    			
    			/// <summary>
    			/// False - 字段名：No_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field No_Id = new DataBaseInfo.Field<Notice>("No_Id");
    			
    			/// <summary>
    			/// True - 字段名：No_Ttl - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field No_Ttl = new DataBaseInfo.Field<Notice>("No_Ttl");
    			
    			/// <summary>
    			/// True - 字段名：No_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field No_Context = new DataBaseInfo.Field<Notice>("No_Context");
    			
    			/// <summary>
    			/// False - 字段名：No_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field No_IsShow = new DataBaseInfo.Field<Notice>("No_IsShow");
    			
    			/// <summary>
    			/// False - 字段名：No_IsOpen - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field No_IsOpen = new DataBaseInfo.Field<Notice>("No_IsOpen");
    			
    			/// <summary>
    			/// 字段名：No_IsTop - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field No_IsTop = new DataBaseInfo.Field<Notice>("No_IsTop");
    			
    			/// <summary>
    			/// False - 字段名：No_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field No_CrtTime = new DataBaseInfo.Field<Notice>("No_CrtTime");
    			
    			/// <summary>
    			/// False - 字段名：No_StartTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field No_StartTime = new DataBaseInfo.Field<Notice>("No_StartTime");
    			
    			/// <summary>
    			/// False - 字段名：No_EndTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field No_EndTime = new DataBaseInfo.Field<Notice>("No_EndTime");
    			
    			/// <summary>
    			/// False - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<Notice>("Acc_Id");
    			
    			/// <summary>
    			/// True - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<Notice>("Acc_Name");
    			
    			/// <summary>
    			/// True - 字段名：No_Organ - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field No_Organ = new DataBaseInfo.Field<Notice>("No_Organ");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Notice>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Notice>("Org_Name");
    		}
    	}
    }
