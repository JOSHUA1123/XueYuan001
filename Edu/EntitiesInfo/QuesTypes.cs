namespace EntitiesInfo {
    	...
    	public partial class QuesTypes : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<QuesTypes>("QuesTypes");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<QuesTypes>();
    			
    			/// <summary>
    			/// 字段名：Qt_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qt_ID = new DataBaseInfo.Field<QuesTypes>("Qt_ID");
    			
    			/// <summary>
    			/// 字段名：Qt_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qt_Name = new DataBaseInfo.Field<QuesTypes>("Qt_Name");
    			
    			/// <summary>
    			/// 字段名：Qt_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qt_Intro = new DataBaseInfo.Field<QuesTypes>("Qt_Intro");
    			
    			/// <summary>
    			/// 字段名：Qt_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Qt_IsUse = new DataBaseInfo.Field<QuesTypes>("Qt_IsUse");
    			
    			/// <summary>
    			/// 字段名：Qt_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qt_Type = new DataBaseInfo.Field<QuesTypes>("Qt_Type");
    			
    			/// <summary>
    			/// 字段名：Qt_TypeName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qt_TypeName = new DataBaseInfo.Field<QuesTypes>("Qt_TypeName");
    			
    			/// <summary>
    			/// 字段名：Qt_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qt_Tax = new DataBaseInfo.Field<QuesTypes>("Qt_Tax");
    			
    			/// <summary>
    			/// 字段名：Qt_Count - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qt_Count = new DataBaseInfo.Field<QuesTypes>("Qt_Count");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<QuesTypes>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<QuesTypes>("Org_ID");
    		}
    	}
    }
