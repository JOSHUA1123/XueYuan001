namespace EntitiesInfo {
    	...
    	public partial class ManageMenu_Point : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ManageMenu_Point>("ManageMenu_Point");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ManageMenu_Point>();
    			
    			/// <summary>
    			/// False - 字段名：MMP_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field MMP_Id = new DataBaseInfo.Field<ManageMenu_Point>("MMP_Id");
    			
    			/// <summary>
    			/// True - 字段名：MMP_FileName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field MMP_FileName = new DataBaseInfo.Field<ManageMenu_Point>("MMP_FileName");
    			
    			/// <summary>
    			/// False - 字段名：MMP_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MMP_IsUse = new DataBaseInfo.Field<ManageMenu_Point>("MMP_IsUse");
    			
    			/// <summary>
    			/// False - 字段名：MMP_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field MMP_IsShow = new DataBaseInfo.Field<ManageMenu_Point>("MMP_IsShow");
    			
    			/// <summary>
    			/// False - 字段名：MM_Id - 数据类型：Int16(可空)
    			/// </summary>
    			public static DataBaseInfo.Field MM_Id = new DataBaseInfo.Field<ManageMenu_Point>("MM_Id");
    			
    			/// <summary>
    			/// False - 字段名：FPI_Id - 数据类型：Int16(可空)
    			/// </summary>
    			public static DataBaseInfo.Field FPI_Id = new DataBaseInfo.Field<ManageMenu_Point>("FPI_Id");
    		}
    	}
    }
