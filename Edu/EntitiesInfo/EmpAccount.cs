namespace EntitiesInfo {
    	...
    	public partial class EmpAccount : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<EmpAccount>("EmpAccount");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<EmpAccount>();
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<EmpAccount>("Acc_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_AccName = new DataBaseInfo.Field<EmpAccount>("Acc_AccName");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Pw = new DataBaseInfo.Field<EmpAccount>("Acc_Pw");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<EmpAccount>("Acc_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_NamePinyin - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_NamePinyin = new DataBaseInfo.Field<EmpAccount>("Acc_NamePinyin");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IDCardNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IDCardNumber = new DataBaseInfo.Field<EmpAccount>("Acc_IDCardNumber");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Signature - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Signature = new DataBaseInfo.Field<EmpAccount>("Acc_Signature");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Sex - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Sex = new DataBaseInfo.Field<EmpAccount>("Acc_Sex");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Age - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Age = new DataBaseInfo.Field<EmpAccount>("Acc_Age");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Birthday - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Birthday = new DataBaseInfo.Field<EmpAccount>("Acc_Birthday");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IsUse = new DataBaseInfo.Field<EmpAccount>("Acc_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Email = new DataBaseInfo.Field<EmpAccount>("Acc_Email");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Qus - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Qus = new DataBaseInfo.Field<EmpAccount>("Acc_Qus");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Ans - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Ans = new DataBaseInfo.Field<EmpAccount>("Acc_Ans");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_EmpCode - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_EmpCode = new DataBaseInfo.Field<EmpAccount>("Acc_EmpCode");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_RegTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Acc_RegTime = new DataBaseInfo.Field<EmpAccount>("Acc_RegTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_OutTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Acc_OutTime = new DataBaseInfo.Field<EmpAccount>("Acc_OutTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IsAutoOut - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IsAutoOut = new DataBaseInfo.Field<EmpAccount>("Acc_IsAutoOut");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Acc_LastTime = new DataBaseInfo.Field<EmpAccount>("Acc_LastTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Tel - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Tel = new DataBaseInfo.Field<EmpAccount>("Acc_Tel");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IsOpenTel - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IsOpenTel = new DataBaseInfo.Field<EmpAccount>("Acc_IsOpenTel");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_MobileTel - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_MobileTel = new DataBaseInfo.Field<EmpAccount>("Acc_MobileTel");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IsOpenMobile - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IsOpenMobile = new DataBaseInfo.Field<EmpAccount>("Acc_IsOpenMobile");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_QQ - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_QQ = new DataBaseInfo.Field<EmpAccount>("Acc_QQ");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<EmpAccount>("Dep_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<EmpAccount>("Dep_CnName");
    			
    			/// <summary>
    			/// -1 - 字段名：Posi_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Id = new DataBaseInfo.Field<EmpAccount>("Posi_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Posi_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Name = new DataBaseInfo.Field<EmpAccount>("Posi_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：EGrp_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field EGrp_Id = new DataBaseInfo.Field<EmpAccount>("EGrp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Photo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Photo = new DataBaseInfo.Field<EmpAccount>("Acc_Photo");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IsUseCard - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IsUseCard = new DataBaseInfo.Field<EmpAccount>("Acc_IsUseCard");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Weixin - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Weixin = new DataBaseInfo.Field<EmpAccount>("Acc_Weixin");
    			
    			/// <summary>
    			/// -1 - 字段名：Title_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Title_Id = new DataBaseInfo.Field<EmpAccount>("Title_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Title_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Title_Name = new DataBaseInfo.Field<EmpAccount>("Title_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_IsPartTime - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Acc_IsPartTime = new DataBaseInfo.Field<EmpAccount>("Acc_IsPartTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Team_ID = new DataBaseInfo.Field<EmpAccount>("Team_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Team_Name = new DataBaseInfo.Field<EmpAccount>("Team_Name");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<EmpAccount>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<EmpAccount>("Org_Name");
    		}
    	}
    }
