namespace EntitiesInfo {
    	...
    	public partial class Subject : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Subject>("Subject");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Subject>();
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<Subject>("Sbj_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<Subject>("Sbj_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ByName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ByName = new DataBaseInfo.Field<Subject>("Sbj_ByName");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Intro = new DataBaseInfo.Field<Subject>("Sbj_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Tax = new DataBaseInfo.Field<Subject>("Sbj_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_IsUse = new DataBaseInfo.Field<Subject>("Sbj_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_CrtTime = new DataBaseInfo.Field<Subject>("Sbj_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Sbj_PassScore - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_PassScore = new DataBaseInfo.Field<Subject>("Sbj_PassScore");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Subject>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Subject>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Sbj_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_PID = new DataBaseInfo.Field<Subject>("Sbj_PID");
    			
    			/// <summary>
    			/// 字段名：Sbj_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Level = new DataBaseInfo.Field<Subject>("Sbj_Level");
    			
    			/// <summary>
    			/// 字段名：Sbj_XPath - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_XPath = new DataBaseInfo.Field<Subject>("Sbj_XPath");
    			
    			/// <summary>
    			/// 字段名：Sbj_CouNumber - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_CouNumber = new DataBaseInfo.Field<Subject>("Sbj_CouNumber");
    			
    			/// <summary>
    			/// 字段名：Sbj_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Logo = new DataBaseInfo.Field<Subject>("Sbj_Logo");
    			
    			/// <summary>
    			/// 字段名：Sbj_LogoSmall - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_LogoSmall = new DataBaseInfo.Field<Subject>("Sbj_LogoSmall");
    			
    			/// <summary>
    			/// 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<Subject>("Dep_Id");
    			
    			/// <summary>
    			/// 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<Subject>("Dep_CnName");
    			
    			/// <summary>
    			/// 字段名：Sbj_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_IsRec = new DataBaseInfo.Field<Subject>("Sbj_IsRec");
    			
    			/// <summary>
    			/// 字段名：Sbj_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Details = new DataBaseInfo.Field<Subject>("Sbj_Details");
    		}
    	}
    }
