namespace EntitiesInfo {
    	...
    	public partial class StudentSort : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<StudentSort>("StudentSort");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<StudentSort>();
    			
    			/// <summary>
    			/// 字段名：Sts_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sts_ID = new DataBaseInfo.Field<StudentSort>("Sts_ID");
    			
    			/// <summary>
    			/// 字段名：Sts_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sts_Name = new DataBaseInfo.Field<StudentSort>("Sts_Name");
    			
    			/// <summary>
    			/// 字段名：Sts_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sts_Tax = new DataBaseInfo.Field<StudentSort>("Sts_Tax");
    			
    			/// <summary>
    			/// 字段名：Sts_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sts_Intro = new DataBaseInfo.Field<StudentSort>("Sts_Intro");
    			
    			/// <summary>
    			/// 字段名：Sts_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sts_IsUse = new DataBaseInfo.Field<StudentSort>("Sts_IsUse");
    			
    			/// <summary>
    			/// 字段名：Sts_IsDefault - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Sts_IsDefault = new DataBaseInfo.Field<StudentSort>("Sts_IsDefault");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<StudentSort>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<StudentSort>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<StudentSort>("Dep_CnName");
    			
    			/// <summary>
    			/// 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<StudentSort>("Dep_Id");
    		}
    	}
    }
