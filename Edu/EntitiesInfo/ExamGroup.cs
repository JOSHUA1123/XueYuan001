namespace EntitiesInfo {
    	...
    	public partial class ExamGroup : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ExamGroup>("ExamGroup");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ExamGroup>();
    			
    			/// <summary>
    			/// -1 - 字段名：Eg_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Eg_ID = new DataBaseInfo.Field<ExamGroup>("Eg_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Eg_Type - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Eg_Type = new DataBaseInfo.Field<ExamGroup>("Eg_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Sts_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sts_ID = new DataBaseInfo.Field<ExamGroup>("Sts_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Exam_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exam_UID = new DataBaseInfo.Field<ExamGroup>("Exam_UID");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ExamGroup>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ExamGroup>("Org_Name");
    		}
    	}
    }
