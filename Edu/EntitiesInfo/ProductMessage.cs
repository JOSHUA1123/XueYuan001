namespace EntitiesInfo {
    	...
    	public partial class ProductMessage : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ProductMessage>("ProductMessage");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ProductMessage>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Id = new DataBaseInfo.Field<ProductMessage>("Pm_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Title = new DataBaseInfo.Field<ProductMessage>("Pm_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Context = new DataBaseInfo.Field<ProductMessage>("Pm_Context");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Answer - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Answer = new DataBaseInfo.Field<ProductMessage>("Pm_Answer");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pm_CrtTime = new DataBaseInfo.Field<ProductMessage>("Pm_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_AnsTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pm_AnsTime = new DataBaseInfo.Field<ProductMessage>("Pm_AnsTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_IsAns - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pm_IsAns = new DataBaseInfo.Field<ProductMessage>("Pm_IsAns");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pm_IsShow = new DataBaseInfo.Field<ProductMessage>("Pm_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_IP = new DataBaseInfo.Field<ProductMessage>("Pm_IP");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Phone = new DataBaseInfo.Field<ProductMessage>("Pm_Phone");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Email = new DataBaseInfo.Field<ProductMessage>("Pm_Email");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_QQ - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_QQ = new DataBaseInfo.Field<ProductMessage>("Pm_QQ");
    			
    			/// <summary>
    			/// -1 - 字段名：Pm_Address - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pm_Address = new DataBaseInfo.Field<ProductMessage>("Pm_Address");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Id = new DataBaseInfo.Field<ProductMessage>("Pd_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Name = new DataBaseInfo.Field<ProductMessage>("Pd_Name");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ProductMessage>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ProductMessage>("Org_Name");
    		}
    	}
    }
