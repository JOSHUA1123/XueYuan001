namespace EntitiesInfo {
    	...
    	public partial class GuideColumns : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<GuideColumns>("GuideColumns");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<GuideColumns>();
    			
    			/// <summary>
    			/// 字段名：Gc_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Gc_ID = new DataBaseInfo.Field<GuideColumns>("Gc_ID");
    			
    			/// <summary>
    			/// 字段名：Gc_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Gc_PID = new DataBaseInfo.Field<GuideColumns>("Gc_PID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<GuideColumns>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Name = new DataBaseInfo.Field<GuideColumns>("Cou_Name");
    			
    			/// <summary>
    			/// 字段名：Gc_ByName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_ByName = new DataBaseInfo.Field<GuideColumns>("Gc_ByName");
    			
    			/// <summary>
    			/// 字段名：Gc_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Title = new DataBaseInfo.Field<GuideColumns>("Gc_Title");
    			
    			/// <summary>
    			/// 字段名：Gc_Keywords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Keywords = new DataBaseInfo.Field<GuideColumns>("Gc_Keywords");
    			
    			/// <summary>
    			/// 字段名：Gc_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Descr = new DataBaseInfo.Field<GuideColumns>("Gc_Descr");
    			
    			/// <summary>
    			/// 字段名：Gc_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Intro = new DataBaseInfo.Field<GuideColumns>("Gc_Intro");
    			
    			/// <summary>
    			/// 字段名：Gc_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Type = new DataBaseInfo.Field<GuideColumns>("Gc_Type");
    			
    			/// <summary>
    			/// 字段名：Gc_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Gc_Tax = new DataBaseInfo.Field<GuideColumns>("Gc_Tax");
    			
    			/// <summary>
    			/// 字段名：Gc_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gc_IsUse = new DataBaseInfo.Field<GuideColumns>("Gc_IsUse");
    			
    			/// <summary>
    			/// 字段名：Gc_IsNote - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Gc_IsNote = new DataBaseInfo.Field<GuideColumns>("Gc_IsNote");
    			
    			/// <summary>
    			/// 字段名：Gc_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Gc_CrtTime = new DataBaseInfo.Field<GuideColumns>("Gc_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<GuideColumns>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<GuideColumns>("Org_Name");
    		}
    	}
    }
