namespace EntitiesInfo {
    	...
    	public partial class LearningCardSet : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LearningCardSet>("LearningCardSet");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LearningCardSet>();
    			
    			/// <summary>
    			/// 字段名：Lcs_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_ID = new DataBaseInfo.Field<LearningCardSet>("Lcs_ID");
    			
    			/// <summary>
    			/// 字段名：Lcs_RelatedCourses - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_RelatedCourses = new DataBaseInfo.Field<LearningCardSet>("Lcs_RelatedCourses");
    			
    			/// <summary>
    			/// 字段名：Lcs_CoursesCount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_CoursesCount = new DataBaseInfo.Field<LearningCardSet>("Lcs_CoursesCount");
    			
    			/// <summary>
    			/// 字段名：Lcs_Count - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Count = new DataBaseInfo.Field<LearningCardSet>("Lcs_Count");
    			
    			/// <summary>
    			/// 字段名：Lcs_MaxCount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_MaxCount = new DataBaseInfo.Field<LearningCardSet>("Lcs_MaxCount");
    			
    			/// <summary>
    			/// 字段名：Lcs_BuildCount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_BuildCount = new DataBaseInfo.Field<LearningCardSet>("Lcs_BuildCount");
    			
    			/// <summary>
    			/// 字段名：Lcs_IsFixed - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_IsFixed = new DataBaseInfo.Field<LearningCardSet>("Lcs_IsFixed");
    			
    			/// <summary>
    			/// 字段名：Lcs_Price - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Price = new DataBaseInfo.Field<LearningCardSet>("Lcs_Price");
    			
    			/// <summary>
    			/// 字段名：Lcs_Coupon - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Coupon = new DataBaseInfo.Field<LearningCardSet>("Lcs_Coupon");
    			
    			/// <summary>
    			/// 字段名：Lcs_Span - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Span = new DataBaseInfo.Field<LearningCardSet>("Lcs_Span");
    			
    			/// <summary>
    			/// 字段名：Lcs_Unit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Unit = new DataBaseInfo.Field<LearningCardSet>("Lcs_Unit");
    			
    			/// <summary>
    			/// 字段名：Lcs_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_CrtTime = new DataBaseInfo.Field<LearningCardSet>("Lcs_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Lcs_Theme - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Theme = new DataBaseInfo.Field<LearningCardSet>("Lcs_Theme");
    			
    			/// <summary>
    			/// 字段名：Lcs_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_Intro = new DataBaseInfo.Field<LearningCardSet>("Lcs_Intro");
    			
    			/// <summary>
    			/// 字段名：Lsc_UsedCount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lsc_UsedCount = new DataBaseInfo.Field<LearningCardSet>("Lsc_UsedCount");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<LearningCardSet>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Lcs_LimitStart - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_LimitStart = new DataBaseInfo.Field<LearningCardSet>("Lcs_LimitStart");
    			
    			/// <summary>
    			/// 字段名：Lcs_LimitEnd - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_LimitEnd = new DataBaseInfo.Field<LearningCardSet>("Lcs_LimitEnd");
    			
    			/// <summary>
    			/// 字段名：Lcs_IsEnable - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_IsEnable = new DataBaseInfo.Field<LearningCardSet>("Lcs_IsEnable");
    			
    			/// <summary>
    			/// 字段名：Lcs_CodeLength - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_CodeLength = new DataBaseInfo.Field<LearningCardSet>("Lcs_CodeLength");
    			
    			/// <summary>
    			/// 字段名：Lcs_PwLength - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_PwLength = new DataBaseInfo.Field<LearningCardSet>("Lcs_PwLength");
    			
    			/// <summary>
    			/// 字段名：Lcs_SecretKey - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_SecretKey = new DataBaseInfo.Field<LearningCardSet>("Lcs_SecretKey");
    		}
    	}
    }
