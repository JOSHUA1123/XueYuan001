namespace EntitiesInfo {
    	...
    	public partial class Message : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Message>("Message");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Message>();
    			
    			/// <summary>
    			/// False - 字段名：Msg_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Msg_Id = new DataBaseInfo.Field<Message>("Msg_Id");
    			
    			/// <summary>
    			/// True - 字段名：Msg_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Msg_Title = new DataBaseInfo.Field<Message>("Msg_Title");
    			
    			/// <summary>
    			/// True - 字段名：Msg_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Msg_Context = new DataBaseInfo.Field<Message>("Msg_Context");
    			
    			/// <summary>
    			/// False - 字段名：Msg_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Msg_CrtTime = new DataBaseInfo.Field<Message>("Msg_CrtTime");
    			
    			/// <summary>
    			/// False - 字段名：Msg_ReadTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Msg_ReadTime = new DataBaseInfo.Field<Message>("Msg_ReadTime");
    			
    			/// <summary>
    			/// False - 字段名：Msg_State - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Msg_State = new DataBaseInfo.Field<Message>("Msg_State");
    			
    			/// <summary>
    			/// False - 字段名：Msg_Del - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Msg_Del = new DataBaseInfo.Field<Message>("Msg_Del");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<Message>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Message>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Msg_QQ - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Msg_QQ = new DataBaseInfo.Field<Message>("Msg_QQ");
    			
    			/// <summary>
    			/// 字段名：Msg_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Msg_Phone = new DataBaseInfo.Field<Message>("Msg_Phone");
    			
    			/// <summary>
    			/// 字段名：Msg_ReContext - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Msg_ReContext = new DataBaseInfo.Field<Message>("Msg_ReContext");
    			
    			/// <summary>
    			/// 字段名：Msg_IsReply - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Msg_IsReply = new DataBaseInfo.Field<Message>("Msg_IsReply");
    			
    			/// <summary>
    			/// 字段名：Ol_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ol_ID = new DataBaseInfo.Field<Message>("Ol_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Message>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Msg_PlayTime - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Msg_PlayTime = new DataBaseInfo.Field<Message>("Msg_PlayTime");
    			
    			/// <summary>
    			/// 字段名：Msg_Likenum - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Msg_Likenum = new DataBaseInfo.Field<Message>("Msg_Likenum");
    			
    			/// <summary>
    			/// 字段名：Ac_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Name = new DataBaseInfo.Field<Message>("Ac_Name");
    			
    			/// <summary>
    			/// 字段名：Ac_Photo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Photo = new DataBaseInfo.Field<Message>("Ac_Photo");
    			
    			/// <summary>
    			/// 字段名：Msg_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Msg_IP = new DataBaseInfo.Field<Message>("Msg_IP");
    			
    			/// <summary>
    			/// 字段名：Ac_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_AccName = new DataBaseInfo.Field<Message>("Ac_AccName");
    		}
    	}
    }
