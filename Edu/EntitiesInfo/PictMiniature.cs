namespace EntitiesInfo {
    	...
    	public partial class PictMiniature : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<PictMiniature>("PictMiniature");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<PictMiniature>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_Id = new DataBaseInfo.Field<PictMiniature>("Pmin_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_Tax = new DataBaseInfo.Field<PictMiniature>("Pmin_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_Width - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_Width = new DataBaseInfo.Field<PictMiniature>("Pmin_Width");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_Height - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_Height = new DataBaseInfo.Field<PictMiniature>("Pmin_Height");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_Unit - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_Unit = new DataBaseInfo.Field<PictMiniature>("Pmin_Unit");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_IsRestrain - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_IsRestrain = new DataBaseInfo.Field<PictMiniature>("Pmin_IsRestrain");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_RestrainObj - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_RestrainObj = new DataBaseInfo.Field<PictMiniature>("Pmin_RestrainObj");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_IsUse = new DataBaseInfo.Field<PictMiniature>("Pmin_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmin_File - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pmin_File = new DataBaseInfo.Field<PictMiniature>("Pmin_File");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<PictMiniature>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<PictMiniature>("Org_Name");
    		}
    	}
    }
