namespace EntitiesInfo {
    	...
    	public partial class Knowledge : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Knowledge>("Knowledge");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Knowledge>();
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Kn_ID = new DataBaseInfo.Field<Knowledge>("Kn_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kns_Name = new DataBaseInfo.Field<Knowledge>("Kns_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Kns_ID = new DataBaseInfo.Field<Knowledge>("Kns_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Title = new DataBaseInfo.Field<Knowledge>("Kn_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_TitleFull - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_TitleFull = new DataBaseInfo.Field<Knowledge>("Kn_TitleFull");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_TitleSub - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_TitleSub = new DataBaseInfo.Field<Knowledge>("Kn_TitleSub");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kn_IsUse = new DataBaseInfo.Field<Knowledge>("Kn_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_IsTop - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kn_IsTop = new DataBaseInfo.Field<Knowledge>("Kn_IsTop");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kn_IsRec = new DataBaseInfo.Field<Knowledge>("Kn_IsRec");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_IsHot - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kn_IsHot = new DataBaseInfo.Field<Knowledge>("Kn_IsHot");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_IsDel - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kn_IsDel = new DataBaseInfo.Field<Knowledge>("Kn_IsDel");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Keywords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Keywords = new DataBaseInfo.Field<Knowledge>("Kn_Keywords");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Descr = new DataBaseInfo.Field<Knowledge>("Kn_Descr");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Author - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Author = new DataBaseInfo.Field<Knowledge>("Kn_Author");
    			
    			/// <summary>
    			/// -1 - 字段名：Th_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<Knowledge>("Th_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<Knowledge>("Th_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Source - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Source = new DataBaseInfo.Field<Knowledge>("Kn_Source");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Intro = new DataBaseInfo.Field<Knowledge>("Kn_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Details = new DataBaseInfo.Field<Knowledge>("Kn_Details");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Kn_CrtTime = new DataBaseInfo.Field<Knowledge>("Kn_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_LastTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Kn_LastTime = new DataBaseInfo.Field<Knowledge>("Kn_LastTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Number - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Number = new DataBaseInfo.Field<Knowledge>("Kn_Number");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_IsNote - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kn_IsNote = new DataBaseInfo.Field<Knowledge>("Kn_IsNote");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Logo = new DataBaseInfo.Field<Knowledge>("Kn_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Label - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Label = new DataBaseInfo.Field<Knowledge>("Kn_Label");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_Uid - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kn_Uid = new DataBaseInfo.Field<Knowledge>("Kn_Uid");
    			
    			/// <summary>
    			/// -1 - 字段名：OtherData - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field OtherData = new DataBaseInfo.Field<Knowledge>("OtherData");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Knowledge>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Knowledge>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Knowledge>("Cou_ID");
    		}
    	}
    }
