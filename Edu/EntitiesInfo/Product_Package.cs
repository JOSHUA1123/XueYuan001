namespace EntitiesInfo {
    	...
    	public partial class Product_Package : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Product_Package>("Product_Package");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Product_Package>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pdpk_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pdpk_Id = new DataBaseInfo.Field<Product_Package>("Pdpk_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pd_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Pd_Id = new DataBaseInfo.Field<Product_Package>("Pd_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：PPK_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field PPK_Id = new DataBaseInfo.Field<Product_Package>("PPK_Id");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Product_Package>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Product_Package>("Org_Name");
    		}
    	}
    }
