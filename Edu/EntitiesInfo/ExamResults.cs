namespace EntitiesInfo {
    	...
    	public partial class ExamResults : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ExamResults>("ExamResults");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ExamResults>();
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Exr_ID = new DataBaseInfo.Field<ExamResults>("Exr_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Score - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Score = new DataBaseInfo.Field<ExamResults>("Exr_Score");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_ScoreFinal - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Exr_ScoreFinal = new DataBaseInfo.Field<ExamResults>("Exr_ScoreFinal");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Draw - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Draw = new DataBaseInfo.Field<ExamResults>("Exr_Draw");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Colligate - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Colligate = new DataBaseInfo.Field<ExamResults>("Exr_Colligate");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Results - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Results = new DataBaseInfo.Field<ExamResults>("Exr_Results");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Exr_CrtTime = new DataBaseInfo.Field<ExamResults>("Exr_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exr_IP = new DataBaseInfo.Field<ExamResults>("Exr_IP");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_Mac - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exr_Mac = new DataBaseInfo.Field<ExamResults>("Exr_Mac");
    			
    			/// <summary>
    			/// -1 - 字段名：Exr_IsSubmit - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Exr_IsSubmit = new DataBaseInfo.Field<ExamResults>("Exr_IsSubmit");
    			
    			/// <summary>
    			/// -1 - 字段名：Exam_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Exam_ID = new DataBaseInfo.Field<ExamResults>("Exam_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Exam_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exam_UID = new DataBaseInfo.Field<ExamResults>("Exam_UID");
    			
    			/// <summary>
    			/// -1 - 字段名：Exam_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exam_Name = new DataBaseInfo.Field<ExamResults>("Exam_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<ExamResults>("Sbj_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<ExamResults>("Sbj_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Id = new DataBaseInfo.Field<ExamResults>("Tp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<ExamResults>("Ac_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Ac_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Name = new DataBaseInfo.Field<ExamResults>("Ac_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<ExamResults>("Dep_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Team_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Team_ID = new DataBaseInfo.Field<ExamResults>("Team_ID");
    			
    			/// <summary>
    			/// 字段名：Exam_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Exam_Title = new DataBaseInfo.Field<ExamResults>("Exam_Title");
    			
    			/// <summary>
    			/// 字段名：Exr_SubmitTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Exr_SubmitTime = new DataBaseInfo.Field<ExamResults>("Exr_SubmitTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ExamResults>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ExamResults>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Sts_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sts_ID = new DataBaseInfo.Field<ExamResults>("Sts_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_Sex - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Sex = new DataBaseInfo.Field<ExamResults>("Ac_Sex");
    			
    			/// <summary>
    			/// 字段名：Ac_IDCardNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_IDCardNumber = new DataBaseInfo.Field<ExamResults>("Ac_IDCardNumber");
    			
    			/// <summary>
    			/// 字段名：Exr_IsCalc - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Exr_IsCalc = new DataBaseInfo.Field<ExamResults>("Exr_IsCalc");
    			
    			/// <summary>
    			/// 字段名：Exr_OverTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Exr_OverTime = new DataBaseInfo.Field<ExamResults>("Exr_OverTime");
    			
    			/// <summary>
    			/// 字段名：Exr_CalcTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Exr_CalcTime = new DataBaseInfo.Field<ExamResults>("Exr_CalcTime");
    			
    			/// <summary>
    			/// 字段名：Exr_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Exr_LastTime = new DataBaseInfo.Field<ExamResults>("Exr_LastTime");
    		}
    	}
    }
