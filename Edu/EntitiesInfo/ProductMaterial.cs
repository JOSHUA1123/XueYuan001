namespace EntitiesInfo {
    	...
    	public partial class ProductMaterial : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ProductMaterial>("ProductMaterial");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ProductMaterial>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pmat_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pmat_Id = new DataBaseInfo.Field<ProductMaterial>("Pmat_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmat_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pmat_Name = new DataBaseInfo.Field<ProductMaterial>("Pmat_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmat_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pmat_Intro = new DataBaseInfo.Field<ProductMaterial>("Pmat_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Pmat_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pmat_IsUse = new DataBaseInfo.Field<ProductMaterial>("Pmat_IsUse");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ProductMaterial>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ProductMaterial>("Org_Name");
    		}
    	}
    }
