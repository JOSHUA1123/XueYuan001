namespace EntitiesInfo {
    ...
    using System;
    	...
    	public partial class Article : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Article>("Article");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Article>();
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Art_Id = new DataBaseInfo.Field<Article>("Art_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Col_Name = new DataBaseInfo.Field<Article>("Col_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Col_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Col_Id = new DataBaseInfo.Field<Article>("Col_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Title = new DataBaseInfo.Field<Article>("Art_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_TitleAbbr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_TitleAbbr = new DataBaseInfo.Field<Article>("Art_TitleAbbr");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_TitleFull - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_TitleFull = new DataBaseInfo.Field<Article>("Art_TitleFull");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_TitleSub - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_TitleSub = new DataBaseInfo.Field<Article>("Art_TitleSub");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Color - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Color = new DataBaseInfo.Field<Article>("Art_Color");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Font - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Font = new DataBaseInfo.Field<Article>("Art_Font");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsError - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsError = new DataBaseInfo.Field<Article>("Art_IsError");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_ErrInfo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_ErrInfo = new DataBaseInfo.Field<Article>("Art_ErrInfo");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsUse = new DataBaseInfo.Field<Article>("Art_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsShow = new DataBaseInfo.Field<Article>("Art_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsImg - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsImg = new DataBaseInfo.Field<Article>("Art_IsImg");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsHot - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsHot = new DataBaseInfo.Field<Article>("Art_IsHot");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsTop - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsTop = new DataBaseInfo.Field<Article>("Art_IsTop");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsRec = new DataBaseInfo.Field<Article>("Art_IsRec");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsDel - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsDel = new DataBaseInfo.Field<Article>("Art_IsDel");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsVerify - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsVerify = new DataBaseInfo.Field<Article>("Art_IsVerify");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_VerifyMan - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_VerifyMan = new DataBaseInfo.Field<Article>("Art_VerifyMan");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsOut - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsOut = new DataBaseInfo.Field<Article>("Art_IsOut");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_OutUrl - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_OutUrl = new DataBaseInfo.Field<Article>("Art_OutUrl");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Keywords - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Keywords = new DataBaseInfo.Field<Article>("Art_Keywords");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Descr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Descr = new DataBaseInfo.Field<Article>("Art_Descr");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Author - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Author = new DataBaseInfo.Field<Article>("Art_Author");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<Article>("Acc_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<Article>("Acc_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Source - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Source = new DataBaseInfo.Field<Article>("Art_Source");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Intro = new DataBaseInfo.Field<Article>("Art_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Details - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Details = new DataBaseInfo.Field<Article>("Art_Details");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Endnote - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Endnote = new DataBaseInfo.Field<Article>("Art_Endnote");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Art_CrtTime = new DataBaseInfo.Field<Article>("Art_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Art_LastTime = new DataBaseInfo.Field<Article>("Art_LastTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_VerifyTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Art_VerifyTime = new DataBaseInfo.Field<Article>("Art_VerifyTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Number - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Art_Number = new DataBaseInfo.Field<Article>("Art_Number");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsNote - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsNote = new DataBaseInfo.Field<Article>("Art_IsNote");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Logo = new DataBaseInfo.Field<Article>("Art_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_IsStatic - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Art_IsStatic = new DataBaseInfo.Field<Article>("Art_IsStatic");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_PushTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Art_PushTime = new DataBaseInfo.Field<Article>("Art_PushTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Label - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Label = new DataBaseInfo.Field<Article>("Art_Label");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Uid - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Art_Uid = new DataBaseInfo.Field<Article>("Art_Uid");
    			
    			/// <summary>
    			/// -1 - 字段名：OtherData - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field OtherData = new DataBaseInfo.Field<Article>("OtherData");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Article>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Article>("Org_Name");
    		}
    	}
    }
