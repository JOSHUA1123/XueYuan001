namespace EntitiesInfo {
    	...
    	public partial class Student_Course : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Student_Course>("Student_Course");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Student_Course>();
    			
    			/// <summary>
    			/// 字段名：Stc_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Stc_ID = new DataBaseInfo.Field<Student_Course>("Stc_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Student_Course>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Student_Course>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Stc_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Stc_CrtTime = new DataBaseInfo.Field<Student_Course>("Stc_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Stc_Money - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Stc_Money = new DataBaseInfo.Field<Student_Course>("Stc_Money");
    			
    			/// <summary>
    			/// 字段名：Stc_StartTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Stc_StartTime = new DataBaseInfo.Field<Student_Course>("Stc_StartTime");
    			
    			/// <summary>
    			/// 字段名：Stc_EndTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Stc_EndTime = new DataBaseInfo.Field<Student_Course>("Stc_EndTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Student_Course>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Rc_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Rc_Code = new DataBaseInfo.Field<Student_Course>("Rc_Code");
    			
    			/// <summary>
    			/// 字段名：Stc_IsFree - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Stc_IsFree = new DataBaseInfo.Field<Student_Course>("Stc_IsFree");
    			
    			/// <summary>
    			/// 字段名：Stc_IsTry - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Stc_IsTry = new DataBaseInfo.Field<Student_Course>("Stc_IsTry");
    			
    			/// <summary>
    			/// 字段名：Stc_QuesScore - 数据类型：Double
    			/// </summary>
    			public static DataBaseInfo.Field Stc_QuesScore = new DataBaseInfo.Field<Student_Course>("Stc_QuesScore");
    			
    			/// <summary>
    			/// 字段名：Stc_StudyScore - 数据类型：Double
    			/// </summary>
    			public static DataBaseInfo.Field Stc_StudyScore = new DataBaseInfo.Field<Student_Course>("Stc_StudyScore");
    			
    			/// <summary>
    			/// 字段名：Stc_ExamScore - 数据类型：Double
    			/// </summary>
    			public static DataBaseInfo.Field Stc_ExamScore = new DataBaseInfo.Field<Student_Course>("Stc_ExamScore");
    		}
    	}
    }
