namespace EntitiesInfo {
    	...
    	public partial class OrganLevel : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<OrganLevel>("OrganLevel");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<OrganLevel>();
    			
    			/// <summary>
    			/// 字段名：Olv_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Olv_ID = new DataBaseInfo.Field<OrganLevel>("Olv_ID");
    			
    			/// <summary>
    			/// 字段名：Olv_Level - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Olv_Level = new DataBaseInfo.Field<OrganLevel>("Olv_Level");
    			
    			/// <summary>
    			/// 字段名：Olv_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Olv_Name = new DataBaseInfo.Field<OrganLevel>("Olv_Name");
    			
    			/// <summary>
    			/// 字段名：Olv_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Olv_Intro = new DataBaseInfo.Field<OrganLevel>("Olv_Intro");
    			
    			/// <summary>
    			/// 字段名：Olv_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Olv_IsUse = new DataBaseInfo.Field<OrganLevel>("Olv_IsUse");
    			
    			/// <summary>
    			/// 字段名：Olv_Tag - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Olv_Tag = new DataBaseInfo.Field<OrganLevel>("Olv_Tag");
    			
    			/// <summary>
    			/// 字段名：Olv_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Olv_Tax = new DataBaseInfo.Field<OrganLevel>("Olv_Tax");
    			
    			/// <summary>
    			/// 字段名：Olv_IsDefault - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Olv_IsDefault = new DataBaseInfo.Field<OrganLevel>("Olv_IsDefault");
    			
    			/// <summary>
    			/// 字段名：Ps_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ps_ID = new DataBaseInfo.Field<OrganLevel>("Ps_ID");
    		}
    	}
    }
