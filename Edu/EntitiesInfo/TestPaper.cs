namespace EntitiesInfo {
    	...
    	public partial class TestPaper : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<TestPaper>("TestPaper");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<TestPaper>();
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Id = new DataBaseInfo.Field<TestPaper>("Tp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Name = new DataBaseInfo.Field<TestPaper>("Tp_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Type = new DataBaseInfo.Field<TestPaper>("Tp_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Intro = new DataBaseInfo.Field<TestPaper>("Tp_Intro");
    			
    			/// <summary>
    			/// 字段名：Tp_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Logo = new DataBaseInfo.Field<TestPaper>("Tp_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Author - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Author = new DataBaseInfo.Field<TestPaper>("Tp_Author");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Total - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Total = new DataBaseInfo.Field<TestPaper>("Tp_Total");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Count - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Count = new DataBaseInfo.Field<TestPaper>("Tp_Count");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Tp_CrtTime = new DataBaseInfo.Field<TestPaper>("Tp_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Lasttime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Lasttime = new DataBaseInfo.Field<TestPaper>("Tp_Lasttime");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<TestPaper>("Sbj_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<TestPaper>("Sbj_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Diff - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Diff = new DataBaseInfo.Field<TestPaper>("Tp_Diff");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_IsRec - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Tp_IsRec = new DataBaseInfo.Field<TestPaper>("Tp_IsRec");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_IsBuild - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Tp_IsBuild = new DataBaseInfo.Field<TestPaper>("Tp_IsBuild");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Tp_IsUse = new DataBaseInfo.Field<TestPaper>("Tp_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Span - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Span = new DataBaseInfo.Field<TestPaper>("Tp_Span");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_UID = new DataBaseInfo.Field<TestPaper>("Tp_UID");
    			
    			/// <summary>
    			/// 字段名：Tp_Diff2 - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Diff2 = new DataBaseInfo.Field<TestPaper>("Tp_Diff2");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<TestPaper>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<TestPaper>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Th_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<TestPaper>("Th_ID");
    			
    			/// <summary>
    			/// 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<TestPaper>("Th_Name");
    			
    			/// <summary>
    			/// 字段名：Tp_PassScore - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_PassScore = new DataBaseInfo.Field<TestPaper>("Tp_PassScore");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<TestPaper>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Tp_Remind - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Remind = new DataBaseInfo.Field<TestPaper>("Tp_Remind");
    			
    			/// <summary>
    			/// 字段名：Tp_SubName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_SubName = new DataBaseInfo.Field<TestPaper>("Tp_SubName");
    			
    			/// <summary>
    			/// 字段名：Tp_FromType - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tp_FromType = new DataBaseInfo.Field<TestPaper>("Tp_FromType");
    			
    			/// <summary>
    			/// 字段名：Tp_FromConfig - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_FromConfig = new DataBaseInfo.Field<TestPaper>("Tp_FromConfig");
    			
    			/// <summary>
    			/// 字段名：Cou_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Cou_Name = new DataBaseInfo.Field<TestPaper>("Cou_Name");
    		}
    	}
    }
