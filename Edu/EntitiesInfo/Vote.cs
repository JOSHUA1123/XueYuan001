namespace EntitiesInfo {
    	...
    	public partial class Vote : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Vote>("Vote");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Vote>();
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Id = new DataBaseInfo.Field<Vote>("Vt_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_UniqueId - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Vt_UniqueId = new DataBaseInfo.Field<Vote>("Vt_UniqueId");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_IsTheme - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Vt_IsTheme = new DataBaseInfo.Field<Vote>("Vt_IsTheme");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Name = new DataBaseInfo.Field<Vote>("Vt_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Type - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Type = new DataBaseInfo.Field<Vote>("Vt_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Intro = new DataBaseInfo.Field<Vote>("Vt_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Tax = new DataBaseInfo.Field<Vote>("Vt_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_SelectType - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_SelectType = new DataBaseInfo.Field<Vote>("Vt_SelectType");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Vt_IsShow = new DataBaseInfo.Field<Vote>("Vt_IsShow");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Vt_IsUse = new DataBaseInfo.Field<Vote>("Vt_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_IsAllowSee - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Vt_IsAllowSee = new DataBaseInfo.Field<Vote>("Vt_IsAllowSee");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_IsImage - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Vt_IsImage = new DataBaseInfo.Field<Vote>("Vt_IsImage");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_CrtTime = new DataBaseInfo.Field<Vote>("Vt_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_StartTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_StartTime = new DataBaseInfo.Field<Vote>("Vt_StartTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_OverTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_OverTime = new DataBaseInfo.Field<Vote>("Vt_OverTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Logo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Logo = new DataBaseInfo.Field<Vote>("Vt_Logo");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Image - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Image = new DataBaseInfo.Field<Vote>("Vt_Image");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_ImageSmall - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Vt_ImageSmall = new DataBaseInfo.Field<Vote>("Vt_ImageSmall");
    			
    			/// <summary>
    			/// -1 - 字段名：Vt_Number - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Vt_Number = new DataBaseInfo.Field<Vote>("Vt_Number");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Vote>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Vote>("Org_Name");
    		}
    	}
    }
