namespace EntitiesInfo {
    	...
    	public partial class User : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<User>("User");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<User>();
    			
    			/// <summary>
    			/// -1 - 字段名：User_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field User_Id = new DataBaseInfo.Field<User>("User_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：User_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_AccName = new DataBaseInfo.Field<User>("User_AccName");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Name = new DataBaseInfo.Field<User>("User_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Sex - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field User_Sex = new DataBaseInfo.Field<User>("User_Sex");
    			
    			/// <summary>
    			/// -1 - 字段名：User_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field User_IsUse = new DataBaseInfo.Field<User>("User_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Pw = new DataBaseInfo.Field<User>("User_Pw");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Email = new DataBaseInfo.Field<User>("User_Email");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Qus - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Qus = new DataBaseInfo.Field<User>("User_Qus");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Ans - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Ans = new DataBaseInfo.Field<User>("User_Ans");
    			
    			/// <summary>
    			/// -1 - 字段名：User_RegTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field User_RegTime = new DataBaseInfo.Field<User>("User_RegTime");
    			
    			/// <summary>
    			/// -1 - 字段名：User_LastTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field User_LastTime = new DataBaseInfo.Field<User>("User_LastTime");
    			
    			/// <summary>
    			/// -1 - 字段名：User_LoginNumber - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field User_LoginNumber = new DataBaseInfo.Field<User>("User_LoginNumber");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Tel - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Tel = new DataBaseInfo.Field<User>("User_Tel");
    			
    			/// <summary>
    			/// -1 - 字段名：User_MobileTel - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_MobileTel = new DataBaseInfo.Field<User>("User_MobileTel");
    			
    			/// <summary>
    			/// -1 - 字段名：User_QQ - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_QQ = new DataBaseInfo.Field<User>("User_QQ");
    			
    			/// <summary>
    			/// -1 - 字段名：User_Msn - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field User_Msn = new DataBaseInfo.Field<User>("User_Msn");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_Id = new DataBaseInfo.Field<User>("UGrp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_Name = new DataBaseInfo.Field<User>("UGrp_Name");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<User>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<User>("Org_Name");
    		}
    	}
    }
