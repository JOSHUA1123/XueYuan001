namespace EntitiesInfo {
    	...
    	public partial class Logs : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Logs>("Logs");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Logs>();
    			
    			/// <summary>
    			/// False - 字段名：Log_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Log_Id = new DataBaseInfo.Field<Logs>("Log_Id");
    			
    			/// <summary>
    			/// False - 字段名：Acc_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Id = new DataBaseInfo.Field<Logs>("Acc_Id");
    			
    			/// <summary>
    			/// True - 字段名：Acc_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Acc_Name = new DataBaseInfo.Field<Logs>("Acc_Name");
    			
    			/// <summary>
    			/// True - 字段名：Log_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Log_Type = new DataBaseInfo.Field<Logs>("Log_Type");
    			
    			/// <summary>
    			/// False - 字段名：Log_Time - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Log_Time = new DataBaseInfo.Field<Logs>("Log_Time");
    			
    			/// <summary>
    			/// True - 字段名：Log_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Log_IP = new DataBaseInfo.Field<Logs>("Log_IP");
    			
    			/// <summary>
    			/// True - 字段名：Log_OS - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Log_OS = new DataBaseInfo.Field<Logs>("Log_OS");
    			
    			/// <summary>
    			/// True - 字段名：Log_Browser - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Log_Browser = new DataBaseInfo.Field<Logs>("Log_Browser");
    			
    			/// <summary>
    			/// True - 字段名：Log_MenuName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Log_MenuName = new DataBaseInfo.Field<Logs>("Log_MenuName");
    			
    			/// <summary>
    			/// False - 字段名：Log_MenuId - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Log_MenuId = new DataBaseInfo.Field<Logs>("Log_MenuId");
    			
    			/// <summary>
    			/// True - 字段名：Log_FileName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Log_FileName = new DataBaseInfo.Field<Logs>("Log_FileName");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Logs>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Logs>("Org_Name");
    		}
    	}
    }
