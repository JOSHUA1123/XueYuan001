namespace EntitiesInfo {
    	...
    	public partial class LearningCard : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LearningCard>("LearningCard");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LearningCard>();
    			
    			/// <summary>
    			/// 字段名：Lc_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lc_ID = new DataBaseInfo.Field<LearningCard>("Lc_ID");
    			
    			/// <summary>
    			/// 字段名：Lc_Code - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lc_Code = new DataBaseInfo.Field<LearningCard>("Lc_Code");
    			
    			/// <summary>
    			/// 字段名：Lc_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lc_Pw = new DataBaseInfo.Field<LearningCard>("Lc_Pw");
    			
    			/// <summary>
    			/// 字段名：Lc_Price - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Lc_Price = new DataBaseInfo.Field<LearningCard>("Lc_Price");
    			
    			/// <summary>
    			/// 字段名：Lc_Coupon - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lc_Coupon = new DataBaseInfo.Field<LearningCard>("Lc_Coupon");
    			
    			/// <summary>
    			/// 字段名：Lc_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lc_CrtTime = new DataBaseInfo.Field<LearningCard>("Lc_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Lc_UsedTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lc_UsedTime = new DataBaseInfo.Field<LearningCard>("Lc_UsedTime");
    			
    			/// <summary>
    			/// 字段名：Lc_IsEnable - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lc_IsEnable = new DataBaseInfo.Field<LearningCard>("Lc_IsEnable");
    			
    			/// <summary>
    			/// 字段名：Lc_IsUsed - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Lc_IsUsed = new DataBaseInfo.Field<LearningCard>("Lc_IsUsed");
    			
    			/// <summary>
    			/// 字段名：Lcs_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lcs_ID = new DataBaseInfo.Field<LearningCard>("Lcs_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<LearningCard>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_AccName = new DataBaseInfo.Field<LearningCard>("Ac_AccName");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<LearningCard>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Lc_LimitStart - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lc_LimitStart = new DataBaseInfo.Field<LearningCard>("Lc_LimitStart");
    			
    			/// <summary>
    			/// 字段名：Lc_LimitEnd - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Lc_LimitEnd = new DataBaseInfo.Field<LearningCard>("Lc_LimitEnd");
    			
    			/// <summary>
    			/// 字段名：Lc_State - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lc_State = new DataBaseInfo.Field<LearningCard>("Lc_State");
    			
    			/// <summary>
    			/// 字段名：Lc_QrcodeBase64 - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Lc_QrcodeBase64 = new DataBaseInfo.Field<LearningCard>("Lc_QrcodeBase64");
    			
    			/// <summary>
    			/// 字段名：Lc_Span - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Lc_Span = new DataBaseInfo.Field<LearningCard>("Lc_Span");
    		}
    	}
    }
