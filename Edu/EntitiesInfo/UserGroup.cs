namespace EntitiesInfo {
    	...
    	public partial class UserGroup : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<UserGroup>("UserGroup");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<UserGroup>();
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_Id = new DataBaseInfo.Field<UserGroup>("UGrp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_Name = new DataBaseInfo.Field<UserGroup>("UGrp_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_IsUse = new DataBaseInfo.Field<UserGroup>("UGrp_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_Tax - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_Tax = new DataBaseInfo.Field<UserGroup>("UGrp_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_Intro = new DataBaseInfo.Field<UserGroup>("UGrp_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：UGrp_IsDefault - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field UGrp_IsDefault = new DataBaseInfo.Field<UserGroup>("UGrp_IsDefault");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<UserGroup>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<UserGroup>("Org_Name");
    		}
    	}
    }
