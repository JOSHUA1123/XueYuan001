namespace EntitiesInfo {
    	...
    	public partial class ProductFactory : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<ProductFactory>("ProductFactory");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<ProductFactory>();
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Id = new DataBaseInfo.Field<ProductFactory>("Pfact_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Name = new DataBaseInfo.Field<ProductFactory>("Pfact_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Addr - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Addr = new DataBaseInfo.Field<ProductFactory>("Pfact_Addr");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Zip - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Zip = new DataBaseInfo.Field<ProductFactory>("Pfact_Zip");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Intro = new DataBaseInfo.Field<ProductFactory>("Pfact_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Tel - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Tel = new DataBaseInfo.Field<ProductFactory>("Pfact_Tel");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_Website - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_Website = new DataBaseInfo.Field<ProductFactory>("Pfact_Website");
    			
    			/// <summary>
    			/// -1 - 字段名：Pfact_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Pfact_IsUse = new DataBaseInfo.Field<ProductFactory>("Pfact_IsUse");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<ProductFactory>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<ProductFactory>("Org_Name");
    		}
    	}
    }
