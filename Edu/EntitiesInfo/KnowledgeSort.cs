namespace EntitiesInfo {
    	...
    	public partial class KnowledgeSort : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<KnowledgeSort>("KnowledgeSort");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<KnowledgeSort>();
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Kns_ID = new DataBaseInfo.Field<KnowledgeSort>("Kns_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kns_Name = new DataBaseInfo.Field<KnowledgeSort>("Kns_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_ByName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kns_ByName = new DataBaseInfo.Field<KnowledgeSort>("Kns_ByName");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_PID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Kns_PID = new DataBaseInfo.Field<KnowledgeSort>("Kns_PID");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Kns_Tax = new DataBaseInfo.Field<KnowledgeSort>("Kns_Tax");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Kns_IsUse = new DataBaseInfo.Field<KnowledgeSort>("Kns_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_Type - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kns_Type = new DataBaseInfo.Field<KnowledgeSort>("Kns_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Kns_Intro = new DataBaseInfo.Field<KnowledgeSort>("Kns_Intro");
    			
    			/// <summary>
    			/// -1 - 字段名：Kns_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Kns_CrtTime = new DataBaseInfo.Field<KnowledgeSort>("Kns_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<KnowledgeSort>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<KnowledgeSort>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<KnowledgeSort>("Cou_ID");
    		}
    	}
    }
