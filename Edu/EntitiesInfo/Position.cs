namespace EntitiesInfo {
    	...
    	public partial class Position : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Position>("Position");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Position>();
    			
    			/// <summary>
    			/// False - 字段名：Posi_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Id = new DataBaseInfo.Field<Position>("Posi_Id");
    			
    			/// <summary>
    			/// True - 字段名：Posi_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Name = new DataBaseInfo.Field<Position>("Posi_Name");
    			
    			/// <summary>
    			/// False - 字段名：Posi_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Posi_IsUse = new DataBaseInfo.Field<Position>("Posi_IsUse");
    			
    			/// <summary>
    			/// False - 字段名：Posi_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Tax = new DataBaseInfo.Field<Position>("Posi_Tax");
    			
    			/// <summary>
    			/// True - 字段名：Posi_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Posi_Intro = new DataBaseInfo.Field<Position>("Posi_Intro");
    			
    			/// <summary>
    			/// False - 字段名：Posi_IsAdmin - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Posi_IsAdmin = new DataBaseInfo.Field<Position>("Posi_IsAdmin");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Position>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Position>("Org_Name");
    		}
    	}
    }
