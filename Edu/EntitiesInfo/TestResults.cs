namespace EntitiesInfo {
    	...
    	public partial class TestResults : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<TestResults>("TestResults");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<TestResults>();
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Tr_ID = new DataBaseInfo.Field<TestResults>("Tr_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_Score - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tr_Score = new DataBaseInfo.Field<TestResults>("Tr_Score");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_ScoreFinal - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tr_ScoreFinal = new DataBaseInfo.Field<TestResults>("Tr_ScoreFinal");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_Draw - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tr_Draw = new DataBaseInfo.Field<TestResults>("Tr_Draw");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_Colligate - 数据类型：Single(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tr_Colligate = new DataBaseInfo.Field<TestResults>("Tr_Colligate");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_Results - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tr_Results = new DataBaseInfo.Field<TestResults>("Tr_Results");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tr_CrtTime = new DataBaseInfo.Field<TestResults>("Tr_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tr_IP = new DataBaseInfo.Field<TestResults>("Tr_IP");
    			
    			/// <summary>
    			/// 字段名：Tr_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tr_Name = new DataBaseInfo.Field<TestResults>("Tr_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_Mac - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tr_Mac = new DataBaseInfo.Field<TestResults>("Tr_Mac");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_IsSubmit - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Tr_IsSubmit = new DataBaseInfo.Field<TestResults>("Tr_IsSubmit");
    			
    			/// <summary>
    			/// -1 - 字段名：Tr_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tr_UID = new DataBaseInfo.Field<TestResults>("Tr_UID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<TestResults>("Sbj_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<TestResults>("Sbj_Name");
    			
    			/// <summary>
    			/// -1 - 字段名：Tp_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Id = new DataBaseInfo.Field<TestResults>("Tp_Id");
    			
    			/// <summary>
    			/// 字段名：Tp_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Tp_Name = new DataBaseInfo.Field<TestResults>("Tp_Name");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<TestResults>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_Name = new DataBaseInfo.Field<TestResults>("Ac_Name");
    			
    			/// <summary>
    			/// 字段名：Sts_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sts_ID = new DataBaseInfo.Field<TestResults>("Sts_ID");
    			
    			/// <summary>
    			/// 字段名：Sts_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sts_Name = new DataBaseInfo.Field<TestResults>("Sts_Name");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<TestResults>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<TestResults>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：St_Sex - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field St_Sex = new DataBaseInfo.Field<TestResults>("St_Sex");
    			
    			/// <summary>
    			/// 字段名：St_IDCardNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_IDCardNumber = new DataBaseInfo.Field<TestResults>("St_IDCardNumber");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<TestResults>("Cou_ID");
    		}
    	}
    }
