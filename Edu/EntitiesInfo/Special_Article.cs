namespace EntitiesInfo {
    	...
    	public partial class Special_Article : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Special_Article>("Special_Article");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Special_Article>();
    			
    			/// <summary>
    			/// -1 - 字段名：Spa_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Spa_Id = new DataBaseInfo.Field<Special_Article>("Spa_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Sp_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Sp_Id = new DataBaseInfo.Field<Special_Article>("Sp_Id");
    			
    			/// <summary>
    			/// -1 - 字段名：Art_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Art_Id = new DataBaseInfo.Field<Special_Article>("Art_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<Special_Article>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Special_Article>("Org_Name");
    		}
    	}
    }
