namespace EntitiesInfo {
    	...
    	public partial class QuesAnswer : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<QuesAnswer>("QuesAnswer");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<QuesAnswer>();
    			
    			/// <summary>
    			/// -1 - 字段名：Ans_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ans_ID = new DataBaseInfo.Field<QuesAnswer>("Ans_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ID = new DataBaseInfo.Field<QuesAnswer>("Qus_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_UID = new DataBaseInfo.Field<QuesAnswer>("Qus_UID");
    			
    			/// <summary>
    			/// -1 - 字段名：Ans_Context - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ans_Context = new DataBaseInfo.Field<QuesAnswer>("Ans_Context");
    			
    			/// <summary>
    			/// -1 - 字段名：Ans_IsCorrect - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ans_IsCorrect = new DataBaseInfo.Field<QuesAnswer>("Ans_IsCorrect");
    		}
    	}
    }
