namespace EntitiesInfo {
    	...
    	public partial class FuncPoint : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<FuncPoint>("FuncPoint");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<FuncPoint>();
    			
    			/// <summary>
    			/// False - 字段名：FPI_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field FPI_Id = new DataBaseInfo.Field<FuncPoint>("FPI_Id");
    			
    			/// <summary>
    			/// True - 字段名：FPI_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field FPI_Name = new DataBaseInfo.Field<FuncPoint>("FPI_Name");
    			
    			/// <summary>
    			/// False - 字段名：FPI_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field FPI_IsUse = new DataBaseInfo.Field<FuncPoint>("FPI_IsUse");
    			
    			/// <summary>
    			/// False - 字段名：FPI_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field FPI_IsShow = new DataBaseInfo.Field<FuncPoint>("FPI_IsShow");
    			
    			/// <summary>
    			/// 字段名：Org_Id - 数据类型：Int32(可空)
    			/// </summary>
    			public static DataBaseInfo.Field Org_Id = new DataBaseInfo.Field<FuncPoint>("Org_Id");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<FuncPoint>("Org_Name");
    		}
    	}
    }
