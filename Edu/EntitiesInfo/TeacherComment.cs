namespace EntitiesInfo {
    	...
    	public partial class TeacherComment : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<TeacherComment>("TeacherComment");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<TeacherComment>();
    			
    			/// <summary>
    			/// 字段名：Thc_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Thc_ID = new DataBaseInfo.Field<TeacherComment>("Thc_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<TeacherComment>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Th_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Th_ID = new DataBaseInfo.Field<TeacherComment>("Th_ID");
    			
    			/// <summary>
    			/// 字段名：Th_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Th_Name = new DataBaseInfo.Field<TeacherComment>("Th_Name");
    			
    			/// <summary>
    			/// 字段名：Thc_Score - 数据类型：Double
    			/// </summary>
    			public static DataBaseInfo.Field Thc_Score = new DataBaseInfo.Field<TeacherComment>("Thc_Score");
    			
    			/// <summary>
    			/// 字段名：Thc_Comment - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thc_Comment = new DataBaseInfo.Field<TeacherComment>("Thc_Comment");
    			
    			/// <summary>
    			/// 字段名：Thc_Reply - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thc_Reply = new DataBaseInfo.Field<TeacherComment>("Thc_Reply");
    			
    			/// <summary>
    			/// 字段名：Thc_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Thc_CrtTime = new DataBaseInfo.Field<TeacherComment>("Thc_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Thc_Device - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thc_Device = new DataBaseInfo.Field<TeacherComment>("Thc_Device");
    			
    			/// <summary>
    			/// 字段名：Thc_IP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Thc_IP = new DataBaseInfo.Field<TeacherComment>("Thc_IP");
    			
    			/// <summary>
    			/// 字段名：Thc_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Thc_IsUse = new DataBaseInfo.Field<TeacherComment>("Thc_IsUse");
    			
    			/// <summary>
    			/// 字段名：Thc_IsShow - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Thc_IsShow = new DataBaseInfo.Field<TeacherComment>("Thc_IsShow");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<TeacherComment>("Org_ID");
    		}
    	}
    }
