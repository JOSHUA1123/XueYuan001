namespace EntitiesInfo {
    	...
    	public partial class TeacherSort : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<TeacherSort>("TeacherSort");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<TeacherSort>();
    			
    			/// <summary>
    			/// 字段名：Ths_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ths_ID = new DataBaseInfo.Field<TeacherSort>("Ths_ID");
    			
    			/// <summary>
    			/// 字段名：Ths_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ths_Name = new DataBaseInfo.Field<TeacherSort>("Ths_Name");
    			
    			/// <summary>
    			/// 字段名：Ths_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ths_Tax = new DataBaseInfo.Field<TeacherSort>("Ths_Tax");
    			
    			/// <summary>
    			/// 字段名：Ths_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ths_Intro = new DataBaseInfo.Field<TeacherSort>("Ths_Intro");
    			
    			/// <summary>
    			/// 字段名：Ths_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ths_IsUse = new DataBaseInfo.Field<TeacherSort>("Ths_IsUse");
    			
    			/// <summary>
    			/// 字段名：Ths_IsDefault - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Ths_IsDefault = new DataBaseInfo.Field<TeacherSort>("Ths_IsDefault");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<TeacherSort>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<TeacherSort>("Org_Name");
    		}
    	}
    }
