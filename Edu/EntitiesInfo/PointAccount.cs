namespace EntitiesInfo {
    	...
    	public partial class PointAccount : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<PointAccount>("PointAccount");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<PointAccount>();
    			
    			/// <summary>
    			/// 字段名：Pa_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pa_ID = new DataBaseInfo.Field<PointAccount>("Pa_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<PointAccount>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Pa_Total - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Total = new DataBaseInfo.Field<PointAccount>("Pa_Total");
    			
    			/// <summary>
    			/// 字段名：Pa_TotalAmount - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pa_TotalAmount = new DataBaseInfo.Field<PointAccount>("Pa_TotalAmount");
    			
    			/// <summary>
    			/// 字段名：Pa_Value - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Value = new DataBaseInfo.Field<PointAccount>("Pa_Value");
    			
    			/// <summary>
    			/// 字段名：Pa_Source - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Source = new DataBaseInfo.Field<PointAccount>("Pa_Source");
    			
    			/// <summary>
    			/// 字段名：Pa_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Type = new DataBaseInfo.Field<PointAccount>("Pa_Type");
    			
    			/// <summary>
    			/// 字段名：Pa_Info - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Info = new DataBaseInfo.Field<PointAccount>("Pa_Info");
    			
    			/// <summary>
    			/// 字段名：Pa_Remark - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Remark = new DataBaseInfo.Field<PointAccount>("Pa_Remark");
    			
    			/// <summary>
    			/// 字段名：Pa_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Pa_CrtTime = new DataBaseInfo.Field<PointAccount>("Pa_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<PointAccount>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Pa_Serial - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Pa_Serial = new DataBaseInfo.Field<PointAccount>("Pa_Serial");
    			
    			/// <summary>
    			/// 字段名：Pa_From - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Pa_From = new DataBaseInfo.Field<PointAccount>("Pa_From");
    		}
    	}
    }
