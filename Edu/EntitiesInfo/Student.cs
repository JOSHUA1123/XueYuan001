namespace EntitiesInfo {
    	...
    	public partial class Student : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Student>("Student");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Student>();
    			
    			/// <summary>
    			/// 字段名：St_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field St_ID = new DataBaseInfo.Field<Student>("St_ID");
    			
    			/// <summary>
    			/// 字段名：St_AccName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_AccName = new DataBaseInfo.Field<Student>("St_AccName");
    			
    			/// <summary>
    			/// 字段名：St_Pw - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Pw = new DataBaseInfo.Field<Student>("St_Pw");
    			
    			/// <summary>
    			/// 字段名：St_Qus - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Qus = new DataBaseInfo.Field<Student>("St_Qus");
    			
    			/// <summary>
    			/// 字段名：St_Anwser - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Anwser = new DataBaseInfo.Field<Student>("St_Anwser");
    			
    			/// <summary>
    			/// 字段名：St_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Name = new DataBaseInfo.Field<Student>("St_Name");
    			
    			/// <summary>
    			/// 字段名：St_Pinyin - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Pinyin = new DataBaseInfo.Field<Student>("St_Pinyin");
    			
    			/// <summary>
    			/// 字段名：St_Age - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field St_Age = new DataBaseInfo.Field<Student>("St_Age");
    			
    			/// <summary>
    			/// 字段名：St_Birthday - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field St_Birthday = new DataBaseInfo.Field<Student>("St_Birthday");
    			
    			/// <summary>
    			/// 字段名：St_IDCardNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_IDCardNumber = new DataBaseInfo.Field<Student>("St_IDCardNumber");
    			
    			/// <summary>
    			/// 字段名：St_Photo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Photo = new DataBaseInfo.Field<Student>("St_Photo");
    			
    			/// <summary>
    			/// 字段名：St_Signature - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Signature = new DataBaseInfo.Field<Student>("St_Signature");
    			
    			/// <summary>
    			/// 字段名：St_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Intro = new DataBaseInfo.Field<Student>("St_Intro");
    			
    			/// <summary>
    			/// 字段名：St_Major - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Major = new DataBaseInfo.Field<Student>("St_Major");
    			
    			/// <summary>
    			/// 字段名：St_Education - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Education = new DataBaseInfo.Field<Student>("St_Education");
    			
    			/// <summary>
    			/// 字段名：St_Sex - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field St_Sex = new DataBaseInfo.Field<Student>("St_Sex");
    			
    			/// <summary>
    			/// 字段名：St_Native - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Native = new DataBaseInfo.Field<Student>("St_Native");
    			
    			/// <summary>
    			/// 字段名：St_Nation - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Nation = new DataBaseInfo.Field<Student>("St_Nation");
    			
    			/// <summary>
    			/// 字段名：St_CodeNumber - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_CodeNumber = new DataBaseInfo.Field<Student>("St_CodeNumber");
    			
    			/// <summary>
    			/// 字段名：St_Address - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Address = new DataBaseInfo.Field<Student>("St_Address");
    			
    			/// <summary>
    			/// 字段名：St_AddrContact - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_AddrContact = new DataBaseInfo.Field<Student>("St_AddrContact");
    			
    			/// <summary>
    			/// 字段名：St_Phone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Phone = new DataBaseInfo.Field<Student>("St_Phone");
    			
    			/// <summary>
    			/// 字段名：St_IsOpenPhone - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field St_IsOpenPhone = new DataBaseInfo.Field<Student>("St_IsOpenPhone");
    			
    			/// <summary>
    			/// 字段名：St_PhoneMobi - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_PhoneMobi = new DataBaseInfo.Field<Student>("St_PhoneMobi");
    			
    			/// <summary>
    			/// 字段名：St_IsOpenMobi - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field St_IsOpenMobi = new DataBaseInfo.Field<Student>("St_IsOpenMobi");
    			
    			/// <summary>
    			/// 字段名：St_Email - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Email = new DataBaseInfo.Field<Student>("St_Email");
    			
    			/// <summary>
    			/// 字段名：St_Qq - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Qq = new DataBaseInfo.Field<Student>("St_Qq");
    			
    			/// <summary>
    			/// 字段名：St_Weixin - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Weixin = new DataBaseInfo.Field<Student>("St_Weixin");
    			
    			/// <summary>
    			/// 字段名：St_Zip - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_Zip = new DataBaseInfo.Field<Student>("St_Zip");
    			
    			/// <summary>
    			/// 字段名：St_LinkMan - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_LinkMan = new DataBaseInfo.Field<Student>("St_LinkMan");
    			
    			/// <summary>
    			/// 字段名：St_LinkManPhone - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_LinkManPhone = new DataBaseInfo.Field<Student>("St_LinkManPhone");
    			
    			/// <summary>
    			/// 字段名：St_IsPass - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field St_IsPass = new DataBaseInfo.Field<Student>("St_IsPass");
    			
    			/// <summary>
    			/// 字段名：St_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field St_IsUse = new DataBaseInfo.Field<Student>("St_IsUse");
    			
    			/// <summary>
    			/// 字段名：St_RegTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field St_RegTime = new DataBaseInfo.Field<Student>("St_RegTime");
    			
    			/// <summary>
    			/// 字段名：St_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field St_LastTime = new DataBaseInfo.Field<Student>("St_LastTime");
    			
    			/// <summary>
    			/// 字段名：St_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field St_CrtTime = new DataBaseInfo.Field<Student>("St_CrtTime");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Student>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Org_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Org_Name = new DataBaseInfo.Field<Student>("Org_Name");
    			
    			/// <summary>
    			/// 字段名：Sts_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sts_ID = new DataBaseInfo.Field<Student>("Sts_ID");
    			
    			/// <summary>
    			/// 字段名：Sts_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sts_Name = new DataBaseInfo.Field<Student>("Sts_Name");
    			
    			/// <summary>
    			/// 字段名：St_Money - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field St_Money = new DataBaseInfo.Field<Student>("St_Money");
    			
    			/// <summary>
    			/// 字段名：St_LastIP - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_LastIP = new DataBaseInfo.Field<Student>("St_LastIP");
    			
    			/// <summary>
    			/// 字段名：Dep_CnName - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Dep_CnName = new DataBaseInfo.Field<Student>("Dep_CnName");
    			
    			/// <summary>
    			/// 字段名：Dep_Id - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Dep_Id = new DataBaseInfo.Field<Student>("Dep_Id");
    			
    			/// <summary>
    			/// 字段名：St_CheckUID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field St_CheckUID = new DataBaseInfo.Field<Student>("St_CheckUID");
    			
    			/// <summary>
    			/// 字段名：St_CurrCourse - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field St_CurrCourse = new DataBaseInfo.Field<Student>("St_CurrCourse");
    			
    			/// <summary>
    			/// 字段名：Ac_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ac_ID = new DataBaseInfo.Field<Student>("Ac_ID");
    			
    			/// <summary>
    			/// 字段名：Ac_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ac_UID = new DataBaseInfo.Field<Student>("Ac_UID");
    		}
    	}
    }
