namespace EntitiesInfo {
    	...
    	public partial class LimitDomain : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<LimitDomain>("LimitDomain");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<LimitDomain>();
    			
    			/// <summary>
    			/// 字段名：LD_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field LD_ID = new DataBaseInfo.Field<LimitDomain>("LD_ID");
    			
    			/// <summary>
    			/// 字段名：LD_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field LD_Name = new DataBaseInfo.Field<LimitDomain>("LD_Name");
    			
    			/// <summary>
    			/// 字段名：LD_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field LD_IsUse = new DataBaseInfo.Field<LimitDomain>("LD_IsUse");
    			
    			/// <summary>
    			/// 字段名：LD_Intro - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field LD_Intro = new DataBaseInfo.Field<LimitDomain>("LD_Intro");
    		}
    	}
    }
