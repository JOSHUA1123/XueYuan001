namespace EntitiesInfo {
    	...
    	public partial class Questions : DataBaseInfo.Entity {
    		...
    		protected override DataBaseInfo.Table GetTable() {
    			return new DataBaseInfo.Table<Questions>("Questions");
    		}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static DataBaseInfo.AllField All = new DataBaseInfo.AllField<Questions>();
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ID = new DataBaseInfo.Field<Questions>("Qus_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_Title - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Title = new DataBaseInfo.Field<Questions>("Qus_Title");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_Answer - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Answer = new DataBaseInfo.Field<Questions>("Qus_Answer");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_Diff - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Diff = new DataBaseInfo.Field<Questions>("Qus_Diff");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_Type - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Type = new DataBaseInfo.Field<Questions>("Qus_Type");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_Explain - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Explain = new DataBaseInfo.Field<Questions>("Qus_Explain");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_IsUse - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Qus_IsUse = new DataBaseInfo.Field<Questions>("Qus_IsUse");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_IsError - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Qus_IsError = new DataBaseInfo.Field<Questions>("Qus_IsError");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_UID - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_UID = new DataBaseInfo.Field<Questions>("Qus_UID");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_Number - 数据类型：Single
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Number = new DataBaseInfo.Field<Questions>("Qus_Number");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_CrtTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Qus_CrtTime = new DataBaseInfo.Field<Questions>("Qus_CrtTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_LastTime - 数据类型：DateTime
    			/// </summary>
    			public static DataBaseInfo.Field Qus_LastTime = new DataBaseInfo.Field<Questions>("Qus_LastTime");
    			
    			/// <summary>
    			/// -1 - 字段名：Qus_IsCorrect - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Qus_IsCorrect = new DataBaseInfo.Field<Questions>("Qus_IsCorrect");
    			
    			/// <summary>
    			/// -1 - 字段名：Kn_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Kn_ID = new DataBaseInfo.Field<Questions>("Kn_ID");
    			
    			/// <summary>
    			/// -1 - 字段名：Sbj_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_ID = new DataBaseInfo.Field<Questions>("Sbj_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_ErrorInfo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_ErrorInfo = new DataBaseInfo.Field<Questions>("Qus_ErrorInfo");
    			
    			/// <summary>
    			/// 字段名：Org_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Org_ID = new DataBaseInfo.Field<Questions>("Org_ID");
    			
    			/// <summary>
    			/// 字段名：Cou_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Cou_ID = new DataBaseInfo.Field<Questions>("Cou_ID");
    			
    			/// <summary>
    			/// 字段名：Ol_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Ol_ID = new DataBaseInfo.Field<Questions>("Ol_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_IsWrong - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Qus_IsWrong = new DataBaseInfo.Field<Questions>("Qus_IsWrong");
    			
    			/// <summary>
    			/// 字段名：Qt_ID - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qt_ID = new DataBaseInfo.Field<Questions>("Qt_ID");
    			
    			/// <summary>
    			/// 字段名：Qus_WrongInfo - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_WrongInfo = new DataBaseInfo.Field<Questions>("Qus_WrongInfo");
    			
    			/// <summary>
    			/// 字段名：Qus_Items - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Items = new DataBaseInfo.Field<Questions>("Qus_Items");
    			
    			/// <summary>
    			/// 字段名：Qus_IsTitle - 数据类型：Boolean
    			/// </summary>
    			public static DataBaseInfo.Field Qus_IsTitle = new DataBaseInfo.Field<Questions>("Qus_IsTitle");
    			
    			/// <summary>
    			/// 字段名：Ol_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Ol_Name = new DataBaseInfo.Field<Questions>("Ol_Name");
    			
    			/// <summary>
    			/// 字段名：Sbj_Name - 数据类型：String
    			/// </summary>
    			public static DataBaseInfo.Field Sbj_Name = new DataBaseInfo.Field<Questions>("Sbj_Name");
    			
    			/// <summary>
    			/// 字段名：Qus_Tax - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Tax = new DataBaseInfo.Field<Questions>("Qus_Tax");
    			
    			/// <summary>
    			/// 字段名：Qus_Errornum - 数据类型：Int32
    			/// </summary>
    			public static DataBaseInfo.Field Qus_Errornum = new DataBaseInfo.Field<Questions>("Qus_Errornum");
    		}
    	}
    }
