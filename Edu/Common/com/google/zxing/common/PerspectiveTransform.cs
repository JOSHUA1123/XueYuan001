...
// Type: com.google.zxing.common.PerspectiveTransform
...
namespace com.google.zxing.common
{
  ...
  public sealed class PerspectiveTransform
  {
    ...
    public void transformPoints(float[] points)
    {
      ...
      while (index < length)
      {
        float num10 = points[index];
        float num11 = points[index + 1];
        float num12 = (float) ((double) num3 * (double) num10 + (double) num6 * (double) num11) + num9;
        points[index] = ((float) ((double) num1 * (double) num10 + (double) num4 * (double) num11) + num7) / num12;
        points[index + 1] = ((float) ((double) num2 * (double) num10 + (double) num5 * (double) num11) + num8) / num12;
        index += 2;
      }
    }
    ...
    public void transformPoints(float[] xValues, float[] yValues)
    {
      ...
      {
        float num1 = xValues[index];
        float num2 = yValues[index];
        float num3 = (float) ((double) this.a13 * (double) num1 + (double) this.a23 * (double) num2) + this.a33;
        xValues[index] = ((float) ((double) this.a11 * (double) num1 + (double) this.a21 * (double) num2) + this.a31) / num3;
        yValues[index] = ((float) ((double) this.a12 * (double) num1 + (double) this.a22 * (double) num2) + this.a32) / num3;
      }
    }
    ...
    public static PerspectiveTransform squareToQuadrilateral(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3)
    {
      ...
      float num6 = y1 - y2;
      float num7 = (float) ((double) num3 * (double) num1 - (double) num4 * (double) num6);
      float a13 = (float) ((double) num5 * (double) num1 - (double) num4 * (double) num2) / num7;
      float a23 = (float) ((double) num3 * (double) num2 - (double) num5 * (double) num6) / num7;
