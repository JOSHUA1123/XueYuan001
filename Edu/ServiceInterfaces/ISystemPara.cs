...
namespace ServiceInterfaces
{
    ...
    /// 系统参数管理
    /// </summary>
    public interface ISystemPara : Common.IBusinessInterface, System.Collections.IEnumerable
    {
        /// <summary>
        /// 添加
        /// </summary>
        ...
        /// <returns></returns>
        Common.Param.Method.ConvertToAnyValue this[string key] { get;}        
        /// <summary>
        /// 获取单个实例
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        T ScalarSql<T>(string sql) where T : DataBaseInfo.Entity;
        /// <summary>
        /// 执行sql语句
        /// </summary>
        /// <param name="sql"></param>
        /// <returns>返回数据集</returns>
        List<T> ForSql<T>(string sql) where T : DataBaseInfo.Entity;
