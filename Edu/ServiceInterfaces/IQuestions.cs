...
namespace ServiceInterfaces
{
    ...
    /// 试题管理
    /// </summary>
    public interface IQuestions : Common.IBusinessInterface
    {
        #region 试题管理
        /// <summary>
        /// 添加试题
        ...
        /// <returns></returns>
        void QuesInput(Questions entity, List<EntitiesInfo.QuesAnswer> ansItem);
        /// <summary>
        /// 删除，按主键ID；
        /// </summary>
        ...
        /// <returns></returns>
        string AnswerToItems(EntitiesInfo.QuesAnswer[] ans);
        /// <summary>
        ...
        /// <returns></returns>
        EntitiesInfo.QuesAnswer[] ItemsToAnswer(string xml, bool? isCorrect);
        /// <summary>
        /// 将答题选项的xml字符串，转换为QuesAnswer对象数组
        /// </summary>
        /// <param name="xml"></param>
        /// <returns></returns>
        EntitiesInfo.QuesAnswer ItemToAnswer(string xml);
        /// <summary>
        /// 计算当前试题的得分
        /// </summary>
