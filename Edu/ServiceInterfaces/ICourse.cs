...
namespace ServiceInterfaces
{
    ...
    /// 课程管理
    /// </summary>
    public interface ICourse : Common.IBusinessInterface
    {
        #region 课程管理
        /// <summary>
        /// 添加课程
        ...
        /// <returns></returns>
        Course CourseSingle(string couName);
        /// <summary>
        ...
        /// <returns></returns>
        Student_Course Buy(int stid, int couid, EntitiesInfo.CoursePrice price);
        /// <summary>
        /// 免费学习
        /// </summary>
