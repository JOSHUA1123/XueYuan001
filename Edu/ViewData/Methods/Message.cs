...
namespace ViewData.Methods
{
    ...
    public class Message : IViewAPI
    {
        ...
        public int Add(string msg, int playtime, int couid, int olid)
        {
            ...
            EntitiesInfo.Message entity = new EntitiesInfo.Message();
            ...
            entity.Msg_IP = Common.Browser.IP;
        ...
        /// <returns></returns>
        public EntitiesInfo.Message[] All(int olid, string order)
        {
        ...
        {
            EntitiesInfo.Message mm = Business.Do<IMessage>().GetSingle(msid);
