...
namespace ViewData.Methods
{
    ...
    public class Subject : IViewAPI
    {
        ...
        /// <returns></returns>
        public EntitiesInfo.Subject ForID(int id)
        {
        ...
        public EntitiesInfo.Subject[] List(int orgid)
        {
        ...
        {
            EntitiesInfo.Subject[] sbjs= Business.Do<ISubject>().SubjectCount(orgid, string.Empty, true, -1, -1);
