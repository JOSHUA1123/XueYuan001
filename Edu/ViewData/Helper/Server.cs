    ...
    public sealed class Server
    {
        ...
        public string RootDomain
        {
            get
            {
                try
                {
                    return Common.Server.RootDomain;
                }
                catch
                {
                    return "";
        ...
        public double RamSize
        {
            get
            {
                if (_ramSize < 0) _ramSize = Common.Server.RamSize;
                return _ramSize;
            }
        }
        ...
        public DateTime InitDate
        {
            get
            {
                ...
                _initDate = Common.License.Value.InitDate;
                return _initDate;
            }
        }
    }
