...
namespace ViewData 
{
    ...
    public class Letter : IEnumerable
    {
        ...
        /// 服务器端的信息
        /// </summary>
        public ViewData.Server Sever
        {
            get
            {
                return ViewData.Server.GetServer();
            }
        }
        /// <summary>
        /// 请求的来源，即客户端
        /// </summary>
        public ViewData.Browser Client
        {
            get
            {
                return ViewData.Browser.GetBrowser();
            }
        }
        #endregion
        ...
        public Letter(HttpContext context)
        {
            ...
            if (!string.IsNullOrWhiteSpace(auth))
            {
                ...
                auth =Common.DataConvert.DecryptForBase64(auth);
