...
namespace ServiceImpls
{
    public class ColumnsCom : IColumns
    {
        ...
        public void Save(Columns entity)
        {
        ...
        public Columns[] Children(int pid, bool? isUse)
        {
