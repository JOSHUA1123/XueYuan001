    ...
    public class TeacherCom : ITeacher
    {
        ...
        public int TeacherAdd(Teacher entity)
        {
            ...
            if (string.IsNullOrWhiteSpace(entity.Th_AccName))
            {
                ...
                {
                    entity.Th_AccName = Common.Request.UniqueID();
                }
            }
            //如果密码不为空
            //if (!string.IsNullOrWhiteSpace(entity.Th_Pw))                
            //    entity.Th_Pw = new Common.Param.Method.ConvertToAnyValue(entity.Th_Pw).MD5;


            //if (teacherService.Add(InsertTeacher(entity)))
            //{
                
            //    return int.Parse(teacherService.GetModels(n => n.Th_AccName == entity.Th_AccName).FirstOrDefault().Ths_ID.ToString());
            //}
        ...
        /// <returns></returns>
        public Entities.Teacher InsertTeacher(Teacher entity)
        {
            Entities.Teacher teacher = new Entities.Teacher();
            teacher.Th_AccName = entity.Th_AccName!=null ? entity.Th_AccName:"";
            teacher.Th_Pw = entity.Th_Pw!=null? entity.Th_Pw:"";
            teacher.Th_Qus = entity.Th_Qus!=null? entity.Th_Qus:"";
            teacher.Th_Anwser = entity.Th_Anwser!=null? entity.Th_Anwser:"";
            teacher.Th_Name = entity.Th_Name != null ? entity.Th_Name:"";
            teacher.Th_Title = entity.Th_Title != null ? entity.Th_Title:"";
            teacher.Th_Pinyin = entity.Th_Pinyin != null ? entity.Th_Pinyin:"";
            teacher.Th_Age = entity.Th_Age.ToString() !=null ? entity.Th_Age: 0;
            teacher.Th_Birthday = entity.Th_Birthday != null ? entity.Th_Birthday:DateTime.Now;
            teacher.Th_IDCardNumber = entity.Th_IDCardNumber != null ? entity.Th_IDCardNumber:"";
            teacher.Th_Photo = entity.Th_Photo != null ? entity.Th_Photo:"";
            teacher.Th_Signature = entity.Th_Signature != null ? entity.Th_Signature:"";
            teacher.Th_Intro = entity.Th_Intro != null ? entity.Th_Intro:"";
            teacher.Th_Job = entity.Th_Job != null ? entity.Th_Job:"";
            teacher.Th_Major = entity.Th_Major != null ? entity.Th_Major:"";
            teacher.Th_Education = entity.Th_Education != null ? entity.Th_Education:"";
            teacher.Th_Sex = entity.Th_Sex.ToString() != null ? entity.Th_Sex:0;
            teacher.Th_Native = entity.Th_Native != null ? entity.Th_Native:"";
            teacher.Th_Nation = entity.Th_Nation != null ? entity.Th_Nation:"";
            teacher.Th_CodeNumber = entity.Th_CodeNumber != null ? entity.Th_CodeNumber:"";
            teacher.Th_Address = entity.Th_Address != null ? entity.Th_Address:"";
            teacher.Th_AddrContact = entity.Th_AddrContact != null ? entity.Th_AddrContact:"";
            teacher.Th_Phone = entity.Th_Phone != null ? entity.Th_Phone:"";
            teacher.Th_IsOpenPhone = entity.Th_IsOpenPhone.ToString() != null ? entity.Th_IsOpenPhone:false;
            teacher.Th_PhoneMobi = entity.Th_PhoneMobi != null ? entity.Th_PhoneMobi:"";
            teacher.Th_IsOpenMobi = entity.Th_IsOpenMobi.ToString() != null ? entity.Th_IsOpenMobi :false;
            teacher.Th_Email = entity.Th_Email != null ? entity.Th_Email:"";
            teacher.Th_Qq = entity.Th_Qq != null ? entity.Th_Qq:"";
            teacher.Th_Weixin = entity.Th_Weixin != null ? entity.Th_Weixin:"";
            teacher.Th_Zip = entity.Th_Zip != null ? entity.Th_Zip:"";
            teacher.Th_LinkMan = entity.Th_LinkMan != null ? entity.Th_LinkMan:"";
            teacher.Th_LinkManPhone = entity.Th_LinkManPhone != null ? entity.Th_LinkManPhone:"";
            teacher.Th_IsPass = entity.Th_IsPass.ToString() != null ? entity.Th_IsPass:false;
            teacher.Th_IsUse = entity.Th_IsUse.ToString() != null ? entity.Th_IsUse:false;
            teacher.Th_RegTime = entity.Th_RegTime != null ? entity.Th_RegTime : DateTime.Now;
            teacher.Th_LastTime = entity.Th_LastTime != null ? entity.Th_LastTime: DateTime.Now;
            teacher.Th_CrtTime = entity.Th_CrtTime != null ? entity.Th_CrtTime:DateTime.Now;
            teacher.Th_Tax = entity.Th_Tax.ToString() != null ? entity.Th_Tax:0;
            teacher.Th_Score = entity.Th_Score.ToString() != null ? entity.Th_Score:0;
            teacher.Th_ViewNum = entity.Th_ViewNum.ToString() != null ? entity.Th_ViewNum:0;
            teacher.Org_ID = entity.Org_ID.ToString() != null ? entity.Org_ID:0;
            teacher.Org_Name = entity.Org_Name != null ? entity.Org_Name:"";
            teacher.Ths_ID = entity.Ths_ID.ToString() != null ? entity.Ths_ID:0;
            teacher.Ths_Name = entity.Ths_Name != null ? entity.Ths_Name:"";
            teacher.Dep_Id = entity.Dep_Id.ToString() != null ? entity.Dep_Id:0;
            teacher.Th_IsShow = entity.Th_IsShow.ToString() != null ? entity.Th_IsShow:false;
            teacher.Ac_ID = entity.Ac_ID.ToString() != null?entity.Ac_ID :0;
            teacher.Ac_UID = entity.Ac_UID!=null? entity.Ac_UID:"";
            return teacher;
        }
        ...
        public void TeacherSave(Teacher entity){
            ...
            using (DbTrans tran = Gateway.Default.BeginTrans())
            {
                try
                {
                    //teacherService.Add(InsertTeacher(entity));
        ...
        {
            Teacher th = this.TeacherSingle(identify);
            if (th == null) return;
        ...
        {
            Teacher th = this.TeacherSingle(accname, orgid);
            if (th == null) return;
            this.TeacherDelete(th); 
        }
        ...
        public Teacher TeacherLogin(string acc, string pw, int orgid)
        {
            ...
            wc.And(Teacher._.Th_Pw == new Common.Param.Method.ConvertToAnyValue(pw).MD5);
            Teacher entity = null;
        ...
        public string TeacherExport4Excel(string path, int orgid, int sortid)
        {
            ...
            string confing = Common.App.Get["ExcelInputConfig"].VirtualPath + "教师信息.xml";
            ...
            for (int i = 0; i < Teachers.Length; i++)
                Teachers[i].Th_Intro = Common.HTML.ClearTag(Teachers[i].Th_Intro);
            for (int i = 0; i < Teachers.Length; i++)
            {
        ...
        public int SortDelete(int identify)
        {
            ...
            if (st != null) throw new Common.ExceptionForAlert("请先删除其所属的教师信息");
        ...
        public int CommentAdd(TeacherComment entity)
        {
            ...
            entity.Thc_IP = Common.Request.IP.IPAddress;
            entity.Thc_Device = Common.Browser.IsMobile ? "Mobi" : "PC";
