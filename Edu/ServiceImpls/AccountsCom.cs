...
namespace ServiceImpls
{
    public class AccountsCom : IAccounts
    {
        ...
        public string RegAgreement()
        {
            ...
            agreement = Regex.Replace(agreement, "{domain}", Common.Server.MainName, RegexOptions.IgnoreCase);
            return agreement;
        }
        #region 账户管理
        /// <summary>
        ...
        public int AccountsAdd(Accounts entity)
        {
            ...
            if (string.IsNullOrWhiteSpace(entity.Ac_AccName))
                ...
                entity.Ac_AccName = string.IsNullOrWhiteSpace(entity.Ac_Name) ? RandomNum(): entity.Ac_Name.Trim();
            else
            ...
            if (string.IsNullOrWhiteSpace(entity.Ac_Pw))
                entity.Ac_Pw = Common.Login.Get["Accounts"].DefaultPw.MD5;
            Gateway.Default.Save<Accounts>(entity);

            #region  Account   用户信息
            //AccountsService accountsService = new AccountsService();
            //Entities.Accounts accounts = new Entities.Accounts();
            //accounts.Ac_PID = entity.Ac_PID;
            //accounts.Ac_AccName = entity.Ac_AccName;
            //accounts.Ac_Pw = entity.Ac_Pw;
            //accounts.Ac_Name = entity.Ac_Name;
            //accounts.Ac_Pinyin = entity.Ac_Pinyin;
            //accounts.Ac_IDCardNumber = entity.Ac_IDCardNumber;
            //accounts.Ac_Signature = entity.Ac_Signature;
            //accounts.Ac_Age = entity.Ac_Age;
            //accounts.Ac_Sex = entity.Ac_Sex;
            //accounts.Ac_Photo = entity.Ac_Photo;
            //accounts.Ac_Money = entity.Ac_Money;
            //accounts.Ac_Point = entity.Ac_Point;
            //accounts.Ac_Coupon = entity.Ac_Coupon;
            //accounts.Ac_IsUse = entity.Ac_IsUse;
            //accounts.Ac_IsPass = entity.Ac_IsPass;
            //accounts.Ac_IsTeacher = entity.Ac_IsTeacher;
            //accounts.Ac_Qus = entity.Ac_Qus;
            //accounts.Ac_Ans = entity.Ac_Ans;
            //accounts.Ac_RegTime = DateTime.Now;
            //accounts.Ac_LastTime = DateTime.Now;
            //accounts.Ac_LastIP = entity.Ac_LastIP;
            //accounts.Ac_Tel = entity.Ac_Tel;
            //accounts.Ac_IsOpenTel = entity.Ac_IsOpenTel;
            //accounts.Ac_MobiTel1 = entity.Ac_MobiTel1;
            //accounts.Ac_MobiTel2 = entity.Ac_MobiTel2;
            //accounts.Ac_IsOpenMobile = entity.Ac_IsOpenMobile;
            //accounts.Ac_Email = entity.Ac_Email;
            //accounts.Ac_Qq = entity.Ac_Qq;
            //accounts.Ac_Weixin = entity.Ac_Weixin;
            //accounts.Ac_CheckUID = entity.Ac_CheckUID;
            //accounts.Ac_UID = entity.Ac_UID;
            //accounts.Org_ID = entity.Org_ID;
            //accounts.Ac_Zip = entity.Ac_Zip;
            //accounts.Ac_LinkMan = entity.Ac_LinkMan;
            //accounts.Ac_LinkManPhone = entity.Ac_LinkManPhone;
            //accounts.Ac_Intro = entity.Ac_Intro;
            //accounts.Ac_Major = entity.Ac_Major;
            //accounts.Ac_Education = entity.Ac_Education;
            //accounts.Ac_Native = entity.Ac_Native;
            //accounts.Ac_Nation = entity.Ac_Nation;
            //accounts.Ac_CodeNumber = entity.Ac_CodeNumber;
            //accounts.Ac_Address = entity.Ac_Address;
            //accounts.Ac_AddrContact = entity.Ac_AddrContact;
            //accounts.Dep_Id = entity.Dep_Id;
            //accounts.Sts_ID = entity.Sts_ID;
            //accounts.Sts_Name = entity.Sts_Name;
            //accounts.Ac_CurrCourse = entity.Ac_CurrCourse;
            //accounts.Ac_PointAmount = entity.Ac_PointAmount;
            //accounts.Ac_School = entity.Ac_School;
            //accounts.Ac_QqOpenID = entity.Ac_QqOpenID;
            //accounts.Ac_WeixinOpenID = entity.Ac_WeixinOpenID;
            //accountsService.Add(accounts);
            //var sc=accountsService.GetModels(n=>n.Ac_AccName== accounts.Ac_AccName).FirstOrDefault();
            #endregion
...
_result += _zimu[_rand.Next(52)]; //通过索引下标随机
        ...
        public void AccountsSave(Accounts entity)
        {
            //如果密码不为空
            //if (!string.IsNullOrWhiteSpace(entity.Ac_Pw))
            //    entity.Ac_Pw = new Common.Param.Method.ConvertToAnyValue(entity.Ac_Pw).MD5; 
        ...
        {
           Accounts ac = this.AccountsSingle(identify);
            if (ac == null) return;
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void AccountsDelete(Accounts entity)
        {
            using (DbTrans tran = Gateway.Default.BeginTrans())
            {
                try
                {
                    ...
                    tran.Commit();
                    //删除教师
                   Teacher th = this.GetTeacher(entity.Ac_ID, null);
        ...
        {
           Accounts ac = Gateway.Default.From<Accounts>().Where(Accounts._.Ac_ID == identify).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 通过账号名获取
        ...
        public Accounts AccountsSingle(string accname, int orgid)
        {
           ...
           Accounts ac = Gateway.Default.From<Accounts>().Where(wc).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 通过手机号获取账户
        ...
        public Accounts AccountsSingle(string phone, bool? isPass, bool? isUse)
        {
           ...
           Accounts ac = Gateway.Default.From<Accounts>().Where(wc && w2).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 获取单一实体对象，按网站账户名称
        ...
        {
            pw = new Common.Param.Method.ConvertToAnyValue(pw).MD5;
            WhereClip wc = new WhereClip();
            if (orgid > 0) wc.And(Accounts._.Org_ID == orgid);
            wc.And(Accounts._.Ac_AccName == accname);
        ...
        {
           Accounts ac = Gateway.Default.From<Accounts>().Where(Accounts._.Ac_ID == id && Accounts._.Ac_CheckUID == uid).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 获取单一实体,通过name和 dingOpenID
        /// </summary>
        /// <param name="name"></param>
        /// <param name="dingOpenid"></param>
        /// <returns></returns>
        public Accounts AccountsSingle(string name, string dingid)
        {
            Accounts ac = Gateway.Default.From<Accounts>().Where(Accounts._.Ac_Name == name && Accounts._.Ac_WeixinOpenID == dingid).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 通过姓名获取账号
        ...
        {
           Accounts ac = Gateway.Default.From<Accounts>().Where(Accounts._.Ac_QqOpenID == qqopenid || Accounts._.Ac_AccName == qqopenid).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 通过微信的openid获取账户
        ...
        {
           Accounts ac = Gateway.Default.From<Accounts>().Where(Accounts._.Ac_WeixinOpenID == openid || Accounts._.Ac_AccName == openid).ToFirst<Accounts>();
            return _acc_init(ac);
        }
        /// <summary>
        /// 通过基础账号的id，获取教师账户
        ...
        public Accounts AccountsLogin(string acc, string pw, bool? isPass)
        {
            ...
            if (isPass != null) wc.And(Accounts._.Ac_IsPass == (bool)isPass);
            //密码
            wc.And(Accounts._.Ac_Pw == new Common.Param.Method.ConvertToAnyValue(pw).MD5);
            //wc.And(Accounts._.Ac_Pw == pw);
            //账号、手机号、身份证，均可验证
            WhereClip w2 = new WhereClip();
           ...
           Accounts entity = Gateway.Default.From<Accounts>().Where(wc && w2).ToFirst<Accounts>();           
        ...
        public Accounts AccountsLogin(int accid, string pw, bool? isPass)
        {
           ...
           Accounts entity = Gateway.Default.From<Accounts>().Where(wc).ToFirst<Accounts>();
            return _acc_init(entity);
        }
        /// <summary>
        /// 判断账号是否存在
        ...
        public string AccountsExport4Excel(string path, int orgid, string sorts)
        {
            ...
            string confing = Common.App.Get["ExcelInputConfig"].VirtualPath + "学生信息.xml";
            xmldoc.Load(Common.Server.MapPath(confing));
            ...
            else
            {
                ...
                foreach (string s in sorts.Split(','))
                {
                    ...
                    //
                   StudentSort sts=Gateway.Default.From<StudentSort>().Where(StudentSort._.Sts_ID == sortid).ToFirst<StudentSort>();
               ...
               StudentSort[] stss = Gateway.Default.From<StudentSort>().Where(StudentSort._.Org_ID == orgid).ToArray<StudentSort>();
        ...
        public PointAccount PointAdd(PointAccount entity)
        {
           ...
           Organization org = Business.Do<IOrganization>().OrganCurrent();
            ...
            using (DbTrans tran = Gateway.Default.BeginTrans())
            {
                try
                {
                   Accounts student = tran.From<Accounts>().Where(Accounts._.Ac_ID == entity.Ac_ID).ToFirst<Accounts>();
                    entity.Pa_Total = student.Ac_Point + entity.Pa_Value;
                    entity.Pa_TotalAmount = student.Ac_PointAmount + entity.Pa_Value;

                    PointAccountService pointAccountService = new PointAccountService();
                    Entities.PointAccount pointAccount = new Entities.PointAccount();
                    pointAccount.Ac_ID = entity.Ac_ID;
                    pointAccount.Pa_Total = entity.Pa_Total;
                    pointAccount.Pa_TotalAmount = entity.Pa_TotalAmount;
                    pointAccount.Pa_Value = entity.Pa_Value;
                    pointAccount.Pa_Source = entity.Pa_Source;
                    pointAccount.Pa_Type = entity.Pa_Type;
                    pointAccount.Pa_Info = entity.Pa_Info;
                    pointAccount.Pa_Remark = entity.Pa_Remark;
                    pointAccount.Pa_CrtTime = entity.Pa_CrtTime;
                    pointAccount.Org_ID = entity.Org_ID;
                    pointAccount.Pa_Serial = entity.Pa_Serial;
                    pointAccount.Pa_From = entity.Pa_From;
                    pointAccountService.Add(pointAccount);
        ...
        public CouponAccount CouponAdd(CouponAccount entity)
        {
           ...
           Organization org = Business.Do<IOrganization>().OrganCurrent();
            ...
            //计算总数
           Accounts acc=Gateway.Default.From<Accounts>().Where(Accounts._.Ac_ID==entity.Ac_ID).ToFirst<Accounts>();
        ...
        public void CouponExchange(Accounts acc, int coupon)
        {
           Organization org = Business.Do<IOrganization>().OrganCurrent();
            ...
            pa.Pa_Source = Common.Browser.IsMobile ? "手机端" : "电脑网页";
            //卡券的增加计算
            ...
            ca.Ca_Source = Common.Browser.IsMobile ? "手机端" : "电脑网页";
            //最大券值
        ...
        {
           MoneyAccount ma = Gateway.Default.From<MoneyAccount>().Where(MoneyAccount._.Ma_Serial == serial).ToFirst<MoneyAccount>();
        ...
        {
            //最后一流水记录
           MoneyAccount first = tran.From<MoneyAccount>().Where(MoneyAccount._.Ac_ID == entity.Ac_ID).OrderBy(MoneyAccount._.Ma_ID.Desc).ToFirst<MoneyAccount>();
            Decimal total = 0;
           Accounts student = tran.From<Accounts>().Where(Accounts._.Ac_ID == entity.Ac_ID).ToFirst<Accounts>();
