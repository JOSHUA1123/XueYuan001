...
namespace ServiceImpls
{
    public class SystemParaCom : ISystemPara
    {
        ...
        public List<SystemPara> Refresh()
        {
            try
            {
                Common.Cache<SystemPara>.Data.Clear();
            }
            catch
            {
            }
            finally
            {
                ...
                foreach (SystemPara p in syspara)
                    Common.Cache<SystemPara>.Data.Add(p);
                List<SystemPara> list = Common.Cache<SystemPara>.Data.List;                
            }
            return Common.Cache<SystemPara>.Data.List;
        }
        /// <summary>
        /// 删除
        /// </summary>
        ...
        /// <returns></returns>
        public Common.Param.Method.ConvertToAnyValue this[string key]
        {
            get
            {
                SystemPara curr = GetSingle(key);
                if (curr == null) return new Common.Param.Method.ConvertToAnyValue(null);
                string val = !string.IsNullOrWhiteSpace(curr.Sys_Value) ? curr.Sys_Value.Trim() : curr.Sys_Default;
                Common.Param.Method.ConvertToAnyValue p = new Common.Param.Method.ConvertToAnyValue(val);
        ...
        public List<string> DatabaseCompleteTest()
        {
            ...
            foreach (Type t in ts)
            {
                ...
                if (!(obj is DataBaseInfo.Entity)) continue;
                DataBaseInfo.Entity entity = (DataBaseInfo.Entity)obj;
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        public T ScalarSql<T>(string sql) where T : DataBaseInfo.Entity
        {
        ...
        public List<T> ForSql<T>(string sql) where T : DataBaseInfo.Entity
        {
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            {
                Common.Param.Method.ConvertToAnyValue p = new Common.Param.Method.ConvertToAnyValue();
