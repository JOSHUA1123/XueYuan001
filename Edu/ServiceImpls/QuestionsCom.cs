...
namespace ServiceImpls
{
    public class QuestionsCom : IQuestions
    {
        ...
        public void QuesInput(Questions entity, List<QuesAnswer> ansItem)
        {
        ...
        {
            Questions entity = this.QuesSingle(identify);
        ...
        {
            Questions qus = QuestionsMethod.QuestionsCache.Singleton.GetSingle(identify);
        ...
        public Questions QuesSingle(string uid)
        {
            ...
            Questions qus = QuestionsMethod.QuestionsCache.Singleton.GetSingle(uid);
        ...
        public Questions QuesSingle(string titile, int type)
        {
            ...
            Questions qus = Gateway.Default.From<Questions>().Where(wc).ToFirst<Questions>();
            if (qus == null) return qus;           
            return qus;
        }
        ...
        {
            QuesAnswer[] ans = this.ItemsToAnswer(qus.Qus_Items, isCorrect);
            return ans;
        }
        ...
        public Questions[] QuesRandom(int orgid, int sbjid, int couid, int olid, int type, int diff1, int diff2, bool? isUse, int count)
        {
            #region 
            //试题类型
            string[] types = Common.App.Get["QuesType"].Split(',');
            ...
            //根据不同的数据库拼接SQL语句
            string sql = "";
            string dataype = Common.Server.DatabaseType; //数据库类型
            if (dataype != "access")
            {
        ...
        private void _buildExcelSql_1(HSSFWorkbook hssfworkbook, WhereClip where)
        {
            ...
            Questions[] ques = Gateway.Default.From<Questions>().Where(wc).OrderBy(Questions._.Qus_ID.Asc).ToArray<Questions>();
            //创建工作簿对象
        ...
        {
            QuesTypes qus = Gateway.Default.From<QuesTypes>().Where(QuesTypes._.Qt_ID == identify).ToFirst<QuesTypes>();
            return qus;
        }
        /// <summary>
        /// 获取某个学科的所有试题分类
        ...
        /// <returns></returns>
        public string AnswerToItems(QuesAnswer[] ans)
        {
        ...
        /// <param name="ans"></param>
        /// <returns></returns>
        private XmlNode _answerToItem(XmlDocument xmlDoc, QuesAnswer ans)
        {
        ...
        /// <returns></returns>
        public QuesAnswer[] ItemsToAnswer(string xml, bool? isCorrect)
        {
            ...
            List<QuesAnswer> anslist =new List<QuesAnswer>();
        ...
        /// <param name="xml"></param>
        /// <returns></returns>
        public QuesAnswer ItemToAnswer(string xml)
        {
        ...
        public void Refresh(string key)
        {
            ...
            ServiceImpls.QuestionsMethod.QuestionsCache.Singleton.Delete(key);
            ServiceImpls.QuestionsMethod.QuestionsCache.Singleton.Add(ques, int.MaxValue, key);
        }
        #endregion
        ...
        public void OnSave(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (ques == null) return;
                ServiceImpls.QuestionsMethod.QuestionsCache.Singleton.UpdateSingle(ques);
            }
        ...
        public void OnAdd(object sender, EventArgs e)
        {
            ...
            if (ques.Ol_ID > 0)
            {
                ...
                Common.Cache<Outline>.Data.Update(ol, olnew);
            }
