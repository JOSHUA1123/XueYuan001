...
//            Product pd = new ContentsCom().ProductSingle(entity.Pd_Uid);
//            if (pd != null)
//            {
...
//                CustomControl.FileUpload.Delete("Product", entity.Pp_File);
//            }
//            else
//            {
//                Product pd = new ContentsCom().ProductSingle(entity.Pd_Uid);
...
//                try
//                {
//                    ProductPicture pp = Gateway.Default.From<ProductPicture>().Where(ProductPicture._.Pd_Id == entity.Pd_Id && ProductPicture._.Pp_Id != entity.Pp_Id).OrderBy(ProductPicture._.Pp_Tax.Asc).ToFirst<ProductPicture>();
//                    if (pp != null)
//                    {                        
//                        pp.Pp_IsCover = true;
