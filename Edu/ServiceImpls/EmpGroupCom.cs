...
namespace ServiceImpls
{
    public class EmpGroupCom :IEmpGroup
    {
        ...
        {
            EmpAcc_Group eg = new EmpAcc_Group();
            eg.Acc_Id = empId;
            eg.EGrp_Id = grpId;
        ...
        {
            return Gateway.Default.From<EmpGroup>().InnerJoin<EmpAcc_Group>("[EmpGroup].[EGrp_Id] = [EmpAcc_Group].[EGrp_Id]")
        ...
        {
            return Gateway.Default.From<EmpAccount>().InnerJoin<EmpAcc_Group>("[EmpAcc_Group].[Acc_Id] = [EmpAccount].[Acc_Id]")
